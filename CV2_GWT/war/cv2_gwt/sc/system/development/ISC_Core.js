...
);isc.B._maxIndex=isc.C+12;isc.Time.$ic();isc.Time.setDefaultDisplayTimezone(new Date().getTimezoneOffset());isc.defineClass("PubSub");isc.A=isc.PubSub;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$59k={};isc.A.$59l=0;isc.B.push(isc.A.getSubscribers=function isc_c_PubSub_getSubscribers(_1){return(this.$59k[_1]=this.$59k[_1]||[])}
...
if(!isc.Canvas.neverUseFilters){if(this.$vr){_16[57]=";filter:progid:DXImageTransform.Microsoft.iris(irisStyle=circle)"}else{_16[57]=null}}}else{if(_11!=null){_16[56]=(this.$qx?";-moz-opacity:":";opacity:")+_11}else{_16[56]=null}}
_16[58]=this.getTransformCSS();_16[60]=_6;var _17=64;if(this.$ln()&&this._useNativeTabIndex){_16[64]=_2.$vd;_16[65]=this.$tx();_16[66]=_2.$ve;_16[67]=this.$ty();if(!this.isDisabled()){_16[68]=_2.$vf;isc.$bn(_16,this.getTabIndex(),69,5);if(this.accessKey!=null){_16[74]=_2.$vg;_16[75]=this.accessKey;_17=76}else _17=74;if(!this.showFocusOutline){if(!_2.$vs)_2.$vs=" hideFocus=true";_16[_17]=_2.$vs;_17+=1}}else _17=68}
_16.length=_17;_16[_17]=this.$rc;if(_1)return _16;return _16.join(isc.emptyString)}
return _15}
...
);isc.evalBoundary;isc.B.push(isc.A.percentSourceInnerSizeChanged=function isc_Canvas_percentSourceInnerSizeChanged(){if(this.percentBox==this.$q3)this.$t9()}
...
);isc.evalBoundary;isc.B.push(isc.A.firePartEvent=function isc_Canvas_firePartEvent(_1,_2){if(!this.useEventParts||!_1)return;var _3=this.getEventPart(_1);if(!_3.part)return;if(!_2)_2=_1.eventType;return this.$z0(_3.part,_2,_3.element,_3.ID,_1)}
