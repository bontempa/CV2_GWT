...
if(_2==null)return isc.Comm.$fo(_1,"");if(isc.isA.String(_2)){return isc.Comm.$fo(_1,isc.makeXMLSafe(_2),(isc.Comm.xmlSchemaMode?"string":null))}
...
{var _3=[];this.$539(_1,_3);return _3}
...
return _3}
);isc.B._maxIndex=isc.C+10;isc.A=isc.DataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$fx="Action";isc.A.resultBatchSize=150;isc.A.$7o=[];isc.A.canExport=true;isc.A.textContentProperty="xmlTextContent";isc.A.$d6="Defaults";isc.A.$d7="Properties";isc.A.$54b="name";isc.A.$522="type";isc.A.dropUnknownCriteria=true;isc.A.$54c="startsWith";isc.A.$29j="substring";isc.A.$54d="exact";isc.A.$54e="iscServer";isc.B.push(isc.A.init=function isc_DataSource_init(){if(this.serverType=="sql")this.dataFormat="iscServer";if(this.dataFormat=="iscServer"&&(this.serviceNamespace!=null||this.recordXPath!=null))this.dataFormat="xml";this.canQueueRequests=(this.dataFormat=="iscServer"||this.clientOnly);if(this.testData&&!this.cacheData)this.cacheData=this.testData;else if(this.clientOnly&&this.cacheData&&!this.testData)
...
var _9=this.getDataURL(_1);_9=_1.actionURL||_1.dataURL||_9;if(_1.useHttpProxy==null){_1.useHttpProxy=this.$ea(_2.useHttpProxy,this.useHttpProxy)}
...
this.$54h(_4,_2,_3)}
,isc.A.$54i=function isc_DataSource__handleClientOnlyReply(_1,_2,_3){var _4=this.cacheAllData&&!this.clientOnly&&this.cacheResultSet?this.cacheResultSet.getAllRows():null,_5=this.getClientOnlyResponse(_3.$54j,_4),_6=_3.$54j;this.$54h(_2,_5,_6,_1,_3)}
,isc.A.$54k=function isc_DataSource__handleCustomReply(_1,_2,_3){var _4={data:_2,startRow:0,endRow:0,totalRows:0,status:0};var _5=_3.$54j;this.$54h(_2,_4,_5,_1,_3)}
,isc.A.$54l=function isc_DataSource__handleJSONReply(_1,_2,_3){var _4=_3.$54j,_5=this.getOperationBinding(_4).recordXPath||this.recordXPath;if((_1.$54m||_1.$54n)&&this.logIsDebugEnabled("xmlBinding")){this.logDebug("Raw response data: "+this.echoFull(_2),"xmlBinding")}
...
,isc.A.$54p=function(rpcResponse,jsonText,rpcRequest){if(rpcResponse.status>=0){var evalText=jsonText;if(rpcRequest.transport!="scriptInclude"){var re;if(this.jsonPrefix){re=new RegExp(/^\s*/);evalText=evalText.replace(re,"");if(evalText.startsWith(this.jsonPrefix)){evalText=evalText.substring(this.jsonPrefix.length)}else{this.logInfo("DataSource specifies jsonPrefix, but not present in "+"response returned from server. Processing response anyway.")}}
...
var _10=this.$fn(_1,_2,_3,_4,_7);if(_6)_2.qualifyAll=null;var _11=isc.Comm.xmlSchemaMode;isc.Comm.xmlSchemaMode=_11;if(_9)isc.Comm.omitXSI=null;return _10}
...
,isc.A.$54v=function isc_DataSource__handleXMLReply(_1,_2,_3,_4){var _5=_1,_6=_4.$54j,_7=this.getOperationBinding(_6),_8;if(_3.status<0){var _9=_2||_3.data;this.$54h(_9,{status:_3.status,data:_9},_6,_3,_4);return}
...
,isc.A.fireResponseCallbacks=function isc_DataSource_fireResponseCallbacks(_1,_2,_3,_4){if(!_1.clientContext)_1.clientContext={};if(_1.status>=0){isc.DataSource.handleUpdate(_1,_2)}else if(!_2.willHandleError){isc.RPCManager.$a1(_1,_2)}
...
);isc.evalBoundary;isc.B.push(isc.A.$540=function isc_DataSource__parseNumber(_1,_2){if(_1==null)return _2;if(!isc.isA.String(_1))return _1;var _3=parseInt(_1);if(isNaN(_3))return _2!=null?_2:_1;else return _3}
...
{this.$714(_1.data,_1.oldValues,_3,this)}
...
var _8=this.getServiceInputs(_1);if(_8.dataProtocol=="clientCustom")return;var _9=isc.addProperties({},_1,_8);_9.$54j=_1;if(_8.data==null)_9.data=null;if(this.clientOnly||(this.cacheAllData&&_1.operationType=="fetch")){_9.clientOnly=true;_9.callback={target:this,methodName:"$54i"};isc.RPC.sendRequest(_9);return}
var _10=this.getOperationBinding(_1);_9.transport=_10.dataTransport||this.dataTransport;if(_9.transport=="scriptInclude"){_9.callback={target:this,methodName:"$54l"};if(!_9.callbackParam){_9.callbackParam=_10.callbackParam||this.callbackParam}
isc.rpc.sendRequest(_9);return}
var _2=this.getDataFormat(_1);if(_2=="xml"){var _11=_9.spoofedResponse;if(!_11){_9.callback={target:this,method:this.$54v};isc.xml.getXMLResponse(_9)}else{var _12=this;isc.Timer.setTimeout(function(){_12.$54v(isc.xml.parseXML(_11),_11,{status:0,httpResponseCode:200,data:_11},_9)})}}else if(_2=="json"){_9.callback={target:this,method:this.$54p};isc.rpc.sendProxied(_9)}else if(_2=="csv"){_9.callback={target:this,method:this.$54o};isc.rpc.sendProxied(_9)}else{_9.serverOutputAsString=true;_9.callback={target:this,method:this.$54k};isc.rpc.sendProxied(_9)}}
...
if(isc.isA.Date(_7)&&Date.compareDates(_7,_11)==0){delete _1[_6]}else if(isc.isAn.Array(_7)){for(var i=0;i<_7.length;i++){this.$714(_7[i],_11[i],_3,_8==null?null:isc.DataSource.get(_8.type));var _13=0;for(var _14 in _7[i])_13++;if(_13==0)delete _7[i]}
var _15;for(var i=0;i<_7.length;i++){if(_7[i]!=null){_15=true;break}}
if(!_15)delete _1[_6]}else if(isc.isAn.Object(_7)){this.$714(_7,_11,_3,_8==null?null:isc.DataSource.get(_8.type));var _13=0;for(var _14 in _7)_13++;if(_13==0)delete _1[_6]}else if(_7==_11){delete _1[_6]}}}}
...
this.$54a=[_1];this.cacheResultSet=isc.ResultSet.create({dataSource:this,fetchMode:"local",allRows:this.cacheData?this.cacheData:null,cachingAllData:true,dataArrived:function(_3,_4){if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("cacheAllData - cacheResultSet.dataArrived: startRow/endRow: "+_3+"/"+_4)}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+163;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$55f=0;isc.A.$55g={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
_1=this.$715(_1);_1._constructor="AdvancedCriteria";return _1}
,isc.A.$715=function isc_c_DataSource__simplifyAdvancedCriteria(_1){var _2=_1.operator;if(_2=="and"||_2=="or"){var _3=_1.criteria;if(_3==null||_3.length==0){return _1}
if(_3.length==1){_1=_3[0];return this.$715(_1)}
var _4=[];for(var i=0;i<_3.length;i++){var _6=_3[i];_6=this.$715(_6);if(_6.operator==_2){_4.addList(_6.criteria)}else{_4.add(_6)}}
...
if(this.$73f){if(_2.fieldName){var _4=this.getFieldOperators(_2.fieldName);if(!_4.contains(_3.ID)){this.logWarn("Operator "+_3.ID+" is not valid for field "+_2.fieldName+". Continuing anyway.")}}}
return _3.condition(_2.value,_1,_2.fieldName,_2,_3,this)}
,isc.A.recordsMatchingAdvancedFilter=function isc_DataSource_recordsMatchingAdvancedFilter(_1,_2,_3){var _4=[];this.$55j=false;this.$55k=_2.strictSQLFiltering;this.$73f=true;for(var _5=0;_5<_1.length;_5++){if(this.evaluateCriterion(_1[_5],_2)){_4.add(_1[_5])}
delete this.$73f}
return _4}
...
);isc.B._maxIndex=isc.C+3;isc.DataSource.registerStringMethods({transformRequest:"dsRequest",transformResponse:"dsResponse,dsRequest,data"});isc.$55l=function(){var _1=function(_60,_61,_62,_63,_64,_65){var _2;if(!_63.criteria){_63.criteria=[]}
...
if(_64.isNot)_65.$55j=!_65.$55j;for(var _3=0;_3<_63.criteria.length;_3++){var _4=_65.evaluateCriterion(_61,_63.criteria[_3]);if(_64.isAnd&&!_4)_2=false;if(_64.isNot&&_4)_2=false;if(_64.isOr&&_4)_2=true;if(_2!=null)break}
if(_2==null){if(_64.isOr)_2=false;else _2=true}
if(_64.isNot)_65.$55j=!_65.$55j;return _2};var _5=function(_60,_61,_62,_63,_64,_65){if(_65.$55k){if(_61[_62]==null||_60==null)return _65.$55j}
...
if(_64.negate)return!_6;else return _6};var _8=function(_60,_61,_62,_63,_64,_65){var _9=_60,_10=_60,_11=_61[_62];if(_63.start)_9=_63.start;if(_63.end)_10=_63.end;if(_65.$55k){if(_11==null||(_64.lowerBounds&&_9==null)||(_64.upperBounds&&_10==null)){return _65.$55j}}
...
if(_11==null)return _65.$55k?_65.$55j:_64.negate;if(_18==null)_18="";if(isc.isA.Number(_18))_18=""+_18;if(!isc.isA.String(_18)||!isc.isA.String(_11))return _64.negate;if(_64.caseInsensitive){_11=_11.toLowerCase();_18=_18.toLowerCase()}
...
_7.callback={target:this,methodName:"$551"};isc.xml.getXMLResponse(_7)},$551:function(_1,_2,_3,_4){var _5=_4.clientContext,_6=_5.$55y,_7=_5.$55z;if(_3.status<0){this.fireCallback(_5.$55x,"data,xmlDoc,rpcResponse,wsRequest",[_10,_1,_3,_4]);return}
...
return _3}
,isc.A.serializeTransaction=function isc_c_RPCManager_serializeTransaction(_1){var _2;if(this.dataEncoding=="JS"){isc.Comm.$fm=true;_2=isc.Comm.serialize(_1.requestData);isc.Comm.$fm=null}else{_2=isc.Comm.xmlSerialize("transaction",_1.requestData)}
return _2}
...
var _5=_4.operations[0];if(!isc.Page.isLoaded()){_4.$56o={callback:_1,prompt:_2,URL:_3};if(!this.delayingTransactions)isc.Page.setEvent("load",this,isc.Page.FIRE_ONCE,"resendDelayedTransactions");this.delayingTransactions=true}
...
if(_6){_4.allClientOnly=true;_4.sendTime=isc.timeStamp();this.delayCall("$56n",[_4.transactionNum],0);return _5}
...
if(this.cachingAllData)_5.cachingAllData=true;this.getDataSource().fetchData(_1,{caller:this,methodName:"fetchRemoteDataReply"},_5);if(!this.isPaged())this.$56w=this.$56r}
,isc.A.fetchRemoteDataReply=function isc_ResultSet_fetchRemoteDataReply(_1,_2,_3){var _4=_1.clientContext.requestIndex;if(!this.$56z)this.$56z=0;if(_4!=(this.$56z+1)&&!_1.isCachedResponse){this.logInfo("server returned out-of-sequence response for fetch remote data request "+" - delaying processing: last processed:"+this.$56z+", returned:"+_4);if(!this.$560)this.$560=[];this.$560.add({dsResponse:_1,data:_2,request:_3});return}
if(this.cachingAllData==true)delete this.cachingAllData;if(!this.isPaged()&&this.$56w==_4)delete this.$56w;var _5;var _6=_1.status<0;if(_6||_1.offlineResponse){_5=[]}else{_5=_1.data}
...
var _9=_1.startRow,_10=_1.endRow;this.$561();this.$562(_5,_1);this.$563(_9,_10,_6);delete this.context.afterFlowCallback;this.$56z=_4;if(this.$560&&this.$560.length>0){for(var i=0;i<this.$560.length;i++){var _12=this.$560[i];if(_12==null)continue;var _13=_12.dsResponse.clientContext.requestIndex;if(_13==this.$56z+1){this.logInfo("Delayed out of sequence data response being processed now "+_13);this.$560[i]=null;this.fetchRemoteDataReply(_12.dsResponse,_12.data,_12.request);break}}}
var _14=_3.clientContext.$56y;if(!_14&&_6){isc.RPCManager.$a1(_1,_3)}}
...
,isc.A.setSort=function isc_ResultSet_setSort(_1,_2){var _3=[],_4=[],_5;for(var i=0;i<_1.length;i++){var _7=_1[i];if(_7.normalizer==null){var _5=this.getDataSource().getField(_7.property);if(_5){_7.normalizer=_5.type;_7.$707=_7.normalizer}}
...
this.updateCache(_1,_2,_4);this.$ev()}
...
,isc.A.$57k=function isc_Canvas__fireFetchCallback(_1,_2,_3){var _4=_3.clientContext?_3.clientContext.$57j:null;if(_4){this.fireCallback(_4,"dsResponse,data,dsRequest",arguments);delete _3.clientContext.$57j}}
...
return false},saveData:function(_1,_2,_3){if(this.dataSource==null){if(this.selectionComponent!=null){var _4=this.$57q;if(_4&&this.selectionComponent.setRecordValues){this.selectionComponent.setRecordValues(_4,this.getValues())}
return}
...
if(_2==null)_2={};var _5=this.getSaveOperationType(_2);if(!_2.oldValues){_2.oldValues=_5!="add"?this.$17j:{}}
if(this.validationURL&&!_3){var _6={};isc.addProperties(_6,_2);isc.addProperties(_6,{actionURL:this.validationURL,valuesAsParams:true,sendNoQueue:true});_6.$57r=_2;_6.$56p=_1;this.performingServerValidation=true;this.validateData(this.getID()+".$57s(rpcRequest,rpcResponse,data)",_6);return}
...
this.$56p=_1;_1=this.getID()+".$57t(dsRequest, dsResponse, data)";_2=this.buildRequest(_2,_5,_1);var _8=false;if(this.submitParamsOnly)_2.useSimpleHttp=true;if(isc.DynamicForm&&isc.isA.DynamicForm(this)){if(this.$18j){_2.actionURL=this.action;_2.target=this.target?this.target:window;_8=true}
...
var _4=this.selectionComponent.getSelection}},selectionComponentSelectionChanged:function(_1,_2,_3){if(!_3)return;this.$57q=_1.getPrimaryKeys(_2);this.editRecord(_2)},selectionComponentCellSelectionChanged:function(_1,_2){for(var i=0;i<_2.length;i++){var _4=_2[i],_5=this.selectionComponent.getCellRecord(_4[0],_4[1]);if(_1.cellIsSelected(_5))break;_5=null}
if(_5){this.$57q=_1.getPrimaryKeys(_5);this.editRecord(_5)}},updateFileItemForm:function(){var _1=this.getFileItemForm();if(_1==null)return;var _2=_1.getValues(),_3=this.getValues(),_4=_1.getItem(0).getFieldName();for(var _5 in _2){if(_5==_4)continue;_1.setValue(_5,null)}
...
if(_3.clientContext){_3.willHandleError=_3.clientContext.$56y}
if(_1.status<0&&!_3.willHandleError)
return isc.RPCManager.$a1(_1,_3);return true},$57s:function(_1,_2,_3){if(_2.status==isc.RPCResponse.STATUS_SUCCESS){this.performingServerValidation=false;this.markForRedraw("serverValidationSuccess");this.saveData(_1.$56p,_1.$57r,true);_1.$56p=null;_1.$57r=null}else{this.setErrors(_2.errors,true)}}});if(isc.DynamicForm)isc.ClassFactory.mixInInterface("DynamicForm","EditorActionMethods");isc.$57x={fetchData:function(_1,_2,_3){var _4=this.getDataSource();if(!_4){this.logWarn("Ignoring call to fetchData() on a DynamicForm with no valid dataSource");return}
...
this.editRecord(_4);var _5=this.$57y.pop();if(_5)this.fireCallback(_5,"dsResponse,data,dsRequest",[_1,_2,_3])},filterData:function(_1,_2,_3){var _4=this.getDataSource();if(!_4){this.logWarn("Ignoring call to filterData() on a DynamicForm with no valid dataSource");return}
...
var count=this.getNativeStoredValuesCount();isc.logWarn("Removing all "+count+" entries from local storage");for(var i=0;i<count;i++){this.$716(this.getKeyForNativeIndex(0),false)}},logCacheContents:function(maxEntryLength){var contents=this.getCacheContents();this.logWarn("Dumping the contents of the browser's local storage:");for(var key in contents){var value=contents[key];if(value&&value.length>maxEntryLength){value=value.substring(0,maxEntryLength)}
...
return keys},removeOldestEntry:function(){var key=this.getAndRemoveOldestFromPriorityQueue();if(key==null)return;this.remove(key,true)},$717:function(maxEntryLength){var doc=this.userDataSpan.xmlDocument;var maxEntryLength=100;this.logWarn("Dumping the contents of raw userData storage:");for(var i=0;i<this.userDataSpan.xmlDocument.firstChild.attributes.length;i++){var key=this.userDataSpan.xmlDocument.firstChild.attributes[i].name;var value=this.userDataSpan.getAttribute(key);if(value&&value.length>maxEntryLength){value=value.substring(0,maxEntryLength)+"..."}
this.logWarn(key+" ===> "+value)}},put:function(key,value,recycleEntries){var ts=new Date().getTime();var oldValue=this.get(key);while(true){try{this.$718(key,value);break}catch(e){if(recycleEntries!==false&&this.isStorageException(e)){var entries=this.getStorageMetrics().storedEntries;if(entries>0){this.logWarn("Cache full; removing oldest entry and trying again");this.removeOldestEntry()}else{this.logWarn("Can't add this entry to browser-local storage, even "+"though the cache is empty - the item must be larger "+"than the browser's permitted cache space.");break}}else{throw e}}}
...
this.logWarn("Cache full when updating priority queue or metrics; rolling "+"back the entire update");this.$716(key);if(pqOK)this.removeFromPriorityQueue(key);this.rebuildMetrics();throw e}else{throw e}}}
...
_4[_1]=[];_4[_1].add(_2);var _5=_1+"_loadSchema";_3=_3||{};if(!_3.prompt)_3.prompt="loading datasource '"+_1+"'";this.logInfo("performing operation: "+_5);isc.rpc.performOperation(_5,{},"isc.DS.$652(rpcResponse,data)",_3)}
,isc.A.$652=function isc_c_DataSource__getDataSourceReply(_1,_2){var _3=_2[0].dsName;if(_1.status!=0){isc.DataSource.logError("dynamic datasource fetch failed for datasource '"+_3+"'.");return}
var _4=_2[0].dsData;isc.eval(_4);var _5=isc.DS.get(_3);var _6=isc.DataSource.$651;for(var i=0;i<_6[_3].length;i++){isc.DataSource.logInfo("calling registered callback: "+(_6[_3])[i]);this.fireCallback(_6[_3][i],"ds",[_5],_5)}
delete _6[_3]}
...
_3.$54j=_1;this.logInfo("performDSOperation("+_5+") "+(isc.isAn.Array(_2)?_2.length:1)+" records"+(isc.rpc.queuing?", queuing":""));_3.callback={target:this,methodName:"$653"};if(isc.DataSource.addMetaDataToQueryString){if(!_3.queryParams)_3.queryParams={};isc.addProperties(_3.queryParams,{ds_name:_1.dataSource,ds_op:_1.operationType});if(_1.startRow!=null){isc.addProperties(_3.queryParams,{ds_startRow:_1.startRow,ds_endRow:_1.endRow})}
...
_1.$54j=_1;this.delayCall("$653",[_3,_3.data,_1],0);return true;}else if(_2.useOfflineCache||_2.useOfflineCacheOnly){var _3=isc.Offline.getResponse(_2);if(_3!=null){if(this.useOfflineResponse&&!this.useOfflineResponse(_2,_3))
{this.logInfo("User-written useOfflineResponse() method returned"+" false; not using cached response","offline");_3=null}}
if(_3!=null){_1.$54j=_1;this.delayCall("$653",[_3,_3.data,_1],0);return true}else if(_1.useOfflineCacheOnly){_3={status:isc.RPCResponse.STATUS_OFFLINE,data:[]}
_1.$54j=_1;this.delayCall("$653",[_3,_3.data,_1],0);return true}}}}
return false}
,isc.A.$653=function isc_DataSource__handleSCServerReply(_1,_2,_3){var _4=_3.$54j;this.$54h(_2,_1,_4,_1,_3)}
...
if(this.$575)this.$575.hide();var _3=isc.SelectionOutline.getSelectedObject();if(_3&&this.observer){this.observer.ignore(_3,"dragMove");_3.restoreFromOriginalValues(["canDrag","canDrop","dragAppearance","dragStart","dragMove","dragStop","setDragTracker"])}
var _4,_5;if(_1.$58g){var _6=_1.type||_1._constructor;_5="["+_6+" "+(_1.name?"name:":"ID");_5+=_1.name||_1.ID;_5+="]"
_4=_1;_1=_1.$58g}
...
this.fireCallback(_2,"node",[_1])},getEditComponents:function(){return this.editComponents},getEditDataSource:function(_1){return isc.DataSource.getDataSource(_1.editDataSource||_1.Class||this.editDataSource)},$58o:function(_1){var _2=[];_2.addList(_1.baseEditFields);_2.addList(_1.editFields);for(var i=0;i<_2.length;i++){var _4=_2[i];if(_4.visible==null)_4.visible=true}
...
this.$584=_5;var _14=this.getSearchOperator(_12.defaultValue);if(!_14&&_13.length>0){isc.logWarn("Criterion specified unknown operator "+(_3?_3.operator:"[null criterion]")+". Using the first valid operator ("+isc.firstKey(_13)+") instead");_12.defaultValue=isc.firstKey(_13);_14=this.getSearchOperator(_12.defaultValue)}
...
,isc.A.setCriteria=function isc_FilterBuilder_setCriteria(_1){this.clearCriteria(true);this.stripNullCriteria(_1);if(!this.$587&&this.fieldDataSource&&_1){if(isc.isA.String(this.fieldDataSource))
...
if(_4.criteria.length!=0){this.$587=true;this.fieldDataSource.fetchData(_4,function(_10){_2.fetchFieldsReply(_10,_1)});return}}}
...
delete this.$585;this.$587=false;this.clauseStack.show();this.redraw();this.filterReady()}
...
isc.defineClass("BatchUploader","VStack");isc.A=isc.BatchUploader.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultWidth="80%";isc.A.membersMargin=5;isc.A.uploadFormDefaults={_constructor:"DynamicForm",updateOperation:"upload"};isc.A.uploadFileLabel="Upload File";isc.A.uploadButtonDefaults={_constructor:"IButton",title:"Upload",click:"this.creator.upload()"};isc.A.gridDefaults={_constructor:"ListGrid",defaultHeight:500,canEdit:true,editByCell:true,validateByCell:true,autoSaveEdits:false};isc.A.cancelCommitButtonLayoutDefaults={_constructor:"HLayout",height:isc.IButton.getInstanceProperty("height")||isc.IButton.getInstanceProperty("defaultHeight"),membersMargin:5};isc.A.commitButtonDefaults={_constructor:"IButton",title:"Commit",click:"this.creator.commitClicked()",autoParent:"cancelCommitButtonLayout"};isc.A.cancelButtonDefaults={_constructor:"IButton",title:"Cancel",click:"this.creator.cancelClicked()",autoParent:"cancelCommitButtonLayout"};isc.A.partialCommit="prompt";isc.A.partialCommitPrompt="There are errors in your data so it cannot all be saved.  "+"If you proceed, you will lose the records with errors.  Click 'OK' "+"to proceed anyway, or 'Cancel' to return to your data";isc.A.partialCommitError="There are errors in your data.  Please correct all errors before "+"clicking Commit";isc.A.warnOnCancel=true;isc.A.cancelConfirmMessage="You will lose any work you have done on this data. Proceed anyway?";isc.A.batchUploadDSName="batchUpload";isc.B.push(isc.A.initWidget=function isc_BatchUploader_initWidget(){this.Super("initWidget",arguments);if(!this.uploadFormFields)this.uploadFormFields=[];this.uploadFormFields.add({name:"file",type:"file",title:this.uploadFileLabel});this.uploadFormFields.add({name:"dsName",type:"hidden",defaultValue:isc.DataSource.getDataSource(this.uploadDataSource).ID});this.addAutoChild("uploadForm",{fields:this.uploadFormFields});this.addAutoChild("uploadButton");var _1=this.uploadForm.getFileItemForm();if(_1)_1.updateOperation=this.uploadForm.updateOperation;var _2=this;isc.DataSource.getDataSource(this.batchUploadDSName,{target:this,methodName:"dataSourceLoaded"})}
,isc.A.dataSourceLoaded=function isc_BatchUploader_dataSourceLoaded(_1){}
,isc.A.upload=function isc_BatchUploader_upload(){this.uploadForm.dataSource=null;if(!this.uploadForm.validate(false,false))return;this.uploadForm.dataSource="batchUpload";isc.rpc.startQueue();var _1=this.uploadForm.fields;for(var i=0;i<_1.length;i++){_1[i].value=this.uploadForm.getValue(_1[i].name)}
...
,isc.A.uploadReply=function isc_BatchUploader_uploadReply(_1){var _2=this.grid;if(!_2){if(isc.ListGrid){_2=this.addAutoChild("grid");this.addAutoChildren(["cancelCommitButtonLayout","commitButton","cancelButton"])}}
_2.setDataSource(this.uploadDataSource,this.gridFields);_2.setData(_1.gridRows);if(_1.errors){for(var i=0;i<_1.errors.length;i++){var _4=_1.errors[i];isc.logWarn("rowNum: "+_4.rowNum+", error: "+isc.echoAll(_4.errors));_2.setRowErrors(_4.rowNum,_4.errors,i<_1.errors.length-1)}
var _5=_1.errors[0].rowNum;_2.delayCall("scrollRecordIntoView",[_5])}
_2.show()}
,isc.A.commitClicked=function isc_BatchUploader_commitClicked(){var _1=this.grid,_2=_1.data,_3=false;for(var i=0;i<_2.length;i++){if(_1.getRowErrors(i)){_3=true;break}}
...
this.commit()}
,isc.A.commit=function isc_BatchUploader_commit(){var _1=this.grid.data,_2=this;for(var i=0;i<_1.length;i++)
...
isc.rpc.sendQueue()}
,isc.A.cancelClicked=function isc_BatchUploader_cancelClicked(){if(this.warnOnCancel){var _1=this;isc.warn(this.cancelConfirmMessage,function(_2){if(_2)_1.cleanup()},{buttons:[isc.Dialog.OK,isc.Dialog.CANCEL]});return}
this.cleanup()}
,isc.A.cleanup=function isc_BatchUploader_cleanup(){this.grid.destroy();this.grid=null;this.cancelCommitButtonLayout.destroy();this.cancelCommitButtonLayout=null;this.commitButton.destroy();this.commitButton=null;this.cancelButton.destroy();this.cancelButton=null}
);isc.B._maxIndex=isc.C+8;isc.screenReader=false;isc.A=isc.Canvas.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addPrimaryRole=function isc_Canvas_addPrimaryRole(){if(!isc.Browser.isMoz||isc.Browser.geckoVersion<20051111)return;if(!this.waiRole)return;var _1=this.getClipHandle();isc.Canvas.setWAIRole(_1,this.waiRole);var _2=this.waiStateProps;if(_2)return;for(var _3 in _2){var _4=_2[_3],_5=this[_4];if(_5==null)continue;isc.Canvas.setWAIState(_1,_3,_5)}}
...
);isc.B._maxIndex=isc.C+3;if(isc.DynamicForm){isc.A=isc.FormItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addContentRoles=function isc_FormItem_addContentRoles(){if(!isc.Browser.isMoz||isc.Browser.geckoVersion<20051111)return;if(!this.$ln())return;var _1=this.getFocusElement();if(_1!=null)isc.Canvas.setWAIRole(_1,this.waiRole)}
);isc.B._maxIndex=isc.C+1}
if(isc.GridRenderer){isc.A=isc.GridRenderer.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addContentRoles=function isc_GridRenderer_addContentRoles(){if(!isc.Browser.isMoz||isc.Browser.geckoVersion<20051111)return;var _1=this.parentElement;if(!_1||(!_1.rowRole&&!_1.getRowRole))return;for(var i=this.$4o;i<=this.$379;i++){var _3=i,_4=this.getTableElement(_3),_5=_1.getRowRole?_1.getRowRole(_3):_1.rowRole;if(_5&&_4){isc.Canvas.setWAIRole(_4,_5);if(_1.getRowWAIState){var _6=_1.getRowWAIState(_3);if(_6)isc.Canvas.setWAIStates(_4,_6)}}
this.addCellRoles(_3)}}
,isc.A.addCellRoles=function isc_GridRenderer_addCellRoles(_1){var _2=this.parentElement;if(!_2||(!_2.cellRole&&!_2.getCellRole))return;for(var i=this.$4p;i<=this.$38a;i++){var _4=this.getTableElement(_1,i),_5=_2.getCellRole?_2.getCellRole(_1,i):_2.cellRole;if(_5){isc.Canvas.setWAIRole(_4,_5);if(_2.getCellWAIState){var _6=_2.getCellWAIState(_1,i);if(_6)isc.Canvas.setWAIStates(_4,_6)}}}}
