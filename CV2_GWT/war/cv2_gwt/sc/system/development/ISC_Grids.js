...
/*
  ...
  Version SC_SNAPSHOT-2011-05-03/EVAL Development Only (2011-05-03)
...
for(var i=0;i<_1.length;i++){var _7=_1[i],_8={};for(var _9 in _7){if(_9==this.parentProperty||_9=="$36r"||_9=="$4a"||_9=="__ref"||_9.startsWith("_isOpen_")||_9.startsWith("_isFolder_")||_9.startsWith("$36s")||_9=="$36t"||_9.startsWith("_selection_")||(_2==false&&_9==this.childrenProperty))continue;_8[_9]=_7[_9];if(_3&&_9==this.childrenProperty&&isc.isAn.Array(_8[_9]))
...
if(_3){if(!this.$36z||(this.$36z!=this.sortProp&&_1!=this.getRoot())||(this.$36z==this.sortProp&&_1==this.getRoot()))
...
if(_2.formatCellValue==null&&this.formatCellValue){_3=this.formatCellValue(_3,_1,_2)}else{_3=this.$25h(_1,_2,_3);if(_2.asHTML)_3=_3.asHTML()}
if(_2){if(_2.userFormula)_3=this.getFormulaFieldValue(_2,_1);else if(_2.userSummary)_3=this.getSummaryFieldValue(_2,_1);else if(_2.type=="imageFile"){if(_2.showFileInline!=false){if(!_1[_2[this.fieldIdProperty]+"$320"]){var _4=isc.Canvas.getFieldImageDimensions(_2,_1),_5=this.getDataSource().streamFile(_1);_3=_1[_2[this.fieldIdProperty]+"$320"]=this.imgHTML(_5,_4.width,_4.height)}else
...
,isc.A.$25h=function isc_DetailViewer__formatDataType(_1,_2,_3){var _4=_2.type,_5=(_4!=null?isc.SimpleType.getBaseType(_4):null),_6=_4&&_4.toLowerCase()=="datetime",_7;if(_5==this.$h0){if(_6){_7=_2.formatter||this.datetimeFormatter}else{_7=(_2.dateFormatter||_2.formatter||this.dateFormatter)}}
if(_7!=null){if(isc.isA.Date(_3)){if(_6){_3=_3.toShortDateTime(_7,true)}else{_3=_3.toNormalDate(_7)}}}else{if(_2.$12u!=null){_3=_2.$12q.normalDisplayFormatter(_3,_2,this,_1)}
...
,isc.A.scrollToRatio=function isc_GridRenderer_scrollToRatio(_1,_2,_3,_4){if(!_1||!this.$37x){return this.invokeSuper(isc.GridRenderer,"scrollToRatio",_1,_2,_3,_4)}
var _5=this.getTotalRows()-1,_6=_2*_5,_7=Math.floor(_6),_8=Math.round((_6-_7)*this.getRowSize(_7));this.$37y=_7;this.$37z=_8;this.$370();if(this.isDirty()){this.$371=_2;this.$37y=_7;this.$37z=_8}}
...
return _6}
,isc.A.$370=function isc_GridRenderer__scrollToTargetRow(){var _1=this.$37y,_2=this.$37z;var _3=this.getRowTop(_1)+_2;this.$374=true;this.$wg=null;this.scrollTo(null,_3);this.$374=false;this.$371=null}
,isc.A.scrollTo=function isc_GridRenderer_scrollTo(_1,_2,_3,_4){if(isc.$da)arguments.$db=this;if(this.$37x&&_2!=null&&!_3){var _5=this.getScrollTop(),_6=_2-_5;if(_6!=0){this.$373(_5,_6);_2=Math.min(_2,this.getRowTop(this.getTotalRows()-1))}}
this.invokeSuper(isc.GridRenderer,"scrollTo",_1,_2,_3,_4);if(this.isDirty()||this.$72y)return;var _7=(this.$376()||this.$377());if(_7){if(this.scrollRedrawDelay==0){this.markForRedraw("scrolled")}else{var _8=this;this.fireOnPause("scrollRedraw",function(){_8.markForRedraw("scrolled")},this.scrollRedrawDelay)}
this.$378=true}}
...
,isc.A.$377=function isc_GridRenderer__needColumnRedraw(){if(this.showAllColumns)return false;var _1=this.getVisibleColumns(),_2=_1[0],_3=_1[1],_4=(_2<this.$4p||_3>this.$38a);return _4}
...
var _29=_28.length;var _30=(this.showAllColumns||_1!=null);var _31=isc.StringBuffer.create(),_32=this.fields,_33=this.$37q;this.$384=_28[0]!=0?null:this.$37q[0];var _34,_35,_36,_37;if(!_30){_34=this.$37q.slice(0,_26).sum(),_35=this.$37q.slice(_27,this.$37q.length).sum(),_36=this.$37q.sum()
...
_31.append("<TBODY>")}
var _48=this.cellHeight,_49=(this.wrapCells?"":"<NOBR>"),_50=(this.wrapCells?"":"</NOBR>");var _51=0;if(isc.Browser.isDOM){var _52=this.$39c(_48);var _53=[];_53[0]="<TD";_53[3]=" ALIGN=";_53[17]=this.fastCellUpdates?"' ":"' CLASS=";if(!_13&&!this.isPrinting&&this.getCellElementId)_53[19]=" ID=";_53[23]=">"+_49;_53[30]=_50+(_52?"</DIV></TD>":"</TD>");var _54=1,_55=2,_56=4,_57=5,_58=6,_59=7,_60=10,_61=11,_62=18,_63=20,_64=21,_65=24;var _66="<TR",_67="</TR>",_68=">",_69=" HEIGHT=",_70=" VALIGN=";if(isc.Browser.isMobileWebkit)_66+=" onmousedown=\"return true;\"";if(isc.screenReader)_66+=" tabIndex=-1";var _71=[],_72=0,_73=[];this.$39d(_28,_38,_46,_52);if(this.isPrinting&&(!this.$387||_2==0)){_31.append(this.grid.getPrintHeaders(_26,_27))}
for(var _74=_2;_74<_3;_74++){var _75=(!_13&&this.$38k==_74);var _76=this.getCellRecord(_74);var _77=_75||this.$39e(_74,_76);_31.append(_66);if(!_13&&!this.isPrinting&&this.getRowElementId){_31.append(" ID=",this.getRowElementId(_74,_74-_2))}
_31.append(_68);var _78=_75?this.$38p:(this.getRowHeight!=null?this.getRowHeight(_76,_74):_48);var _79;if(_75){_79=true}else{_79=this.fixedRowHeights;if(_79&&this.shouldFixRowHeight!=null){_79=(this.shouldFixRowHeight(_76,_74)!=false)}}
if(_79){_53[_54]=_69;_53[_55]=_78-_45;_53[_60]=null}else{_53[_54]=null;_53[_55]=null;if(_78==this.cellHeight&&!this.fixedRowHeights){_53[_60]=null}else{_53[_60]=this.$39f(_76,_74)}}
if(_52){_53[_64]=">"+this.$37i+this.$39g(_78,_76,_74,_75)}
var _80=_77?this.$39h(_76,_74,_26,_27):null;for(var i=0;i<_28.length;i++){_1=_28[i];var _81=_32[_1],_82=_76;if(_82==null)_82=this.getCellRecord(_74,_1);if(_71[_1]>0){_81.$39i[_74]=_73[_1];_71[_1]--;if(_71[_1]==0){_72--;_73[_1]=null}
continue}
_53[_56]=this.getCellAlign(_76,_81,_74,_1);var _83=this.getCellVAlign(_76,_81,_74,_1);if(_83!=null){_53[_57]=_70
_53[_58]=_83}
if(_80!=null&&(_1==_80[0])){_51++;_53[_59]=this.$39j(_80[1]-_80[0]);if(_52){_53[_64+1]=this.$rd}}else{_53[_59]=_81.$39k;if(this.getRowSpan){var _84=this.getRowSpan(_76,_74,_1);if(_84>1){var _85=" ROWSPAN="+_84;if(_53[_56]!=null)
_53[_56]+=_85;else
_53[_56]=_85;_71[_1]=_84-1;_72++;_73[_1]=_74;if(_81.$39i==null)_81.$39i={};_81.$39i[_74]=_74}}
if(_52){_53[_64+1]=_81.$39l}else{_53[_64+1]=null}}
...
_53[_62]=_86}else{var _89=this.$39m(_86);_53[_61]=_89;_53[_61+1]=_87}
if(_75){this.$383=true;var _90=this.getTableHTML(null,this.$38k,this.$38m);delete this.$383;if(!_52){_53[_65]=isc.SB.concat(this.$37i,this.$39g(_78,_76,_74,_75),this.$rd,this.$rc,_90,"</DIV>")}else{_53[_65]=_90}}else
_53[_65]=this.$39n(_76,_74,_1);if(!_13&&this.getCellElementId){_53[_63]=this.getCellElementId(_74,_74-_2,_1,_1-_26)}
_31.append(_53);if(!_13&&_82!=null&&_82.$23!=null){if(_82.$23[0]&&_82.$23[0].rowNum==null)
{this.updateEmbeddedComponentCoords(_82.$23,_82,_74,_1)}}
if(_77&&(_1==_80[0])){i+=_80[1]-_80[0]}}
_31.append(_67);if(this.isPrinting&&_76.$23!=null){var _91=_76.$23;for(var _92=0;_92<_91.length;_92++){var _93=_91[_92];if(_93.$39z==null&&_93.$73p!=null){_31.append(_66,_68,'<td colspan="',_29,'">',_93.$73p,"</td>",_67);delete _93.$73p}}}
if(_75){_74=this.$38m-1}}}
if(!this.$387||_3==this.getTotalRows())_31.append("</TABLE>");var _94=_15-_3,_95=(!_13&&this.$37x);var _96=this.cacheDOM?0:(this.endSpace||0);this.$39o=0;if(!this.showAllRows&&(_94!=0||_95)){var _97=_94*this.getAvgRowHeight();if(_95&&_94==0){var _98=this.getViewportHeight();if(_97<_98){_97=_98}}
this.$39o=_97;_96+=this.$39o}
if(!this.cacheDOM&&!this.isPrinting){_31.append("<DIV style='width:1px;");if(_43){_31.append("height:",_96,"px;overflow:hidden;")}
if(_96==0)_31.append("display:none;");_31.append("' ");if(_13||this.isPrinting){_31.append(">")}else{_31.append(" ID="+this.getID()+"$39p>")}
...
if(_18){if(_4!=this.$37j){var _21=this.getDrawnRowHeight(_2)-_1.getVisibleHeight()-1;_1.moveTo(null,this.getRowTop(_2)+_21)}
...
if(_3!=null){this.$398(_5,_1,_3,_4,_2)}else{var _6=this.getTableElement(_1);if(_6!=null){var _7="TD",_8=(!this.showAllColumns?this.$4p:0),_9=(!this.showAllColumns?this.$38a:this.fields.length-1),_10=0;for(var _11=_8;_11<=_9;_11++,_10++){var _4;if(this.showColumnsSeparately||this.cacheDOM){_4=this.getTableElement(_1,_11)}else{_4=_6.cells[_10]}
...
,isc.A.mouseMove=function isc_GridRenderer_mouseMove(_1,_2){if(this.$4q())return;var _3=this.getEventRow(),_4=this.getEventColumn();if(_3<0||_4<0)return;if(!(_3==this.lastOverRow&&_4==this.lastOverCol)){var _5=(_3!=this.lastOverRow||_4<0);var _6=(_3>=0&&_4>=0&&this.cellIsEnabled(_3,_4));if(this.lastOverRow!=null&&this.lastOverCol!=null){var _7=this.lastOverRow,_8=this.lastOverCol,_9=this.getCellRecord(_7,_8);this.lastOverRow=null;this.lastOverCol=null;if((this.hoverByCell||_5)&&this.shouldShowRollOver(_7,_8))
...
if(this.getCanHover()){isc.Hover.setAction(this,this.$40g,[_3,_4],this.hoverDelay)}}
...
,isc.A.showContextMenu=function isc_GridRenderer_showContextMenu(){if(this.$4q())return false;var _1=this.getEventRow(),_2=this.getEventColumn();if(_1>=0&&_2>=0&&this.cellIsEnabled(_1,_2)){var _3=this.getCellRecord(_1,_2),_4;if(this.cellContextClick)
...
,isc.A.$40j=function isc_GridRenderer__rowSelectionChanged(_1,_2){if(this.selectionChanged&&(this.selectionChanged(_1,_2)==false))return false;var _3=this.selection,_4=_3.lastSelectionItem,_5=_3.data.indexOf(_4,this.$4o,this.$379);if(_5==-1)_5=_3.data.indexOf(_4);if(_5==-1)return;this.updateRowSelection(_5)}
...
,isc.A.modifyContent=function isc_GridRenderer_modifyContent(){if(!this.$38k)this.$394();if(this.$37y!=null){this.$72y=true;this.$370();this.$72y=null;var _1=this.getTableElement();if(_1)_1.style.visibility="inherit"}
...
this.$w8()}}
,isc.A.clear=function isc_GridRenderer_clear(){this.Super("clear",arguments);this.$38d();delete this.$37t}
...
if(_8&&!_10){var _12=this.grid.getInnerWidth(),_27;if(_9){var _28=this.grid.getFrozenSlots(this.grid.$37q);_27=_28.sum();_12-=_27}
...
if(_13>_11){_11=_13;this.$40y=true}else{if(this.$40y)delete this.$40y}}
...
if(_34.sorter&&_34.$400()&&!_34.isRTL()){_34.sorter.moveTo(_36);if(!_34.sorter.isVisible())_34.sorter.show()}else if(_34.sorter){_34.sorter.setLeft(0-_34.sorter.getWidth())}}}
var _38=(!_7&&this.$40y),_39=(!_8&&this.$40z);if(_38||_39){delete this.$40y;delete this.$40z;var _40=_38?this.grid.getAutoFitMinBodyHeight():null,_41=_39?(!_9?this.grid.getInnerWidth():(this.grid.getInnerWidth()-this.grid.frozenBody.getWidth())):null;this.resizeTo(_12,_11);this.grid.$401("autoFitData mode changed")}
return this.invokeSuper(isc.GridBody,"adjustOverflow",_1,_2,_3,_4,_5)}
...
,isc.A.scrollTo=function isc_GridBody_scrollTo(_1,_2,_3){if(isc.$da)arguments.$db=this;if(_1!=null){var _4=this.getScrollWidth()-this.getViewportWidth();_1=Math.max(0,Math.min(_4,_1))}
if(_2!=null){var _5=this.getScrollHeight()-this.getViewportHeight();_2=Math.max(0,Math.min(_5,_2))}
var _6=this.grid;var _7=this.$721;if(!_7)_6.bodyScrolled(_1,_2,this.frozen);this.invokeSuper(null,"scrollTo",_1,_2,_3);if(!this.isDirty()&&_6.$404){_6.$4r.itemsMoved()}}
...
,isc.A.redraw=function isc_GridBody_redraw(_1,_2,_3,_4){this.$405=true;var _5=this.grid,_6=_5.$4r,_7=_5.$404,_8,_9,_10,_11,_12;_5.$406();if(!_5.leaveScrollbarGap&&_5.predictScrollbarGap&&(this.overflow==isc.Canvas.AUTO)){var _13=this.vscrollOn,_14=!_5.isEmpty()&&(_5.getTotalRows()*_5.cellHeight)>this.getInnerHeight();if(_13!=_14){delete this.$407;_5.$401("body redrawing with changed vertical scroll-state")}}
if(_7){this.logInfo("redraw with editors showing, editForm.hasFocus: "+_6.hasFocus,"gridEdit");_8=_5.getEditCol();this.$239();_12=this.$408()}
if(this.$407!=null){delete this.$407;_5.$401(this.$407)}
var _15=this.getDrawArea();var _16=this.grid,_17=this.$409;if(!_17)_17=this.$409=[0,0,0,0];var _16=this.grid,_18=_16.getRecord(_15[0]),_19=_16.getRecord(_15[1]),_20=(_18&&_18!=Array.LOADING)&&(_19&&_19!=Array.LOADING);;if(_20&&!_17.equals(_15))
{if(!this.frozen){_16.$41a(_17[0],_17[1],_17[2],_17[3],this);this.$409=_15}}
if(!(this.frozen&&(_1==this.$74e||_1=="scrolled"))){_16.updateRecordComponents()}
...
{this.$41d(_8)}else{delete this.$41c}}else if(_6!=null){_5.$41b(null,null,this)}}
...
{if(this.grid.$722!=null){var _5=this.grid.$722[0],_6=this.grid.$722[1];if(_5!=_2||_6!=_3){this.grid.handleErrorIconOut()}}
...
,isc.A.$mk=function isc_GridBody__focusChanged(_1){var _2=this.Super("$mk",arguments);if(_1&&this.grid.isEditable()){var _3=this.grid,_4=isc.EH.lastEvent;if(_3.editOnFocus&&_3.isEditable()&&_3.getEditRow()==null&&!(_4.target==this&&(_4.eventType==isc.EH.MOUSE_DOWN||_4.eventType==isc.EH.MOUSE_UP||_4.eventType==isc.EH.CLICK||_4.eventType==isc.EH.DOUBLE_CLICK)))
{if(_3.$41e){delete _3.$41e}else{var _5=_3.findNextEditCell(0,0,true,true);if(_5!=null)
_3.handleEditCellEvent(_5[0],_5[1],isc.ListGrid.FOCUS)}}}
return _2}
,isc.A.updateRowSelection=function isc_GridBody_updateRowSelection(_1){var _2=this.grid;if(!_2)return;if(_2.showSelectionCanvas)_2.updateSelectionCanvas();if(!_2.$41f){this.invokeSuper(isc.GridBody,"updateRowSelection",_1)}
if(_2.getCurrentCheckboxField()!=null){var _3=_2.getCheckboxFieldPosition();if(_2&&!_2.$41f)_2.refreshCell(_1,_3);var _4=(isc.isAn.Array(_2.data)||(isc.isA.ResultSet(_2.data)&&_2.data.allMatchingRowsCached())),_5=_2.getSelection()||[];if(_4){if(_5.length==_2.data.getLength()){_2.$41g(true)}else{_2.$41g(false)}}}else if(_2.getTreeFieldNum&&_2.selectionAppearance=="checkbox"){var _6=_2.getTreeFieldNum();if(!_2.$41f){_2.refreshCell(_1,_6)}}}
...
,isc.A.moved=function isc_GridBody_moved(_1,_2,_3,_4){this.invokeSuper(null,"moved",_1,_2,_3,_4);var _5=this.grid;if(_5.$404){_5.$4r.itemsMoved()}}
,isc.A.parentMoved=function isc_GridBody_parentMoved(_1,_2,_3,_4){this.invokeSuper(null,"parentMoved",_1,_2,_3,_4);var _5=this.grid;if(_5.$404){_5.$4r.itemsMoved()}}
...
,isc.A.redrawFormItem=function isc_GridBody_redrawFormItem(_1,_2){var _3=this.grid;if(_3&&(_1.form==_3.$4r)){var _4=_3.getEditRow(),_5=_3.getColNum(_1.getFieldName());_3.refreshCell(_4,_5,false,true)}else
...
return _1}
,isc.A.$414=function isc_ListGrid__formatDateCellValue(_1,_2,_3,_4,_5,_6){if(isc.isA.Date(_1)){var _7=_2&&_3.$41p[_2.type],_8=_3.$415(_2);if(_7)return _1.toShortDateTime(_8,true);return _1.toShortDate(_8)}
return _1}
,isc.A.$415=function isc_ListGrid__getDateFormatter(_1){var _2;if(_1)_2=(_1.displayFormat||_1.dateFormatter||_1.formatter);if(!_2){if(_1&&this.$41p[_1.type]&&this.datetimeFormatter){_2=this.datetimeFormatter}else{_2=this.dateFormatter}}
return _2}
...
return _1}
,isc.A.$418=function isc_ListGrid__getTimeFormatter(_1){var _2;if(_1)_2=(_1.displayFormat||_1.timeFormatter||_1.formatter);if(!_2)_2=this.timeFormatter;return _2}
...
if(_7!=null){var _8=_3.$418(_2);return isc.Time.toTime(_7,_8)}
return _1}
,isc.A.$42a=function isc_ListGrid__formatBinaryCellValue(_1,_2,_3,_4,_5,_6){if(isc.isA.String(_1))return _1;if(_4==null)return null;var _7=_2.name,_8=_4[_7+"_filename"],_1;if(_2.type=="imageFile"&&_2.showFileInline==true){var _9=_7+"$320";if(!_4[_9]){var _10=isc.Canvas.getFieldImageDimensions(_2,_4),_11=_3.getDataSource().streamFile(_4,_2.name);_10.width=_10.width||_3.imageSize;_10.height=_10.height||_3.imageSize;_1=_4[_9]=isc.Canvas.imgHTML(_11,_10.width,_10.height)}else
_1=_4[_9]}else{if(_2.showFileInline==true){this.logWarn("$42a(): Unsupported field-type for showFileInline: "+_2.type)}
...
return _1}
,isc.A.$42b=function isc_ListGrid__formatLinkCellValue(_1,_2,_3,_4,_5,_6){if(_1==null||isc.is.emptyString(_1))return _1;var _7=_2.target?_2.target.replaceAll(_3.$rd,_3.$41r):_3.$41s;var _8=(_4&&_4[_3.linkTextProperty])?_4[_3.linkTextProperty]:_2[_3.linkTextProperty]||_1;var _9=_1;if(_2.linkURLPrefix)_9=_2.linkURLPrefix+_9;if(_2.linkURLSuffix)_9=_9+_2.linkURLSuffix;_9=_9.replaceAll(_3.$rd,_3.$41r);if(_7=="javascript"){_9="javascript:void"}
var _10=_3.$41q;_10[1]=_9;_10[3]=_7;var _11=_3.getID();_10[5]=_11;_10[7]=_11;_10[9]=_5;_10[11]=_6;_10[13]=_8;return _10.join(isc.emptyString)}
...
{if(!this.$18o(_1,_7)){return false}}
...
,isc.A.getExpansionField=function isc_ListGrid_getExpansionField(){var _1=this,_2={width:this.$42o()+this.expansionFieldExtraWidth,getAutoFreezePosition:function(){return _1.getExpansionFieldPosition()}};_2.valueIconWidth=this.$42o();_2.valueIconHeight=this.$42p();isc.addProperties(_2,this.expansionFieldDefaults,this.expansionFieldProperties);_2.title="&nbsp;";return _2}
...
,isc.A.collapseRecord=function isc_ListGrid_collapseRecord(_1){if(_1.expanded){if(this.onCollapseRecord!=null&&!this.onCollapseRecord(_1))return;if(this.$42q&&this.$42q==_1)
delete this.$42q;var _2=_1.$23.find("isExpansionComponent",true);this.removeEmbeddedComponent(_1,_2?_2:this.frozenFields?this.frozenFields.length:0);this.$413--}
_1.expanded=false;this.$42r();this.markForRedraw()}
...
this.data.destroy()}
if(_1)this.data=_1;if(!this.data)return;this.$43x(this.data);this.regroup(true);if(!this.selection||(this.data!=this.selection.data)){this.createSelectionModel()}
if(this.preserveEditsOnSetData)this.$43y();var _2=isc.ResultSet&&isc.isA.ResultSet(this.data)&&!this.data.lengthIsKnown();if(!_2&&this.$43z()&&!this.$404){this.startEditing()}
...
if(this.summaryRow&&this.showGridSummary)this.summaryRow.recalculateSummaries();this.$413=0;if(!this.canExpandMultipleRecords&&this.$42q)
...
,isc.A.groupTreeChanged=function isc_ListGrid_groupTreeChanged(){if(this.$438)return;if(!this.$439)this.$43y();var _1=this.getTotalRows()-1;if(this.body){if(this.body.lastOverRow>_1)delete this.body.lastOverRow;if(this.body.$44a>_1)delete this.body.$44a}
...
this.calculateRecordSummaries();var _10=this.groupByField;if(_10!=null&&!this.$44h){if(_1=="add"||_1=="remove"||_1=="replace"||(_1=="update"&&(_2==null||_3==null)))
...
if(this.body)this.body.finishRowAnimation();if(!this.$439)this.$43y();this.$42r();if(this.$43z()&&!this.$404){this.startEditing()}
var _16=this.getTotalRows()-1;if(this.body){if(this.body.lastOverRow>_16)delete this.body.lastOverRow;if(this.body.$44a>_16)delete this.body.$44a}
if(this.$44b>_16)delete this.$44b;if(this.hilites)this.applyHilites();if(!this.$44c){if(_6)this.updateFieldWidthsForAutoFitValue(this.$74e);this.$432(this.$74e);if(this.summaryRow&&this.showGridSummary)this.summaryRow.recalculateSummaries()}
...
,isc.A.showField=function isc_ListGrid_showField(_1,_2){arguments.$db=this;var _3=_1;_3=this.getSpecifiedField(_3);if(_3==null){this.logWarn("showField(): unable to find field object for field: "+_1+". Taking no action. Call setFields() to add new fields.")
return}
if(_3.showIf!=null)_3.showIf=null;var _4=this.completeFields!=null
if(!_4||this.frozenFields||_3.frozen||this.$44l){this.setFields(this.completeFields||this.fields);this.fieldStateChanged();return}else{if(this.fields.contains(_3))return;this.deriveVisibleFields()}
var _5=this.fields.indexOf(_3),_6=this.$2v();if(_6!=null&&_6>=_5){this.$44i(_6+=1)}
var _7=this.header;if(_7!=null){if(!_2)this.header.hPolicy="fill";this.header.addButtons([_3],_5)}
if(this.body){if(this.getEditCol()!=null&&this.getEditCol()>=_5){this.$42i+=1}
if(this.$404&&!this.editByCell||this.getEditCol()==_5){var _8=this.getEditRow(),_9=this.getRecord(_8),_10=this.getEditedRecord(_8),_11=this.getEditFormItemFieldWidths(_9)[_5],_12=this.getEditItem(_3,_9,_10,_8,_5,_11);if(_12!=null){var _13;if(this.editByCell)_13=0;else{var _14=this.$4r.getItems();for(var i=0;i<_14.length;i++){var _16=_14[i].colNum;if(_16>=_5){if(_13==null)_13=i;_14[i].colNum+=1}}}
var _17=this.body.getDrawArea();if(this.editByCell||_5>=_17[2]&&_5<=_17[3])
this.$4r.addItems([_12],_13)}}
...
,isc.A.hideField=function isc_ListGrid_hideField(_1,_2){arguments.$db=this;var _3=_1;_3=this.getSpecifiedField(_3);if(_3==null){this.logWarn("hideField(): unable to find field object for field: "+_1+". Taking no action. To add this field use the setFields() method.")
return}
_3.showIf=this.$11;if(!this.fields.contains(_3)){return}
...
_12.destroy()}
if(_6){var _13=this.$4r,_14=_13.getItems();for(var i=_14.length-1;i>=0;i--){if(_14[i].colNum<=_4)break;_14[i].colNum-=1}}
...
if(_6){if(!this.editByCell){var _16=this.$4r.getItem(_5);if(_16!=null){this.$4r.removeItems([_16])}}}
...
this.$42r();this.fieldStateChanged()}
...
var _2=this.$2v(),_3=(_2!=null&&this.fields?this.fields[_2]:null);var _4=this.$404,_5=this.getEditRow(),_6=this.getEditCol(),_7=this.$4r,_8=this.fields?this.getEditFieldName():null;if(this.completeFields==null)this.fields=[];this.completeFields=this.bindToDataSource(_1,this.canPickOmittedFields);if(this.completeFields==null)this.completeFields=[];if(this.shouldShowRowNumberField()){var _9=this.getCurrentRowNumberField(),_10=this.getRowNumberFieldPosition(),_11=!_9;if(_11)_9=this.getRowNumberField();if(_11)this.completeFields.addAt(_9,_10);else this.completeFields.slideList([_9],_10)}
...
if(_4){if(_19){this.showInlineEditor(_5,_18,false,false,true);if(_20)_7.$18k(_30)}else{this.$44m(_5,_18,!_20)}
if(_20){var _30=this.getEditFieldName();if(_30==_8){_7.$18k(_30)}else{_7.focusInItem(_30)}}}
if(this.$2v()!=null&&this.canSort)this.resort();if(this.filterEditor!=null)this.filterEditor.setFields(this.completeFields.duplicate());if(this.summaryRow&&this.showGridSummary){this.summaryRow.setFields(this.completeFields.duplicate());this.summaryRow.recalculateSummaries()}}
...
,isc.A.shouldShowCheckboxField=function isc_ListGrid_shouldShowCheckboxField(){return(this.selectionAppearance==this.$19f&&this.selectionType!=this.$ox&&!isc.isA.TreeGrid(this))}
...
,isc.A.layoutChildren=function isc_ListGrid_layoutChildren(_1,_2,_3){isc.Canvas.$cc.layoutChildren.call(this,_1,_2,_3);if(this.body!=null){this.$401(_1,_2,_3);if(this.frozenBody){var _4=this.shrinkForFreeze&&this.body.hscrollOn;var _5=this.bodyLayout.getInnerHeight();if(_4)_5-=this.body.getScrollbarSize();this.frozenBody.setHeight(_5);this.frozenBody.$ss=_5}}}
,isc.A.$401=function isc_ListGrid__updateFieldWidths(_1,_2,_3){if(this.body==null)return;this.$37q=null;if(this.fields&&!this.fields.$433){var _4=this.getAutoFitValueWidths(null,true);if(_4!=null){for(var i=0;i<this.fields.length;i++){if(_4[i]==null)continue;var _6=this.fields[i];var _7=_6.width||this.minFieldWidth;if(_7<_4[i]){_6.$435=_4[i];var _8=this.getFieldHeaderButton(i);if(_8!=null){_8.setWidth(_4[i]);_8.parentElement.reflow()}}else if(_6.$435!=null){_6.$435=null;var _8=this.getFieldHeaderButton(i);if(_8!=null){_8.setWidth(_7);_8.parentElement.reflow()}}}
...
var _7=this.$2v();if(this.header&&_7!=null)this.header.selectButton(_7);this.bodyScrolled();return this}
...
return false}
,isc.A.prepareForDraw=function isc_ListGrid_prepareForDraw(){if(this.completeFields==null)this.setFields(this.fields);if(this.getEditRow()==null){var _1=this.$43z();if(_1)this.startEditing()}
...
if(_8!==_10){return _8}else{if(_1==null)return this.emptyCellValue;if(this.data.getFieldValue&&_5){_9=this.data.getFieldValue(_1,_6,_5)}else if(_1.ownerDocument&&_5){_9=isc.xml.getFieldValue(_1,_6,_5)}else{if(_7!=null){_9=isc.Canvas.$1y(_7,_1)}else{_9=_1[_6]}}}
...
_1=this.$42l(_2,_3)}else{if(_1[this.isSeparatorProperty])return this.$42x;if(_1.$2k){if(this.groupTitleField&&this.fields[_3].name!=this.groupTitleField){return" "}else{return this.getGroupNodeHTML(_1,_4)}}}
...
return"&nbsp;"}
_11=(this.$404&&this.$39v==_2&&(!this.editByCell||this.$42i==_3)&&this.canEditCell(_2,_3));if(_11){_6=this.getEditItemCellValue(_1,_2,_3)}else if(this.$444(_3)&&this.canEditCell(_2,_3)){_6=this.getInactiveEditorCellValue(_1,_2,_3);_11=true}else{var _5=this.fields[_3],_12,_13;if(_5.displayField!=null){_13=!_5.valueMap&&!_5.getCellValue&&this.$17h(_5);if(_13){var _14=_5.displayField;_12=this.getRawCellValue(_1,_2,_14,true)}}
...
if(_10){if(!_16||isc.isAn.emptyString(_16))_16=this.emptyCellValue;_6=_16}else{_6=this.$28x(_6,_1,_5,_2,_3);var _17=this.getFieldHilites(_1,_5);if(_17)_6=this.applyHiliteHTML(_17,_6);if(_16){if(_5.valueIconOrientation!=isc.Canvas.RIGHT)
_6=_16+_6;else
_6=_6+_16}}
...
return this.getCellValue(_1,_4,_6,this.body);if(_3==null)_3=this.getRawValue(_1,_2);var _7=this.$28x(_3,_1,_5,_4,_6);return _7}
...
,isc.A.$17h=function isc_ListGrid__useDisplayFieldValue(_1){return _1&&_1.displayField&&(_1.displayField!=_1.name)&&(!_1.optionDataSource||isc.DS.get(_1.optionDataSource)==this.getDataSource())}
...
,isc.A.$28x=function isc_ListGrid__formatCellValue(_1,_2,_3,_4,_5){if(_3&&_3.formatCellValue!=null){_1=_3.formatCellValue(_1,_2,_4,_5,this)}else if(_3&&_3.cellValueTemplate){_1=_3.cellValueTemplate.evalDynamicString(this,{value:_1,record:_2,field:_3})}else if(this.formatCellValue!=null){_1=this.formatCellValue(_1,_2,_4,_5)}else if(_3&&_3.$12t!=null){_1=_3.$12q.shortDisplayFormatter(_1,_3,this,_2,_4,_5)}else if(_3&&_3.$44j!=null){_1=_3.$44j(_1,_3,this,_2,_4,_5)}
if(_3.userSummary){_1=this.getSummaryFieldValue(_3,_2)}
if(_1==null||isc.is.emptyString(_1)){if(_3.emptyCellValue!=null){_1=_3.emptyCellValue}else if(_3.type=="summary"){_1=this.invalidSummaryValue}else{_1=this.emptyCellValue}}else if(this.$42z[_1]==true){_1=this.$297}else if(!isc.isA.String(_1)){_1=isc.iscToLocaleString(_1)}
...
delete _3.$445}
);isc.evalBoundary;isc.B.push(isc.A.$406=function isc_ListGrid__clearingInactiveEditorHTML(_1,_2){if(!this.$4r||!this.$43z((_2!=null?this.getField(_2):null),true))return;if(_1!=null){var _3="_"+_1+"_"+_2,_4=this.$446[_3];if(_4){_4.formItem.clearInactiveEditorContext(_4);delete this.$446[_3]}}else{var _5=this.getEditForm(),_6=_5.getItems();for(var i=0;i<_6.length;i++){_6[i].clearAllInactiveEditorContexts()}
delete this.$446}}
...
,isc.A.setRawCellValue=function isc_ListGrid_setRawCellValue(_1,_2,_3,_4){var _5=this.fields[_3];if(!_1||!_5)return;if(_5.setRawCellValue){isc.Func.replaceWithMethod(_5,"setRawCellValue","viewer,record,recordNum,field,fieldNum,value");_5.setRawCellValue(this,_1,_2,_5,_3,_4)}else{if(_5.dataPath){isc.Canvas.$1x(_5.dataPath,_4,_1)}else{_1[_5[this.fieldIdProperty]]=_4}}
...
if((_2.$37q==null||(_2.$37q.length==0&&_2.fields.length>0))||(_3&&(_3.$37q==null||(_3.$37q.length==0&&_3.fields.length>0))))return;this.$74k=true;var _4=this.$74l||[],_5=this.$74m||{};this.$74m={};this.$74l=[];if(this.showRecordComponents||this.showBackgroundComponents){var _6=this.body.getDrawArea(),_7=this.showRecordComponentsByCell,_8=this.body.getID(),_9=this.frozenBody?this.frozenBody.getID():null;if(_1){this.logDebug("updating to potentially show recordComponents for drawArea:"+_6,"recordComponents")}
...
var _3=this.recordComponentPoolingMode;if(_2)_3="viewport";if(_3=="data"){}else{var _4=isc.Canvas.getById(_1.$390),_5=_1.embeddedRecord,_6=_1.$74d;delete _5.$74r[_6];if(_4!=null){_4.removeEmbeddedComponent(_1.embeddedRecord,_1)}
...
var _11=this.isEditable()&&(this.editEvent==isc.EH.CLICK||this.editOnFocus);if(_5.canToggle&&this.canEditCell(_2,_3)&&this.shouldToggle(_5)){var _12=this.getEditorValueMap(_5,this.getEditedRecord(_2,_3));if(_12==null&&isc.SimpleType.getBaseType(_5.type)==this.$hy){_12=[true,false]}
...
return _9}
,isc.A.selectAllRecords=function isc_ListGrid_selectAllRecords(){this.$41f=true;this.selection.selectAll();this.$41f=null;this.$432("select all")}
,isc.A.deselectAllRecords=function isc_ListGrid_deselectAllRecords(){this.$41f=true;this.selection.deselectAll();this.$41f=null;this.$432("deselect all")}
,isc.A.bodyKeyPress=function isc_ListGrid_bodyKeyPress(_1,_2){if(this.data.getLength()>0){var _3=isc.EventHandler,_4=_1.keyName;var _5=this.editOnKeyPress&&this.isEditable();if(_5&&this.$45o(_1,_2))return false;if(_4==this.$30v){return this.$15r(-1)}else if(_4==this.$30w){return this.$15r(1)}else if(_4==this.$421){if(this.generateClickOnSpace)
if(this.$15s()==false)return false;if(this.generateDoubleClickOnSpace)
return this.$45p()}else if(_4==this.$15u){if(this.generateClickOnEnter)
...
if(_2==this.$426)this.$15t(_3);else{if(_3==_4){var _7=this.$45r();if(this.body.selectionEnabled()&&this.recordIsEnabled(_3,_7))
...
,isc.A.$45s=function isc_ListGrid__generateRecordClick(_1){this.clearLastHilite();if(isc.isAn.Object(_1))_1=this.getRecordIndex(_1);if(!isc.isA.Number(_1)||_1<0)_1=0;if(_1>=this.data.getLength())_1=this.data.getLength()-1;this.body.$44a=_1;var _2=this.$45r();var _3=(this.body.selectionEnabled()&&this.recordIsEnabled(_1,_2));if(_3)this.selection.selectOnMouseDown(this,_1,_2);this.rowClick(this.getCellRecord(_1,_2),_1,_2,true);if(_3)this.selection.selectOnMouseUp(this,_1,_2);return false}
...
,isc.A.bodyScrolled=function isc_ListGrid_bodyScrolled(_1,_2,_3){if(_3){this.body.$721=true;var _4=this.frozenBody;if(_4.$374){this.body.$37y=_4.$37y;this.body.$37z=_4.$37z;this.body.$371=_4.$371;this.body.$370()}else{this.body.scrollTo(null,_2)}
delete this.body.$721
return}
if(this.frozenBody!=null){this.frozenBody.$721=true;var _5=this.body,_4=this.frozenBody;if(_5.$374){_4.$37y=_5.$37y;_4.$37z=_5.$37z;_4.$371=_5.$371;_4.$370()}else{_4.scrollTo(null,_2)}
...
,isc.A.$y6=function isc_ListGrid__setTabIndex(_1,_2,_3,_4){this.invokeSuper(isc.ListGrid,"$y6",_1,_2,_3,_4);if(this.header!=null&&this.canTabToHeader)this.header.$y6(_1,false);if(this.body!=null)this.body.$y6(_1,false)}
...
,isc.A.showSummaryRow=function isc_ListGrid_showSummaryRow(){if(this.summaryRow&&this.summaryRow.masterElement==this)return;if(!this.summaryRow){var _1;if(this.completeFields)_1=this.completeFields.duplicate();else if(this.fields)_1=this.fields.duplicate();this.summaryRow=this.createAutoChild("summaryRow",{warnOnReusedFields:false,autoDraw:false,top:this.getBottom()-this.summaryRowHeight,left:this.getLeft()+this.getLeftMargin(),showHeader:false,height:this.summaryRowHeight,getBaseStyle:function(){return this.creator.summaryRowStyle},disabled:this.disabled,width:this.getWidth(),bodyOverflow:"hidden",$45a:function(){},$44k:function(_7){if(!this.creator.shouldShowGridSummary(_7))return false;return this.Super("$44k",arguments)},dataSource:this.getSummaryRowDataSource(),getTotalRows:function(){return 1},recalculateSummaries:function(){if(this.dataSource!=null){var _2=this.creator.getSummaryRowCriteria(),_3=isc.ResultSet&&isc.isA.ResultSet(this.data)&&!this.data.willFetchData(_2);this.fetchData(_2,null,this.creator.getSummaryRowFetchRequestConfig());if(_3)this.invalidateCache();return}
delete this.$27;this.markForRedraw();return this.getRecord(0)},getCellRecord:function(_10,_11){if(this.dataSource!=null)return this.Super("getCellRecord",arguments);if(_10!=0)return null;if(this.$27){return this.$27}
this.$27={};this.$27[this.creator.gridSummaryRecordProperty]=true;this.$27[this.recordCanSelectProperty]=false;var _4=this.completeFields||this.fields,_5=[];for(var i=0;i<_4.length;i++){var _7=_4[i],_8=_4[i].name;if(!this.creator.shouldShowGridSummary(_7))continue;this.$27[_8]=this.creator.getGridSummary(_7)}
return this.$27},fields:_1,getFieldWidths:function(){return this.creator.getFieldWidths()},$28x:function(_10,_11,_7,_12,_13){var _9=this.creator;if(_9.shouldShowGridSummary(_7)){if(_10==null)return this.invalidSummaryValue;if(_7.formatGridSummary){if(!isc.isA.Function(_7.formatGridSummary)){_7.formatGridSummary=isc.Func.expressionToFunction("value",_7.formatGridSummary)}
if(isc.isA.Function(_7.formatGridSummary)){return _7.formatGridSummary(_10)}}
return this.Super("$28x",arguments)}
return(_7.emptyCellValue!=null?_7.emptyCellValue:this.emptyCellValue)},$kj:false,$qz:true,masterResized:function(_10,_11){if(_10!=null){this.setWidth(this.masterElement.getWidth())}
if(_11!=null){this.setTop(this.masterElement.getBottom()-
this.masterElement.summaryRowHeight)}}});this.addPeer(this.summaryRow)}else{this.summaryRow.setDataSource(this.getSummaryRowDataSource());this.summaryRow.setFields(this.completeFields.duplicate());this.summaryRow.moveTo(this.getBottom()-this.summaryRowHeight);this.summaryRow.setLeft(this.getLeft()+this.getLeftMargin());this.summaryRow.setWidth(this.getWidth());this.summaryRow.recalculateSummaries();this.addPeer(this.summaryRow);this.summaryRow.setBodyFieldWidths(this.$37q.duplicate());this.syncSummaryRowScrolling(this.body.getScrollLeft(),this.body.getScrollTop)}
this.summaryRow.moveAbove(this);this.$z5(this.summaryRow,isc.Canvas.BOTTOM);if(this.isDrawn()){this.clear();this.draw()}}
...
,isc.A.setFilterValues=function isc_ListGrid_setFilterValues(_1){this.$45w=_1||{};this.updateFilterEditor()}
...
,isc.A.$45x=function isc_ListGrid__getFilterEditorValues(){var _1=this.$45w;if(this.updateFilterEditorValues!=null){_1=this.updateFilterEditorValues(_1,this.autoFetchTextMatchStyle)}
...
var _8;if(!this.$404){var _9=this.makeEditForm(_1,_2);if(this.$43z()&&_9){this.logInfo("Edit Form rebuilt with alwaysShowEditors:true, requires full redraw","inactiveEditorHTML");_8=true}}
this.$39v=_1;this.$42i=_2;this.$44b=_1;this.$46c(_1,_2,_8);if(this.body){var _10;if(!_6)_10=true;else{var _11=this.body,_12=_11.getRowTop(_1),_13=_11.getRowSize(_1),_14=_11.getScrollTop(),_15=_11.getViewportHeight();_10=(_12<_14)||(_12+_13>_14+_15)}
if(_10&&!this.suppressEditScrollIntoView)this.scrollCellIntoView(_1,_2,false)}
if(!this.isDrawn())return;this.$46d();var _16=this.getEditorName(_1,_2),_17=this.$4r.getItem(_16);if(_17==null){this.logWarn("ListGrid showing inline editor. Unable to get a pointer to the edit "+"form item for field:"+_16);return}
if(_3)_17.$42k=true;if(_4)_17.$42j=true;if(!_5){if(isc.Browser.isMoz){var _18=this.body.getClipHandle(),_19=_18.scrollTop}
var _20=isc.EH.lastEvent;var _21=(isc.Browser.isIE&&_20.eventType==isc.EH.MOUSE_DOWN&&_20.target!=this.$4r);if(isc.Browser.isIE){var _22=isc.ListGrid.$46e;if(_22&&(_22.hasFocus||_22.itemHasFocus()))_21=true}
if(_21){this.$46f=isc.Timer.setTimeout(this.$4r.getID()+".focusInItem('"+_16+"');",0)}else{if(isc.Browser.isMoz&&this.body.overflow==isc.Canvas.VISIBLE){this.adjustOverflow()}
this.$4r.focusInItem(_16)}}}
,isc.A.$46c=function isc_ListGrid__showEditForm(_1,_2,_3){var _4=this.$404;this.$404=true;if(!this.isDrawn()||!this.body)return;var _5=this.isEmpty()||(!_4&&(_1>=this.data.getLength())&&(this.showNewRecordRow||(this.body.getTableElement(_1)==null)));var _6=this.$43z();var _7=this.getCellRecord(_1,_2);if(_7&&_7.$23!=null&&_7.$23.length>0){_3=true}
...
var _5,_6;if((_2.$4p==null)||_2.isDirty()||_2.$405){var _7=_2.getDrawArea();_5=_7[2];_6=_7[3]}else{_5=_2.$4p;_6=_2.$38a}
...
);isc.evalBoundary;isc.B.push(isc.A.$46r=function isc_ListGrid__editorGetAutoComplete(){var _1=this.grid;if(!_1)return null;var _2=_1.getField(this.getFieldName());if(_2.autoComplete!=null)return _2.autoComplete;if(_1.autoComplete!=null)return _1.autoComplete;return this.Super("$25o",arguments)}
...
_8.type=_1.type;_8.editorType=this.getEditorType(_1,_2);var _19=_8.editorType;if(this.$429[_19]==true||this.$43a[_19]==true||(_1.type==this.$h0&&_19==null)){_8.editorType=(this.$43a[_19]==true?this.$43b:this.$h0);_8.useTextField=true;_8.cellPadding=0;_8.itemCellStyle=null;_8.pickerIconHSpace=0;var _20=this.$415(_1);if(_20)_8.displayFormat=_20;var _21=this.$416(_1);if(_21)_8.inputFormat=_21}
if(this.$428[_19]==true||(_1.type==this.$h1&&_19==null)){var _20=this.$418(_1);if(_20)_8.displayFormat=_20}
if(this.$43c[_19]==true){_8.getTextBoxStyle=function(){var _22=this.grid,_2=_22.getCellRecord(this.rowNum,this.colNum);this.textBoxStyle=_22.getCellStyle(_2,this.rowNum,this.colNum);return this.Super("getTextBoxStyle",arguments)}
_8.gridCellStyleChanged=function(_2,_4,_5,_25){var _23=this.$4l();if(_23){_23.className=this.textBoxStyle=_25}}
...
this.$460(_1,_4,_2);if(_3||!this.isDrawn()||!this.body){if(this.summaryRow&&this.showGridSummary)this.summaryRow.recalculateSummaries();return}
if(_1<this.data.getLength())
this.calculateRecordSummaries([this.data.get(_1)])
var _10=(_7||this.body.isDirty());if(_10){var _11=this.isEditingRecord(_1,_4)&&this.$4r!=null
if(_11)this.$46k();this.body.markForRedraw();if(this.summaryRow&&this.showGridSummary){this.summaryRow.recalculateSummaries()}}else{this.$461(_1,_4,_6)}}
,isc.A.$461=function isc_ListGrid__displayNewEditValues(_1,_2,_3,_4){if(!_3){return}
var _5=this.isEditingRecord(_1,_2)&&this.$4r!=null
for(var _6 in _3){var _7=this.getColNum(_6);var _8;if(_5){this.$4r.setValue(_6,_3[_6]);var _9=this.$4r.getItem(_6);_8=(_7>=0&&_9&&this.canEditCell(_1,_7))}
...
if(_8!=null){_9=_8.$44r;_10=isc.Canvas.$1y(_3,_9)}else{this.logInfo("creating new edit values for row: "+_1,"gridEdit");this.initializeEditValues(_1,_2,true);_8=this.getEditSession(_1,_2);_9=_8.$44r}
if(_10===_11){var _12=this.getCellRecord(_1,_2);_10=_12?isc.Canvas.$1y(_3,_12):null}else _7=true;var _13=this.getField(_3);if(this.fieldValuesAreEqual(_13,_10,_4))_6=false;if(_4===_11){isc.Canvas.$1w(_3,_9)}else if(_7||_6){isc.Canvas.$1x(_3,_4,_9)}
...
,isc.A.$443=function isc_ListGrid__getEditValue(_1,_2){var _3=this.$42l(_1,_2);if(_3==null)return;if(!isc.isA.String(_2))_2=this.getEditorName(_1,_2,true);return isc.Canvas.$1y(_2,_3)}
...
if(this.body)this.body.markForRedraw("clear edit values, remove row")}}else if(_5!=null&&!_3){var _12={},_13=this.data.get(_5);for(var _14 in _6.$44r){_12[_14]=_13?_13[_14]:null}
this.$461(_5,_2,_12,_6.$469)}}
...
delete _3.$462}
,isc.A.$43y=function isc_ListGrid__remapEditRows(_1){delete this.$463;delete this.$47c;if(this.$44q==null)return;var _2=this.getEditRow(),_3=this.getEditCol(),_4=false;var _5=this.data.getLength(),_6={};var _7=isc.getKeys(this.$44q);for(var i=0;i<_7.length;i++){var _9=_7[i],_10=this.$44q[_9];var _11=this.$47d(_10,_5);if(_10.$46x==null)_5++;if(_11==null)continue;var _12=_11[0],_13=_11[1];if(_12!=null&&_12>=0){if(_2!=null&&_2==_10.$38t&&(!this.useCellRecords||(_3==_10.$46y)))
{_4=true;if(!_1)this.$47b(_12,_13,"remapEditRows")}
_6[_12]=_9;_10.$38t=_12;if(this.useCellRecords)_10.$46y=_13}else{var _14=this.getOriginalData();var _15=!this.dataSource||this.saveLocally||(isc.ResultSet&&isc.isA.ResultSet(_14)&&_14.allRowsCached());if(_15&&(!this.isGrouped||!this.data.find(_10.$46x)))
{this.logWarn("Record:"+this.echo(_10.$46x)+", is no longer present in this List.<br>Clearing edit values for this record.");delete this.$44q[this.getEditValuesID(_9)]}else{this.logWarn("Record:"+this.echo(_10.$46x)+(_15?", hidden in grouped tree data. ":", lost from local cache in paged result set. ")+"Pending edits for this record will be maintained.");delete _10.$38t;delete _10.$46y;this.$47c=true}}}
this.$46w=_6;if(_2!=null&&!_4&&!_1){this.hideInlineEditor(true)}}
,isc.A.$42r=function isc_ListGrid__remapEmbeddedComponents(){if(!this.body||this.body.$23==null)return;var _1=this.body.$23,_2=[];for(var i=0;i<_1.length;i++){var _4=_1[i],_5=_4.embeddedRecord,_6=this.getPrimaryKeys(_5),_7=this.findRowNum(_6),_8;if(_7>=0){_8=this.data.get(_7);if(!_8.$23)_8.$23=[];if(!_8.$23.contains(_4)){_4.$39y=_7;_4.embeddedRecord=_8;_8.$23.add(_4);if(_4.isExpansionComponent)_8.expanded=true}}else{if(this.$47e==false||(this.showRecordComponents&&this.recordComponentPoolingMode=="data")){_2.add(_4)}}}
...
return}}
this.setFilterValues(_2);return this.Super("$2f",[_1,_2,_3,_4],arguments)}
...
,isc.A.storeUpdatedEditorValue=function isc_ListGrid_storeUpdatedEditorValue(_1){if(!this.isDrawn()||!this.$404)return;var _2=this.getEditRow(),_3=this.getEditCol(),_4=this.getField(_3),_5=this.$4r,_6=this.getEditFormItem(_3),_7;if(_6){if(_6.$17m())_6.updateValue();_7=this.$47m(_6.getValue(),_4,_2,_3);var _8;if(_7===_8)_7=null;this.setEditValue(_2,_3,_7,true,_1)}}
...
);isc.evalBoundary;isc.B.push(isc.A.saveAndEditPreviousCell=function isc_ListGrid_saveAndEditPreviousCell(){this.$47o(-1,true)}
...
var _11=this.recordHasChanges(_3,_4,false);if(this.$453()){this.$74c=(_5||_11);var _12;if(this.useCellRecords){_12=!this.validateCell(_3,_4)}else{_12=!this.validateRow(_3)}
if(_12){if(!_5)this.$47r(_10,_2);return false}}
if(_5)return true;if(!_11){this.logInfo("saveEdits: no actual change, not saving","gridEdit");this.$46i(_8,_4);this.$47s(_2,_3,_4,_1,true);return}
_6=this.$42l(_3,_4);this.logInfo("Saving newValues '"+isc.echoAll(_6)+"'","gridEdit");this.rememberSubmittedEditValues(_3,_4);_6=isc.addProperties({},_6);var _13=this.saveEditedValues(_3,_4,_6,_9,_8,_1,_2);if(_13===false){this.$47r(_10,_2);return false}
return true}
...
var _7=(this.dataSource!=null&&!this.saveLocally),_8=false;if(_7)_8=!isc.RPCManager.startQueue();var _9=this.$43i++,_10=this.$47t[_9]=[];this.$47u[_9]=_2;var _11=false;for(var i=0;i<_1.length;i++){if(_1[i]==null)continue;var _4=_1[i],_5;if(isc.isAn.Array(_4)){_5=_4[1];_4=_4[0]}
if(!this.recordHasChanges(_4,_5))continue;_11=true;_10[_10.length]=_1[i];var _12="this.$47v(rowNum,"+_9+",colNum,editCompletionEvent,success)";this.saveEdits(null,_12,_4,_5)}
...
,isc.A.saveEditedValues=function isc_ListGrid_saveEditedValues(_1,_2,_3,_4,_5,_6,_7){var _8={editValuesID:_5,rowNum:_1,colNum:_2,values:_3,oldValues:_4,editCompletionEvent:_6};if(this.shouldSaveLocally())return this.$47w(_8,_7);if(isc.Offline&&isc.Offline.isOffline()&&!this.dataSource.clientOnly){isc.warn(this.offlineSaveMessage);return false}
var _9=this.getID()+".$47x(dsResponse, dsRequest)",_10={operation:(_4==null?this.addOperation:this.updateOperation)||this.saveOperation,application:this.application,willHandleError:true,showPrompt:this.shouldWaitForSave(),oldValues:_4,$47y:this.getRecord(_1,_2),clientContext:{saveCallback:_7,newValues:_3,editInfo:_8},componentId:this.ID};this.$47z(_3,_4);if(this.$439==null)this.$439={};this.$439[_8.editValuesID]=true;var _11=isc.DS.get(this.dataSource);if(_4==null){var _12=isc.addProperties({},_4,_3);_11.addData(_12,_9,_10)}else{var _13=isc.DS.get(this.dataSource).filterPrimaryKeyFields(_4),_14=isc.addProperties({},_13,_3);_11.updateData(_14,_9,_10)}}
,isc.A.$47w=function isc_ListGrid__saveLocally(_1,_2){var _3=_1.rowNum,_4=_1.colNum,_5=_1.oldValues,_6=_1.values;var _7=this.getCellRecord(_3,_4),_8=(_7==null);if(_8){var _9=this.getData();var _10=this.getEditSession(_3);_10.$46x=this.getPrimaryKeys(_6);delete _10.$462;_9.add(_6);_9.dataChanged()}else{var _11,_12;for(var i=0;i<this.fields.length;i++){var _14=this.getEditorName(this.fields[i],i,true);_11=isc.Canvas.$1y(_14,_6);if(_11!==_12)this.setRawCellValue(_7,_3,i,_11)}}
...
,isc.A.$471=function isc_ListGrid__fireCellChanged(_1,_2,_3,_4,_5,_6){var _7,_8;for(var i in _4){var _10=(_5==null?null:_5[i]);if(_4[i]==_10)continue;var _11=this.fields.find(this.fieldIdProperty,i);if(!_11)continue;if(this.isGrouped&&_11&&this.groupByField.contains(_11.name)){_7=true}
...
if(_1.$739||isc.isAn.Object(_1))return _1;if(isc.isA.String(_1))return this.fields.find(this.fieldIdProperty,_1);return null}
...
,isc.A.createBodies=function isc_ListGrid_createBodies(){if(this.body!=null)return;this.$725();this.body=this.createBody(this.ID+"_body",this.normalFields||this.fields);this.bodies=[this.body];this.dragScrollTarget=this.body;var _1=this.frozenFields;if(!_1){this.addChild(this.body);return}
...
isc.addProperties(_4,this.bodyDefaults,this.bodyProperties);this.$48g(_4);_4.completeCreation();return _4}
...
if(_10){_14.show();_14.setLeft(_10.getLeft());_14.setWidth(_11)}},$48o:function(){if(!this.$48k)return;this.$48j();var _13=this.getVisibleHeight();for(var i=0;i<this.$48k.length;i++){var _14=this.$48k[i];this.addChild(_14);var _9=this.members.findAll("name",_14.$48n);if(!_9)continue;for(var j=0;j<_9.length;j++){var _16=_9[j],_17=_16.getVisibleHeight(),_18=_14.getVisibleHeight();if(_18+_17>_13)_16.setHeight(_17-_18)}
_14.bringToFront()}},addButtons:function(_22,_23){this.Super("addButtons",arguments);if(_2.headerSpans)_2.$48p(_22,this);this.$48o()},draw:function(){if(this.$48k&&_2.unspannedHeaderVAlign){for(var i=0;i<this.buttons.length;i++){var _5=this.buttons[i];if(!this.spannedFields.contains(_5.name))_5.valign=_2.unspannedHeaderVAlign}}
this.Super("draw",arguments);this.$48o()},getStandardChildLocator:function(_22){var _19=_22.masterIndex,_2=this.grid;if(_19!=null&&_2!=null){var _20=_2.getFieldName(_19);return isc.AutoTest.createLocatorFallbackPath("headerButton",{fieldName:_20})}
...
if(_16.canResizeItems&&!_16.dontObserve)this.$48q(_16);if(this.headerSpans)this.$48p(_1.buttons,_16);return _16}
...
for(var i=0;i<_3.length;i++){var _6=_3[i];var _7=this;var _8=isc.addProperties(this.getButtonProperties(),{_constructor:_2.buttonConstructor,height:this.headerSpanHeight,align:"center",valign:this.headerSpanVAlign,showRollOver:false,showContextMenu:function(){return _7.headerSpanContextClick(this)}},_6);var _9=_6.liveObject=this.createAutoChild("headerSpan",_8);_9.$48m=this.headerSpanHeight==null;if(_9.$48m){[this.headerSpanDefaults,this.headerSpanProperties,_6].map(function(_10){if(_10&&_10.height!=null)_9.$48m=false})}
_9.$48n=_6.fields;_2.addSpan(_9,_9.fields)}}
...
if(this.canSort==false||!_3||this.$41x(_3)==false)return false;var _4=_3[this.fieldIdProperty],_5=this.isSortField(_4)?this.getSortSpecifier(_4):null,_6=isc.EventHandler,_7=_6.getKey(),_8=_6.shiftKeyDown(),_9=this.$43u,_10=this.getSpecifiedField(_4).sortDirection;if(_8&&this.canMultiSort){if(this.isSortField(_4)){if(_10==_9||this.canUnsort==false){this.toggleSort(_4)}else{this.toggleSort(_4,"unsort")}}else{this.$48s(_4)}}else{if(this.isSortField(_4)&&this.getSortFieldCount()==1){if(_10==_9||this.canUnsort==false){this.toggleSort(_4)}else{this.toggleSort(_4,"unsort")}}else{this.setSort([{property:_4,direction:_9?"ascending":"descending"}])}}
return false}
...
,isc.A.unsort=function isc_ListGrid_unsort(){if(this.data.unsort&&(this.data.unsort()||this.canUnsort)){var _1=this.$2v();var _2=this.getField(_1);if(_2)_2.sortDirection=null;this.sortDirection=this.$43u;this.$44i(null);if(_1!=null&&this.header&&isc.isA.Toolbar(this.header)){this.header.deselectButton(_1);var _3=this.header.getButton(_1);if(_3)_3.setTitle(this.getHeaderButtonTitle(_3))}
if(this.sorter)this.sorter.setTitle(this.sorter.getTitle());if(isc.ResultSet&&isc.isA.ResultSet(this.data)&&this.invalidateCacheOnUnsort){this.data.$48z=null;this.data.invalidateCache()}
return true}
return false}
...
return _2}
,isc.A.toggleSort=function isc_ListGrid_toggleSort(_1,_2){var _3=this.$28?isc.shallowClone(this.$28):[],_4=_3.find("property",_1);if(!_4)return;if(!_2)
...
,isc.A.getSortSpecifier=function isc_ListGrid_getSortSpecifier(_1){var _2=this.$28?this.$28.find("property",_1):null;return _2}
...
for(var i=0;i<this.$28.length;i++){var _7=this.$28[i],_6=_1,_8=this.getUnderlyingField(_7.property),_9=this.getField(_7.property),_10=null;if(_8){if(_9){if(!_3)_3=_9}
...
if(this.unsort)this.unsort();if(_13>=0){this.$44i(_13)}else{this.$44i(null)}
...
if(this.sorter){this.sorter.setTitle(this.sorter.getTitle())}
if(this.body&&this.showRecordComponents)delete this.body.$409;this.$432(this.$43o);if(this.logIsInfoEnabled("sorting"))this.logInfo("Leaving setSort","sorting");return true}
...
{_2.getRange(0,_3-1);this.$44h=true;this.logInfo("postponing grouping until data is loaded","grouping");return}
...
var _4;if(this.groupTree){if(this.retainOpenStateOnRegroup&&(this.groupTree.getLength()>0)&&(this.groupTree.$36z==this.groupByField))
{_4=[];this.$44g(this.groupTree,this.groupTree.getRoot(),_4,true)}
this.ignore(this.groupTree,"changeDataVisibility");this.groupTree.destroy()}
this.groupTree=this.createAutoChild("groupTree",{idField:this.groupIdField,parentIdField:this.groupParentIdField,titleProperty:"groupValue",childrenProperty:"groupMembers",parentProperty:"_groupTree_"+this.ID,showRoot:false,isGroupedOutput:true,$36z:this.groupByField,criteria:this.data.criteria,separateFolders:true,getCriteria:function(){return this.criteria},getChildren:function(_28,_29){var _5=this.Super("getChildren",arguments);if(_29==isc.Tree.FOLDERS_ONLY||_28==this.getRoot()){return _5}
...
var _13=isc.addProperties({},_8[i],_12.$44r);_8[i]=_13}}}
...
_14[_16]=_17}}
_14.customStyle=_6.groupSummaryStyle;_14[_6.recordEnabledProperty]=false;_14[_6.includeInSummaryProperty]=false;_14[_6.groupSummaryRecordProperty]=true;_7.add(_14);return _7}else{return _5}},primaryKeyFields:this.dataSource?this.getDataSource().getPrimaryKeyFieldNames():null,indexOf:function(_28){var _18=this.Super("indexOf",arguments);if(_18==-1&&this.creator.getDataSource()!=null){var _19=this.$365();_18=_19.findByKeys(_28,this.creator.getDataSource())}
return _18}},isc.Tree);this.logInfo("Adding "+_2.getLength()+" records to groups","grouping");for(var i=0;i<_2.getLength();i++){this.$2u(_2.get(i),false,_4)}
...
if(!_4)this.openInitialGroups();this.data=_23;if(!_1){this.$44d(this.data)}else{this.observe(_23,"changeDataVisibility","observer.$437()")}
...
this.logInfo("groupBy: "+this.groupByField,"grouping");this.isGrouped=true;this.$44h=true;this.dataChanged()}
...
else if(!_2.getGroupValue&&_2.$12q&&_2.$12q.getGroupTitle){return _2.$12q.getGroupTitle(_1.groupValue,_1,_2,_2.name,this)}
...
,isc.A.$2u=function isc_ListGrid__addRecordToGroup(_1,_2,_3){var _4,_5=this.groupTree.getRoot();for(var i=0;i<this.groupByField.length;i++){var _7=this.groupByField[i],_8=(this.completeFields||this.fields).findIndex(this.fieldIdProperty,_7),_9=(this.completeFields||this.fields).get(_8),_10=this.data.indexOf(_1);var _11=this.getRawCellValue(_1,_10,_7,true);if(_9.getGroupValue){_11=_9.getGroupValue(_11,_1,_9,_7,this)}else if(_9.userFormula){_11=this.getFormulaFieldValue(_9,_1)}else if(_9.userSummary){_11=this.getSummaryFieldValue(_9,_1)}else if(_9.$12q&&_9.$12q.getGroupValue){_11=_9.$12q.getGroupValue(_11,_1,_9,_7,this)}
if(_9.valueMap&&_9.valueMap[_11]){_11=_9.valueMap[_11]}
if(_11==null||isc.isAn.emptyString(_11)){_11=this.nullGroupTitle}
if(this.groupTree.getChildren(_5)==null)_4=null;else _4=this.groupTree.getChildren(_5).find('groupValue',_11);if(!_4){_4={groupName:_7,groupValue:_11,$2k:true,canDrag:false,canSelect:false};if(!this.groupTitleField)_4.singleCellValue=_11;else _4.groupTitle=_11;_4[_7]=_11;_4[this.recordCustomStyleProperty]=this.groupNodeStyle
...
,isc.A.refreshGroupSummary=function isc_ListGrid_refreshGroupSummary(_1){if(!this.isGrouped||!this.showGroupSummary||!this.groupTree)return;this.groupTree.$36p();if(_1==null){this.body.markForRedraw()}else{var _2=this.groupTree.getParent(this.groupTree.get(_1));if(_2){var _3=this.groupTree.indexOf(_2)+this.groupTree.getChildren(_2).length;this.refreshRow(_3)}}}
...
,isc.A.click=function isc_TreeGridBody_click(_1,_2){if(!this.$4q()){var _3=this.grid,_4=_3.getEventRecordNum(),_5=_3.getRecord(_4);if(_3.data.isFolder(_5)&&_3.clickInOpenArea(_5)){_3.toggleFolder(_5);_3.clearLastHilite();_3.$44b=null;return isc.EH.STOP_BUBBLING}}
...
if(this.$49d==null){this.$49d=["<table cellpadding=0 cellspacing=0 class='",,"' style='",,isc.Canvas.$qr+"'><tr><td style='",,isc.Canvas.$qr+"' class='",,"'>",,"</td>"]}
return this.$49d}
...
isc.addProperties(_15,this.getDropValues(_27,_9,_2,_3,_4));this.$2s(_27,_9,_4,null,_3,_2)}}}else{for(var i=0;i<_1.length;i++){this.$2s(_1[i],_9,_4,null,_3,_2)}}
...
,isc.A.$49k=function isc_TreeGrid__getCheckboxIcon(_1){var _2=null;if(this.selectionAppearance==this.$19f){if(!this.body.canSelectRecord(_1)){_2="[SKINIMG]/blank.gif"}else{var _3=this.selection.isSelected(_1)?true:false;var _4=(_3&&this.showPartialSelection&&this.selection.isPartiallySelected(_1))?true:false;_2=_4?(this.checkboxFieldPartialImage||this.booleanPartialImage):_3?(this.checkboxFieldTrueImage||this.booleanTrueImage):(this.checkboxFieldFalseImage||this.booleanFalseImage)}}
return _2}
...
,isc.A.createChildren=function isc_RecordEditor_createChildren(){this.Super("createChildren",arguments);if(!this.$492)this.makeActionButton()}
...
,isc.A.makeEditForm=function isc_RecordEditor_makeEditForm(){var _1=this.getEditForm(),_2;if(_1==null){_2=this.$711}else{_2=_1.getValuesAsCriteria()}
this.Super("makeEditForm",arguments);_1=this.getEditForm();if(_1!=null){_1.setValuesAsCriteria(_2);delete this.$711}}
...
,isc.A.performFilter=function isc_RecordEditor_performFilter(_1){var _2=this.$493(this.sourceWidget.autoFetchTextMatchStyle);var _3={};if(_1)_3.showPrompt=false;_3.textMatchStyle=this.sourceWidget.autoFetchTextMatchStyle;var _4=this.sourceWidget.data;if(isc.isA.ResultSet(_4)&&_4.willFetchData(_2,_3.textMatchStyle)){this.fireOnPause("performFilter",{target:this.sourceWidget,methodName:"handleFilterEditorSubmit",args:[_2,_3]},this.fetchDelay)}else{this.sourceWidget.handleFilterEditorSubmit(_2,_3)}}
...
,isc.A.getEmptyMessage=function isc_Menu_getEmptyMessage(){if(this.$50b){return this.loadingDataMessage.evalDynamicString(this,{loadingImage:this.imgHTML(isc.Canvas.loadingImageSrc,isc.Canvas.loadingImageSize,isc.Canvas.loadingImageSize)})}
...
if(this.$50q)this.$50q.map("destroy");this.Super("destroy",arguments)}
...
return this.Super("keyPress",arguments)},$x9:function(){this.Super("$x9",arguments);this.markForRedraw()},showMenu:function(){if(isc.isA.String(this.menu))this.menu=window[this.menu];if(!isc.isA.Menu(this.menu))this.$503(this.menu);if(!isc.isA.Menu(this.menu))return;isc.Menu.$50y=this;var _1=this.menu;_1.$14y();var _2=this.getPageLeft();if(!this.alignMenuLeft){_2=_2-(_1.getVisibleWidth()-this.getVisibleWidth())}
var _3=this.showMenuBelow?this.getPageTop()+this.getVisibleHeight()+1:this.getPageTop()-_1.getVisibleHeight()+2;_1.placeNear(_2,_3);_1.show(this.menuAnimationEffect)},$503:function(_1){if(!_1)return;_1.autoDraw=false;var _2=this.menuConstructor||isc.Menu;this.menu=_2.create(_1)}};isc.ClassFactory.defineClass("MenuButton","Button");isc.MenuButton.addProperties(isc.$502)
...
,isc.A.setButtons=function isc_MenuBar_setButtons(_1){_1=[];for(var i=0;i<this.menus.length;i++){var _3=this.menus[i];_1[i]=this.$52g(_3,i)}
