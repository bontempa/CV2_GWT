...
this.setUpSize();this.$15g();if(this.showTitle)this._titleLabel=this.addChild(this.$11f());if(this.showRange){this.$11b=this.addChild(this.$11c("min"));this.$11d=this.addChild(this.$11c("max"))}
...
,isc.A.setMinValue=function isc_Slider_setMinValue(_1){this.minValue=_1;if(this.$11b)this.$11b.setContents(_1);this.setValue(this.minValue)}
,isc.A.setMaxValue=function isc_Slider_setMaxValue(_1){this.maxValue=_1;if(this.$11d)this.$11d.setContents(_1);this.setValue(this.minValue)}
...
,isc.A.destroy=function isc_DynamicForm_destroy(){if(this.valuesManager)this.valuesManager.removeMember(this);this.$167(this.items);this.Super("destroy",arguments)}
...
if(_12.editorProperties)_12=isc.addProperties({},_12,_12.editorProperties);var _13=this.getEditorType(_12);_1[_11]=_12=this.createItem(_12,_13);if(_13==this.$153)_8=true;if(isc.FileItem&&isc.isA.FileItem(_12)&&_9){this.logWarn("Attempting to creating a form with multiple FileItems. This is "+"not currently supported - only the first file type field value will "+"be committed on submission of this form.")}
...
if(_8)this.encoding=isc.DynamicForm.MULTIPART_ENCODING;for(var i=0;i<_7.length;i++){var _15=_7[i],_16=_15.sectionExpanded;if(_16&&(!_10||(this.$110==_15))){_15.expandSection()}else{_15.collapseSection()}}
this.$17a=true;var _17=this.getTabIndex();if(_5&&_17!=-1){this.$17b();var _18=this.getTabIndexSpan();if(_18>_6){var _19=this.$zk();if(_19){var _20=_19.getTabIndex();if(_20<(_17+_18)){_19.$zp((_17+_18)-_20)}}}}
...
,isc.A.rememberValues=function isc_DynamicForm_rememberValues(){var _1=this.getValues(),_2=this.$17j={};this.$17k=[];var _3="__ref";for(var _4 in _1){if(isc.isA.Function(_1[_4]))continue;if(_4==_3)continue;if(isc.isA.Date(_1[_4])){_2[_4]=new Date();_2[_4].setTime(_1[_4].getTime())}else{_2[_4]=_1[_4]}
var _5=this.getItem(_4);if(_5&&_5.isSetToDefaultValue())this.$17k.add(_4)}
return _2}
...
,isc.A.valuesHaveChanged=function isc_DynamicForm_valuesHaveChanged(_1){var _2=this.getValues(),_3=this.$17j,_4=false,_5={};if(!isc.isAn.Object(_3))_3={};var _6="__ref";for(var _7 in _2){if(isc.isA.Function(_2[_7]))continue;if(_7==_6)continue;var _8=this.getItem(_7);if(_8!=null){_4=!_8.compareValues(_2[_7],_3[_7])}else{_4=!isc.DynamicForm.compareValues(_2[_7],_3[_7])}
...
,isc.A.getValuesAsCriteria=function isc_DynamicForm_getValuesAsCriteria(_1,_2,_3){if(_1==null){_1=(this.operator!="and")||this.getItems().map("hasAdvancedCriteria").contains(true)||(this.$17f!=null)}
if(!_1){var _4=this.$17n();if(_3)return _4;return isc.DataSource.filterCriteriaForFormValues(_4)}
var _5=this.$17f?isc.clone(this.$17f):{operator:this.operator,_constructor:"AdvancedCriteria",criteria:[]};var _6=this.$17n(true,_2);_5.criteria.addList(_6);return isc.DS.checkEmptyCriteria(_5)||{}}
...
_1.$17q()}
,isc.A.$17p=function isc_DynamicForm__saveValue(_1,_2){isc.DynamicForm.$1x(_1,_2,this.values);if(!this.selectionComponent&&this.valuesManager!=null){if(isc.isA.ValuesManager(this.valuesManager)&&this.valuesManager.members&&this.valuesManager.members.contains(this))
{this.valuesManager.$17r(_1,_2,this)}}}
,isc.A.clearItemValue=function isc_DynamicForm_clearItemValue(_1){var _2=_1.getDataPath()||_1.getFieldName();isc.DynamicForm.$1w(_2,this.values);if(!this.selectionComponent&&this.valuesManager){this.valuesManager.$17s(_2,this)}}
,isc.A.$17g=function isc_DynamicForm__saveValues(_1){this.values=_1;if(!this.selectionComponent&&this.valuesManager!=null){var _2=isc.getKeys(this.values);for(var i in _1){this.valuesManager.$17r(i,_1[i],this);_2.remove(i)}
...
,isc.A.$17t=function isc_DynamicForm__sectionExpanding(_1){if(this.sectionVisibilityMode=="mutex"&&this.$110&&this.$110!=_1)
{this.$110.collapseSection()}
this.$110=_1}
,isc.A.$17u=function isc_DynamicForm__sectionCollapsing(_1){}
...
,isc.A.$171=function isc_DynamicForm__itemsCleared(){var _1=this.items;for(var i=0;i<_1.length;i++){if(_1[i].isDrawn())_1[i].cleared()}}
...
if(_14!=null)_12=_14[_13.last()]}else if(_9)_12=_1[_9];if(_2&&isc.CanvasItem&&isc.isA.CanvasItem(_8)&&!_8.$173())
{continue}
var _16,_17=((!_9&&!_10)||_12===_16);var _18=null;if(_3&&_17&&_8.value!=null){_18=_8.value;if(_18!=_8._value)_11=false}
var _19=null;if(_17&&_6!=null){for(var i=0;i<_6.length;i++){if(_8.canEditCriterion(_6[i])){_17=false;_19=_6[i];_6.removeAt(i);if(_6.length==0)delete this.$17f;break}}}
...
,isc.A.getAbsPosHTML=function isc_DynamicForm_getAbsPosHTML(){var _1=isc.SB.create();for(var _2=0,_3=this.items.length;_2<_3;_2++){var _4=this.items[_2];if(!_4)continue;_4.$17q();if(!_4.visible)continue;_1.append(_4.getStandaloneItemHTML(_4.getValue()))}
return _1.release()}
...
,isc.A.performImplicitSave=function isc_DynamicForm_performImplicitSave(_1,_2){if(_1.awaitingImplicitSave)delete _1.awaitingImplicitSave;if(_1.$dp!=null)isc.Timer.clear(_1.$dp);this.logInfo("implicitSave called "+(!_2?"by editorExit()":"after implicitSaveDelay ("+this.implicitSaveDelay+"ms)")+" for item "+_1.name+".");this.saveData(this.getID()+".implicitSaveCallback(data)")}
...
if(_6)this.logInfo("Validation errors: "+isc.Log.echoAll(_10));if(_4)return(_6?_10:true);this.setErrors(_10);if(_9){this.setItemValues(_12);for(var _27 in _12){if(this.getItem(_27)==null)this.$17p(_27,_12[_27])}}
...
_3.$18m=_6.expression.apply(this,[_3,_6,_7])}}}}
...
{_2=_6;_3=_7}}
if(_2&&this.$18q(_2,true))this.focusInItem(_2);else{var _8,_9=isc.EH.clickMaskRegistry;if(_9){for(var i=_9.length-1;i>=0;i--){if(isc.EH.isHardMask(_9[i])){_8=_9[i];break}}}
this.$lh(_1,_8,true)}}
...
if(_2.$ln()){_2.focusInItem();this.setFocusItem(_2);if(this.$17l){var _3=this;isc.Page.setEvent("idle",function(){if(!_3.destroyed)_3.focusInItem()},isc.Page.FIRE_ONCE)}}else{this.logWarn("focusInItem: item cannot accept focus: "+_2)}}
...
,isc.A.handleDoubleClick=function isc_DynamicForm_handleDoubleClick(_1,_2){var _3=this.$om(_1);if(_3&&_3.item){var _4=_3.item;if(_3.inactiveContext){return this.bubbleInactiveEditorEvent(_4,"doubleClick",_3)}else if(_3.overTitle){return this.bubbleItemHandler(_4,"handleTitleDoubleClick",_4)}else{var _5=(_3.overElement||_3.overTextBox||_3.overControlTable);if(_3.overIcon){if(_4.$185(_3.overIcon)==false)return false;var _6=_4.getIcon(_3.overIcon);if(_6&&_6.writeIntoItem)_5=true}
...
);isc.evalBoundary;isc.B.push(isc.A.adjustDragLinePosition=function isc_DynamicForm_adjustDragLinePosition(_1,_2,_3){var _4=this.items.$141,_5=this.items.indexOf(_2),_6,_7,_8;for(var i=0;i<_4.length;i++){if(_4[i].indexOf(_5)!=-1){_6=i;_7=_4[i].indexOf(_5);_8=_4[i].lastIndexOf(_5);break}}
...
);isc.B._maxIndex=isc.C+225;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$19d="link";isc.A.$ht="text";isc.A.$19e="select";isc.A.$19f="checkbox";isc.A.$19g="staticText";isc.A.$hy="boolean";isc.A.$19h="binary";isc.A.$19i="blob";isc.A.$19j="multifile";isc.A.$19k="multiupload";isc.A.$153="upload";isc.A.$19l="file";isc.A.$19m="base64Binary";isc.A.$19n="enum";isc.A.$19o="CycleItem";isc.A.$19p="selectOther";isc.A.$19q="relation";isc.A.$19r="NestedEditorItem";isc.A.$19s="NestedListEditorItem";isc.A.$19t="imageFile";isc.A.$19u="ViewFileItem";isc.A.$19v="section";isc.A.$19w="SectionItem";isc.A.$19x="button";isc.A.$19y="ButtonItem";isc.A.$19z="id";isc.B.push(isc.A.getEditorType=function isc_c_DynamicForm_getEditorType(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.defaultFieldType,_5=_1.editorType||_1.formItemType||_1._constructor||_1.type||_4;if(_1.editorType||_1.formItemType||_1._constructor)return _5;if(_5==this.$19d){if(!this.canEditField(_1,_2))_5=this.$19d;else _5=this.$ht}else if(!this.canEditField(_1,_2)){if(_5==this.$19h||_5==this.$19l||_5==this.$19t)
_5=this.$19u;else if(_5!=this.$19v&&_5!=this.$19w&&_5!=this.$19x&&_5!=this.$19y)
{_5=this.$19g}}else if(_5==this.$hy){var _6=_1.valueMap;if(!isc.isAn.Array(_6)&&isc.isAn.Object(_6))_5=this.$19e;else _5=this.$19f}else if(_5==this.$19h||_5==this.$19i||_5==this.$19l||_5==this.$19t)
{if(_1.dataSource)_5=this.$19j
else _5=this.$19l}else if(_5==this.$19k){_5=this.$19j}else if(_5==this.$19m){_5=this.$19m}else if(_5==this.$19n){if(_1.showValueIconOnly)_5=this.$19o
else _5=this.$19e}else if(isc.DataSource&&isc.isA.DataSource(_3)&&_3.fieldIsComplexType(_1.name)){_5=_1.multiple?_2.nestedListEditorType:_2.nestedEditorType}else{if(!_1.type||(_1.type==_4)||(_1.type!=this.$19p&&(isc.FormItemFactory.getItemClass(_1.type)==null)))
{if(_1.dataSource){_5=this.$19q}else if(_1.valueMap||_1.optionDataSource||_1.displayField){_5=(_1.showValueIconOnly?this.$19o:this.$19e)}else if(_2&&(_1.length&&_1.length>_2.longTextEditorThreshold))
...
if(this.$21m==null){this.$21m=["<TABLE CELLSPACING=0 CELLPADDING=0 BORDER=0 ID='",,"' STYLE='"+isc.Canvas.$qr,,"' CLASS='",,"'><TR>",,"<TD style='",,"' VALIGN=",,">"]}
return this.$21m}
...
,isc.A.getInnerHeight=function isc_FormItem_getInnerHeight(){var _1=this.containerWidget;if(this.$174())return this.$18h(this.height,true);if(this.$15b){var _2=this.$15b[1];if(!isc.isA.Number(_2))return _2;if(this.$22u()){_2-=this.$22s()}
return _2}
return this.getHeight()}
,isc.A.getInnerWidth=function isc_FormItem_getInnerWidth(_1){var _2=this.containerWidget;if(this.$174())return this.$18h(this.width);var _3=this.$15b?this.$15b[0]:this.width;if(!isc.isA.Number(_3))return _3;if(this.$22u()){_3-=this.$22t()}
return _3}
...
return _1.release()}
,isc.A.getPickerIconCellCSS=function isc_FormItem_getPickerIconCellCSS(){if(isc.Browser.isIE)return isc.emptyString;var _1=this.getPickerIconHeight();if(isc.isA.Number(_1)&&_1<this.getInnerHeight()){return this.$211+_1+this.$9k}
...
return this.$23z}
);isc.evalBoundary;isc.B.push(isc.A.getElementHTML=function isc_FormItem_getElementHTML(_1,_2){var _3=isc.SB.create(),_4=this.$23k();var _5=this.$ln(),_6,_7;if(_5){var _8=this.$232(),_9=this.isDisabled()?null:this.accessKey;if(_4){_7=isc.Canvas.getFocusProxyString(this.getID(),false,0,0,this.getTextBoxWidth(),this.getTextBoxHeight(),this.isVisible(),!this.isDisabled(),_8,_9,false)}else{var _10=isc.SB.create();if(_9!=null)_10.append(this.$212,_9,this.$rd);_10.append(this.$213,_8,this.$rd);_6=_10.release()}}
...
,isc.A.getErrorHTML=function isc_FormItem_getErrorHTML(_1){var _2=this.shouldShowErrorText(),_3=this.shouldShowErrorIcon();if(!_2&&!_3)return isc.emptyString;var _4=this.form,_5=_3&&_2,_6=!_5&&_3&&((this.getErrorOrientation()==isc.Canvas.LEFT)||(this.getErrorOrientation()==isc.Canvas.RIGHT)),_7=(_2&&this.form.showTitlesWithErrorMessages&&this.getTitle()!=null?this.getTitle()+": ":null),_8,_9=_2?this.getErrorMessage(_1):null;if(!_5){_8=isc.SB.concat("<DIV ",(_6?"style='display:inline;'":null)," CLASS='",this.getCellStyle(),"'>",(_3?this.getErrorIconHTML(_1)+"&nbsp;":null),_7,_9,"</DIV>")}else{_8=isc.SB.concat("<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0><TR>","<TD WIDTH=",this.errorIconWidth,">",this.getErrorIconHTML(_1),"</TD><TD STYLE='",isc.Canvas.$qr,"' CLASS='",this.getCellStyle(),"'>&nbsp;",_7,_9,"</TD></TR></TABLE>")}
return _8}
,isc.A.getErrorIconHTML=function isc_FormItem_getErrorIconHTML(_1){this.$72q=_1;var _2=this.getErrorIconId();return this.$235(_2,this.errorIconWidth,this.errorIconHeight,"top",0,null,null,this.form.getImgURL(this.errorIconSrc),this.getID(),_2,null,true,isc.DynamicForm.$15v+"='"+this.getID()+"' "+isc.DynamicForm.$15w+"='"+_2+"'")}
...
,isc.A.getIconsHTML=function isc_FormItem_getIconsHTML(){if(!this.showIcons||this.icons==null)return"";var _1=this.$238(true);if(this.showIconsOnFocus&&!_1){this.hideAllIcons();return""}
var _2=isc.SB.create(),_3=false;for(var i=0;i<this.icons.length;i++){var _5=this.icons[i];if(!this.$24k(_5)||this.$24j(_5))continue;if(_3==false){_3=true;_2.append(this.$72p)}
_2.append("<td>");var _6=_1&&this.$24o(_5,true);_2.append(this.getIconHTML(_5,null,this.iconIsDisabled(_5),!!_6));_2.append("</td>")}
...
if(isc.Browser.isMoz)_13[6]=(_14<0?"ignore;":"normal;");_13[7]=_3?"cursor:default;":null;_13[9]=_14;_13[13]=_11;_13[17]=_12;_13[19]=this.$235(this.$24t(_12),_6,_7,this.$24r(_1),this.$24s(_1),(!_15?_8:null),_9,_5,_11,_12,_8);return _13.join(isc.emptyString)}}
...
,isc.A.$25h=function isc_FormItem__formatDataType(_1){if(this.applyStaticTypeFormat){if(this.formatValue!=null){var _2=this.form,_3=this.form?this.form.values:{};return this.formatValue(_1,_3,_2,this)}}else if(this.formatEditorValue!=null){var _2=this.form,_3=this.form?this.form.values:{};return this.formatEditorValue(_1,_3,_2,this)}else if(this.$12v!=null){var _2=this.form,_3=this.form?this.form.values:{};if(this.$12q){return this.$12q.editFormatter(_1,this,_2,_3)}else{return this.$12v(_1,this,_2,_3)}}
...
,isc.A.setValue=function isc_FormItem_setValue(_1,_2){this.$25m=true;if(this.$25n!=null&&!this.compareValues(_1,this._value)){this.$71s()}
var _3=(this.maintainSelectionOnTransform&&this.hasFocus&&(this.$25o()!=this.$219));if(_3)this.rememberSelection();if(this.$25p!=null){isc.Timer.clearTimeout(this.$25p);this.$25p=null}
...
this.clearValue()}
,isc.A.$25r=function isc_FormItem__checkForDisplayFieldValue(_1){var _2=this.getOptionDataSource();if(_2&&(this.$71t==null||!this.compareValues(this.$71t,_1))&&(this.$25s==null||!this.$25s[_1]))
{if(!this.$25s)this.$25s={};this.$25s[_1]=true;var _3=this.optionCriteria||{};if(!this.filterLocally){_3[this.getValueFieldName()]=_1}
...
,isc.A.fetchMissingValueReply=function isc_FormItem_fetchMissingValueReply(_1,_2,_3){var _4,_5=_1.clientContext.dataValue,_6=this.getDisplayFieldName(),_7=this.getValueFieldName();delete this.$25s[_5];if(_2)_4=_2.find(_7,_5);if(!_4){this.logInfo("Unable to retrieve display value for data value:"+_5+" from dataSource "+this.getOptionDataSource());if(!this.filterLocally)return}
this.$71u(_4);if(this.$25j==null)this.$25j={};var _8=this.$25j;var _9;for(var i=0;i<_2.length;i++){_4=_2[i];var _11=_4[_7],_12=_4[_6];if(_8[_11]!==_9){if(_8[_11]!=_12){this.logWarn("Deriving valueMap for '"+_7+"' from dataSource based on displayField '"+_6+"'. This dataSource contains more than one record with "+_7+" set to "+_11+" with differing "+_6+" values."+" Derived valueMap is therefore unpredictable.")}
continue}
_8[_4[_7]]=_4[_6]}
if(this.filterLocally)this.$25q=true;var _13=(this._value==_5);this.updateValueMap(_13)}
,isc.A.getSelectedRecord=function isc_FormItem_getSelectedRecord(){if(this.$25n&&(this.$71t==this._value)){return this.$25n}}
,isc.A.$71u=function isc_FormItem__storeSelectedRecord(_1){this.$25n=_1;this.$71t=this._value}
...
,isc.A.$25u=function isc_FormItem__showInFieldHint(){if(!this.$25v){var _1=this.getDataElement();if(_1){_1.className=this.$25w()}else{var _2=this.$4l();if(_2!=null)
_2.className=this.$25w()}
var _3=this.getHint();if(_3)_3=_3.unescapeHTML();this.setElementValue(_3);this.$25v=true}}
,isc.A.$25x=function isc_FormItem__hideInFieldHint(){if(this.$25v){var _1=this.getDataElement();if(_1){_1.className=this.getTextBoxStyle()}else{var _2=this.$4l();if(_2!=null)
...
_5.setEndPoint(this.$22d,_4);_3[0]=_5.text.length;return _3}else if(isc.Browser.isMoz||isc.Browser.isSafari){return[_2.selectionStart,_2.selectionEnd]}}
...
var _13=this.$25m;var _14=!this.compareValues(_1,_3);if((_5||_14)&&!_13)
{this.setValue(_1);if(_5&&this.maintainSelectionOnTransform)this.$258()}
if(this.$25m)this.$251=this._value;if((this.redrawOnChange||_6.length>0||(_6.length==0&&_11!=null&&_4)))
{this.redraw()}
...
,isc.A.$26m=function isc_FormItem__setIconsEnabled(){if(this.showPickerIcon){var _1=this.getPickerIcon();this.setIconEnabled(_1)}
...
,isc.A.handleEditorExit=function isc_FormItem_handleEditorExit(){if(!this.$26n)return;this.$26n=null;var _1=this.getValue();if(this.validateOnExit||this.form.validateOnExit){if(this.form.isNewRecord()||!this.compareValues(_1,this.$26o))
{this.validate()}
this.$26o=null}
...
,isc.A.$26s=function isc_FormItem__handleInput(){isc.EH.$i4("INP");if(this.changeOnKeypress&&!this.mask){if(isc.Log.supportsOnError){this.updateValue()}else{try{this.updateValue()}catch(e){isc.Log.$a2(e)}}}
isc.EH.$i5()}
,isc.A.$20i=function isc_FormItem__nativeCutPaste(_1,_2){if(this.changeOnKeypress)this.$26t()}
);isc.evalBoundary;isc.B.push(isc.A.handleKeyPress=function isc_FormItem_handleKeyPress(_1,_2){if(!this.form)return;var _3=this.form.$om(_1);if(_3.overIcon){if(this.$26h(_3.overIcon)==false)return false}else{if(!this.$18v()&&this.changeOnKeypress)this.$26t();var _4=_1.keyName;if(this.hideIconsOnKeypress&&!this.$243&&_4!=this.$j9){this.hideAllIcons()}}
...
if(this.showPickerIcon||(this.showIcons&&this.icons!=null)){var _20=this.getTotalIconsWidth();if(this.showPickerIcon)_20+=this.getPickerIconWidth();_11.append(this.$179((this.form.isRTL()?isc.Canvas.RIGHT:isc.Canvas.LEFT),this.getCellStyle(),1,1,_20,null,null,isc.Canvas.$qr,null,null,null,(this.icons&&(this.showPickerIcon||this.icons.length>1))));if(this.showPickerIcon)_11.append(this.getIconHTML(this.getPickerIcon()));_11.append(this.getIconsHTML());_11.append(this.$18a(true))}
...
);isc.B._maxIndex=isc.C+3;isc.A=isc.CanvasItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function isc_CanvasItem_init(){this.Super("init",arguments);this.$27k()}
...
,isc.A.$20h=function isc_TextItem__nativeElementBlur(_1,_2){var _3=this.Super("$20h",arguments);if(this.changeOnBlur)this.form.elementChanged(this);else{var _4=this.getElementValue();if(this.mapDisplayToValue){_4=this.mapDisplayToValue(_4)}
...
if(this.showHintInField){var _6;var _5=this.getElementValue();if(_5===_6||_5==null||isc.is.emptyString(_5)){this.$25u()}}
return _3}
...
,isc.A.$20e=function isc_TextItem__nativeElementFocus(_1,_2){var _3=this.Super("$20e",arguments);this.$25x();if(this.mask){this.$273(false);var _4=0;var _5=this.$274;if(!this.selectOnFocus){_4=this.$275();_5=_4}
this.delayCall("$276",[_4,_5])}
return _3}
...
,isc.A.init=function isc_TextItem_init(){this.Super("init",arguments);if(this.mask&&!isc.isA.ComboBoxItem(this)&&!isc.isA.SpinnerItem(this)){this.$278();if(this.keyPressFilter){this.logWarn("init: keyPressFilter ignored because mask is enabled")}}else if(this.keyPressFilter){this.$277=new RegExp(this.keyPressFilter)}}
,isc.A.keyPress=function isc_TextItem_keyPress(_1,_2,_3,_4){if(isc.EventHandler.ctrlKeyDown()||isc.EventHandler.altKeyDown())return true;if((!this.characterCasing||this.characterCasing==isc.TextItem.DEFAULT)&&!this.$277&&!this.mask)
{return true}
if(this.mask){var _5=this.$279();var _6=isc.Browser.isSafari;var _7=_5.begin;if(_3=="Backspace"||_3=="Delete"){if((_5.begin-_5.end)!=0||(_6&&this.$28a))
...
this.$274++}
,isc.A.$279=function isc_TextItem__getSelection(){var _1=this.getSelectionRange();return{begin:_1[0],end:_1[1]}}
...
return _4}
,isc.A.$270=function isc_TextItem__getMaskBuffer(){return this.$28f.join('')}
...
,isc.A.$28x=function isc_PickListMenu__formatCellValue(_1,_2,_3,_4,_5){var _6=this.getFieldName(_5);_1=this.formItem.formatPickListValue(_1,_6,_2);return this.Super("$28x",[_1,_2,_3,_4,_5])}
...
return _1},getPickListFilterCriteria:function(){var _1=this.optionCriteria||{};return isc.addProperties(_1,this.pickListCriteria)},getAllLocalOptions:function(){return this.$28z()?null:this.getClientPickListData()},$289:function(_1,_2){var _3=this.getOptionDataSource();if(_3==null){return}
...
return _8},$27a:"true",setUpPickListFields:function(){var _1=this.getPickListFields(),_2=this.pickList.fields;var _3=!_2||(_2.length!=_1.length);if(!_3){for(var i=0;i<_1.length;i++){var _5=_1[i],_6=_2[i];for(var _7 in _5){if(_5[_7]!=_6[_7]){_3=true;break}}
if(_3)break}}
...
return _1},getClientPickListData:function(){return isc.PickList.optionsFromValueMap(this)},$28t:function(){if(this.pickListHidden)this.pickListHidden()},$28v:function(){if(this.pickListShown)this.pickListShown()},selectDefaultItem:function(){return this.selectItemFromValue(this.getValue())},selectItemFromValue:function(_1){if(!isc.isAn.Array(_1))_1=[_1];var _2=this.pickList.getSelection(),_3=this.getValueFieldName(),_4=true,_5;for(var i=0;i<_1.length;i++){var _7=_1[i],_8;if(_2.find(_3,_7))continue;var _9=this.pickList.getData(),_10=this.$28z()?this.getOptionDataSource():null;if(_10!=null){var _11=_9.localData;if(_11)_8=_11.find(_3,_7)}else{_8=_9.find(_3,_7)}
...
if(_5!=null)this.pickList.scrollRecordIntoView(_5);return _4},filterComplete:function(_1,_2,_3){this.$29d=false;var _4=this.pickList;if(!_4||_4.destroyed)return;var _5=_4.hasFocus||(_4.body&&_4.body.hasFocus);var _2=_4.getData();if(_2.getLength()==0&&_4.isVisible()&&_4.isDrawn()){if(this.hideEmptyPickList){_4.hide();if(_5)this.focusInItem()}else{_4.setHeight(this.getPickListHeight());var _6=this.getPickListPosition();if(this.allowPickListToClip)_4.setRect([_6[0],_6[1]]);else _4.placeNear(_6[0],_6[1])}}else{if(this.$28u)this.$28y();else if(_4.isVisible()&&_4.isDrawn())this.placePickList();delete this.$28u}
this.selectDefaultItem();if(this.$29e){delete this.$29e;this.$25r(this._value)}
this.$29f();var _7=(_3&&_3.clientContext?_3.clientContext.$5u:null);if(_7){this.fireCallback(_7,"item,dsResponse,data,dsRequest",[this,_1,_2,_3])}},$29f:function(){if(this.isDrawn()&&this.getValueFieldName()!=null&&this.$28z())
...
var _2=this.getSelectedRecord();if(_2){var _3=this.mapValueToDisplay(_1);if(this.$29h!=_3&&!(!this.addUnknownValues&&this.isA("ComboBoxItem")))
{this.setElementValue(_3)}}}},filterDataBoundPickList:function(_1,_2){if(isc.$da)arguments.$db=this;var _3=this.getPickListFilterCriteria(),_4={textMatchStyle:this.textMatchStyle,showPrompt:false};if(this.optionFilterContext!=null)isc.addProperties(_4,this.optionFilterContext);if(this.optionOperationId!=null)_4.operationId=this.optionOperationId;if(_1!=null){isc.addProperties(_4,_1)}
var _5=false;if(this.pickList.data&&isc.ResultSet&&isc.isA.ResultSet(this.pickList.data)){if(_2){this.pickList.data.$29i()}else if(!this.pickList.data.willFetchData(_3,this.textMatchStyle)){_5=true}}
this.pickList.filterData(_3,{target:this,methodName:"filterComplete"},_4);if(_5)this.filterComplete();else this.$29d=true},handleDataArrived:function(_1,_2,_3){if(this.defaultToFirstOption&&this.getValue()==null&&_1==0){this.setToDefaultValue()}
...
if(!_5)_3=_1.duplicate();if(this.showAllOptions&&_4.length>1)_3.addList(_4);return _3},shouldHideEmptyPickList:function(){if(this.hideEmptyPickList!=null)return this.hideEmptyPickList;return!this.$28z()},getPickListPosition:function(){return[this.getPageLeft(),this.getPageTop()+this.getHeight()]},getPickListHeight:function(){var _1=this.pickListHeight,_2=this.pickList,_3=_2.getTotalRows();if(_3==0)return this.emptyPickListHeight;var _4=_2.cellHeight,_5=(_2.showHeader?_2.headerHeight:0),_6=_3*_4,_7=(_2.body?_2.body.getVBorderPad():isc.Element.$qj(_2.bodyStyleName)),_8=_6+_5+_2.getVBorderPad()+_7;if(_2.showFilterEditor){_8+=_2.filterEditorHeight}
return Math.min(_8,_1)},$29k:function(_1,_2,_3){var _4=this.pickList,_5=_1;if(_4.fixedFieldWidths){_4.resizeTo(_5,_2);return}
...
this.$29k(this.pickListWidth!=null?this.pickListWidth:this.getElementWidth(),_5,(_5==this.pickListHeight));if(this.allowPickListToClip)_1.setRect([_3,_4]);else _1.placeNear(_3,_4)},pickValue:function(_1){}});isc.A=isc.PickList;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.optionsFromValueMap=function isc_c_PickList_optionsFromValueMap(_1){var _2=_1.getValueMap(),_3=[];if(_2==null)_2=[];var _4=_1.getValueFieldName();if(isc.isAn.Array(_2)){for(var i=0;i<_2.length;i++){_3[i]={}
...
,isc.A.getClientPickListData=function isc_SelectItem_getClientPickListData(){if(this.$29r)return this.$29r;var _1=isc.PickList.optionsFromValueMap(this),_2=this.getValueFieldName();if(this.allowEmptyValue&&(_1.find(_2,null)==null)){var _3={};_1.addAt(_3,0)}
...
,isc.A.filterComplete=function isc_SelectItem_filterComplete(){if(this.allowEmptyValue&&this.$28z()){var _1=this.pickList.data,_2=_1.isLocal()?_1.allRows:_1.localData;if(_2&&!_2.find(this.getValueFieldName(),null)){_1.insertCacheData({},0)}}
...
var _2=this.getValue(),_3=_1.indexOf(_2);if(_3==_1.length-1)_3=-1;var _4=_1[_3+1];if(!this.compareValues(_4,this._value)){var _5=this.mapValueToDisplay(_4);this.setElementValue(_5,_4);this.$17r(_4)}}
...
);isc.B._maxIndex=isc.C+2;isc.ClassFactory.defineClass("LinkItem","StaticTextItem");isc.A=isc.LinkItem.getPrototype();isc.A.wrap=false;isc.A.canFocus=true;isc.A=isc.LinkItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$214=["<DIV ID='",,"' "+isc.DynamicForm.$15v+"='",,"' "+isc.DynamicForm.$15w+"='"+isc.DynamicForm.$15y,"' CLASS='",,"' STYLE='",,"' onclick='if(window.",,") return ",,".$298(event);","'>",,"</DIV>"];isc.B.push(isc.A.$23k=function isc_LinkItem__writeOutFocusProxy(){return false}
...
return false}
return true}
,isc.A.getElementHTML=function isc_LinkItem_getElementHTML(_1){var _2=this.getLinkHTML(_1);var _3=this.$214;_3[1]=this.$23d();_3[3]=this.getID();_3[6]=this.getTextBoxStyle();_3[8]=this.getTextBoxCSS();_3[10]=this.getID();_3[12]=this.getID();_3[15]=_2;return _3.join(isc.emptyString)}
...
_1=isc.Canvas.linkHTML(_1,_3,_4,(this.getID()+"$30a"),this.getGlobalTabIndex(),this.accessKey)
...
);isc.B._maxIndex=isc.C+8;isc.ClassFactory.defineClass("PasswordItem","TextItem");isc.A=isc.PasswordItem.getPrototype();isc.A.$27r="PASSWORD";isc.ClassFactory.defineClass("RadioGroupItem","ContainerItem");isc.A=isc.RadioGroupItem.getPrototype();isc.A.itemHeight=20;isc.A.vertical=true;isc.A.prompt=null;isc.A.textBoxStyle="labelAnchor";isc.A=isc.RadioGroupItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.$173=function isc_RadioGroupItem__useHiddenDataElement(){return false}
...
var _5={};if(this.useMask){var _6=this.getInputFormat();if(!_6)_6="MDY";var _7=this.getInputFormatMask(_6);_5.mask=_7;_5.maskSaveLiterals=true;_5.maskOverwriteMode=true;if(this.inputFormat){this.displayFormat=this.$30f[_6]}}
...
,isc.A.setValue=function isc_DateItem_setValue(_1){this.$25m=true;var _2=false;if(_1==null){_1=this.getDefaultValue();_2=true}
...
if(_5){var _6;if(!this.useTextField){_6=true}else if(this.enforceDate&&_1!=null){var _7=this.dateTextField;_6=!this.$30i||!_7||(_7.getValue()!=_1)}
...
if(!_5&&this.$30i){delete this.$30i;this.clearErrors();this.redraw()}
this.saveValue(_4,_2);this.$30j=true;if(this.useTextField){if(this.dateTextField){if(_3&&this.dateTextField.isDirty){this.dateTextField.setValue(this.dateTextField._value)}else{var _8=_5?_4:this.formatDate(_4);this.dateTextField.setValue(_8);delete this.dateTextField.isDirty}}}
if(this.daySelector)this.daySelector.setValue(_4.getDate());if(this.monthSelector)this.monthSelector.setValue(_4.getMonth());if(this.yearSelector)this.yearSelector.setValue(_4.getFullYear());delete this.$30j;return true}
...
return _1}
,isc.A.$30k=function isc_DateItem__getEmptyDate(){var _1=new Date();_1.setHours(0);_1.setMinutes(0);_1.setSeconds(0);_1.setMilliseconds(0);return _1}
...
_2.setUTCMinutes(_9)}
this.$30j=true;if(this.useTextField){var _10=this.formatDate(_2);this.dateTextField.setValue(_10)}else{var _2=this._value||this.getDefaultValue(),_11;if(this.yearSelector)this.yearSelector.setValue(_3);else{_2.setFullYear(_3);_11=true}
...
this.$30j=false;this.updateValue();if(!this.hasFocus)this.focusInItem()}
...
return _6.release()}
,isc.A.$20e=function isc_TextAreaItem__nativeElementFocus(_1,_2){var _3=this.Super("$20e",arguments);this.$25x();return _3}
,isc.A.$20h=function isc_TextAreaItem__nativeElementBlur(_1,_2){var _3=this.Super("$20h",arguments);if(this.changeOnBlur)this.form.elementChanged(this);else{var _4=this.getElementValue();if(this.mapDisplayToValue){_4=this.mapDisplayToValue(_4)}
if(this._value!=_4)this.form.elementChanged(this)}
if(this.showHintInField){var _5;var _6=this.getElementValue();if(_6===_5||_6==null||isc.is.emptyString(_6)){this.$25u()}}
return _3}
...
var _4=this.getValue(),_5=(!_4||_4==isc.emptyString);if(_1==this.$30w&&isc.EH.altKeyDown()){if(_5)this.$305=true;this.filterWithValue=false;this.showPickList();return false}
if(_3){if(_1==this.$30w||_1==this.$30v||_1==this.$15u||_1==this.$j8)
{_2.bodyKeyPress(isc.EH.lastEvent);return false}}
return this.Super("handleKeyPress",arguments)}
,isc.A.handleKeyDown=function isc_ComboBoxItem_handleKeyDown(){if(!this.hasFocus)return this.Super("handleKeyDown",arguments);var _1=isc.EH.lastEvent.keyName,_2=this.pickList,_3=(_2?(_2.isDrawn()&&_2.isVisible()):false);if(_3){if(_2&&_2.isVisible()&&_1==this.$j9&&(this.completeOnTab||this.$25o()==this.$219))
...
var _2=this.mapValueToDisplay(_1);if(_2==_1){this.clearValue()}else{this.$17r(_1,true)}
this.Super("handleEditorExit",arguments)}
,isc.A.$17r=function isc_ComboBoxItem__updateValue(_1,_2){var _3=this.getElementValue(),_4=(_1==_3&&this.mapValueToDisplay(this.getValue())==_3);this.$73l=(!_4&&!this.$306);if(this.addUnknownValues||_2){return this.Super("$17r",arguments)}
if(_4)return;var _5=this.mapValueToDisplay(_1);if(_5==_1){this.saveValue(null);this.refreshPickList(_1);return}
return this.Super("$17r",arguments)}
...
,isc.A.refreshPickList=function isc_ComboBoxItem_refreshPickList(_1){_1=this.$251||_1;var _2=(!_1||_1==isc.emptyString);if(!_2)delete this.$305;var _3=this.pickList,_4=(_3?_3.isVisible():false);if(_2&&!this.$305){if(_4)_3.hide()}else if(this.showPickListOnKeypress||_4){if(this.addUnknownValues)this.saveValue(_1);if(!this.$306&&this.hasFocus){this.filterWithValue=true;this.showPickList(true,true)}}}
...
{return}
delete this.$28u;delete this.$29b;if(!_1||!_1.isVisible()||_1.formItem!=this)return;_1.hide()}
...
,isc.A.pickValue=function isc_ComboBoxItem_pickValue(_1){var _2=this.mapValueToDisplay(_1);if(this.addUnknownValues)this.setElementValue(_2);else this.setValue(_1);this.$306=true;this.$307={};this.$307[_2]=_1;this.updateValue();delete this.$306}
...
,isc.A.setValue=function isc_ComboBoxItem_setValue(_1,_2,_3,_4,_5){this.$73l=false;this.$308=true;this.invokeSuper(isc.ComboBoxItem,"setValue",_1,_2,_3,_4,_5);delete this.$308;if(!this.hasFocus&&this.showHint&&this.showHintInField&&this.getHint()){var _6;if(_1===_6||_1==null||isc.is.emptyString(_1)){this.$25u()}}}
...
return _1}
,isc.A.getCriteriaFieldName=function isc_ComboBoxItem_getCriteriaFieldName(){var _1=this.$73l&&!this.getSelectedRecord();if(this.displayField&&_1)return this.displayField;return this.criteriaField||this.getFieldName()}
,isc.A.$25r=function isc_ComboBoxItem__checkForDisplayFieldValue(_1,_2){var _3=(this.$25g(_1,true)!=null);if(_3)return;if(this.$29d){this.$29e=true;return}
this.invokeSuper(isc.ComboBoxItem,"$25r",_1)}
...
,isc.A.getIconsHTML=function isc_SpinnerItem_getIconsHTML(){if(!this.showIcons)return"";var _1=isc.SB.create();if(!this.$31a){var _2="<TD tabIndex=-1"+(isc.Browser.isIE?" style='font-size:0px'":"")+">",_3={},_4=this.$24r(_3),_5=this.$24s(_3);this.$31a=["<TABLE STYLE='vertical-align:",_4,";margin-top:",_5,";margin-bottom:",_5,";display:inline;' BORDER=0 CELLPADDING=0 CELLSPACING=0><TR>",_2,this.getIconHTML(this.icons[0]),"<TD></TR><TR>",_2,this.getIconHTML(this.icons[1]),"</TD></TR></TABLE>"]}else{this.$31a[8]=this.getIconHTML(this.icons[0]);this.$31a[11]=this.getIconHTML(this.icons[1])}
...
return _1}
,isc.A.$31l=function isc_PickTreeItem__getPrimaryKeyFieldName(){if(!this.dataSource)return null;if(!this.$31m){var _1=isc.DataSource.getDataSource(this.dataSource),_2=_1.getPrimaryKeyFieldNames(),_3=isc.isAn.Array(_2)?_2[0]:_2;if(isc.isAn.Array(_2)&&_2.length>1){this.logWarn("Multiple primary key fields not supported by PickTreeItem - using '"+_3+"' as single primary key field")}
this.$31m=_3}
return this.$31m}
...
,isc.A.$31n=function isc_PickTreeItem__getNode(_1){if(!_1)return null;var _2=(this.dataSource?this.canvas.getTree():this.valueTree);if(this.$31j())return this.valueTree.find(_1);return _2.find(this.$31k(),_1)}
...
,isc.A.$17r=function isc_ValuesManager__updateValue(_1,_2,_3){if(isc.isA.DynamicForm(_3)&&_3.getItem(_1)==null){this.$31u(_3,_1);return}
var _4;var _5=_3.getFullDataPath();if(_5){_1=(_1!=null)?this.$1z(_5,_1):_5;_4=true}else _4=_1.contains(isc.Canvas.$1v);if(!_4){this.values[_1]=_2}else{isc.DynamicForm.$1x(_1,_2,this.values)}}
...
,isc.A.getItem=function isc_ValuesManager_getItem(_1){return this.$31v(_1,true)}
...
,isc.A.$31v=function isc_ValuesManager__findMemberByField(_1,_2,_3){if(!this.members||_1==null||isc.isAn.emptyString(_1))return null;_1=_1.trim("/");var _4=_1.split(isc.Canvas.$1v);var _5=_3?[]:null;for(var i=0;i<this.members.length;i++){var _7=this.members[i],_8=_7.getFullDataPath();if(_8==isc.Canvas.$1v||isc.isAn.emptyString(_8))
_8=null;if(_4&&_4.length>0&&_8!=null){var _9=null;for(var _10=0;_10<_4.length;_10++){_9=!_9?_4[_10]:(_9+isc.Canvas.$1v+_4[_10]);if(_8.endsWith(isc.Canvas.$1v)){_8=_8.substring(0,_8.length-1)}
if(_8==_9){if(!_2&&(_10==_4.length-1)){if(!_3)return _7;_5.add(_7);break}
if(_7.getField){var _11=_4.slice(_10+1).join(isc.Canvas.$1v);var _12=_7.getField(_11);if(_12){if(_2){if(!isc.isA.FormItem(_12))_12=null;if(_3){if(_12)_5.add(_12)}else{return _12}}else{if(_3)_5.add(_7);else return _7}}}}}}else{if(_1.startsWith(isc.Canvas.$1v))_1=_1.substring(1);if(this.members[i].getItem){var _13=this.members[i].getField(_1);if(_13){if(_2){if(!isc.isA.FormItem(_13))_13=null;if(_3){if(_13)_5.add(_13)}else{return _13}}else{if(_3)_5.add(_7);else return _7}}}}}
return _3?_5:null}
...
_1=(_1&&_10);if(!_6){if(_5.$31y)_5.handleHiddenValidationErrors=_5.$31y;else delete _5.handleHiddenValidationErrors}
...
this.addHiddenErrors(_12);this.$18l(true);if(isc.getKeys(_12).length>0)_1=false;return _1}
...
_1=isc.addProperties({},_1);this.values=_1;if(this.members){for(var i=0;i<this.members.length;i++){this.$310(this.members[i])}}
this.rememberValues()}
...
this.$17k=[]
this.$311(this.$17j,_1);return this.$17j}
,isc.A.getOldValues=function isc_ValuesManager_getOldValues(){var _1={};isc.addProperties(_1,this.$17j);return _1}
,isc.A.getChangedValues=function isc_ValuesManager_getChangedValues(){var _1=this.getValues(),_2=this.$17j,_3=false,_4={};if(!isc.isAn.Object(_2))_2={};for(var _5 in _1){if(isc.isA.Function(_1[_5]))continue;var _6=this.getItem(_5);if(_6!=null){_3=!_6.compareValues(_1[_5],_2[_5])}else{_3=!isc.DynamicForm.compareValues(_1[_5],_2[_5])}
if(_3){_4[_5]=_1[_5]}}
return _4}
,isc.A.$311=function isc_ValuesManager__cloneValues(_1,_2,_3){var _4="__ref";for(var _5 in _2){if(isc.isA.Function(_2[_5]))continue;if(_5==_4)continue;var _6=_5;if(_3){_6=_3+_5}else{_6=_5}
var _7=this.getItem(_6);if(_7&&_7.isSetToDefaultValue()){this.$17k.add(_6)}
var _8=_2[_5];if(isc.isA.Date(_8)){_1[_5]=_8.duplicate()}else if(isc.isAn.Object(_8)&&!isc.isAn.Array(_8)){_1[_5]={};this.$311(_1[_5],_8,(_6+isc.Canvas.$1v))}else{_1[_5]=_2[_5]}}}
...
this.setValues(_1)}
,isc.A.valuesHaveChanged=function isc_ValuesManager_valuesHaveChanged(){return!isc.objectsAreEqual(this.getValues(),this.$17j)}
,isc.A.getValue=function isc_ValuesManager_getValue(_1){return isc.DynamicForm.$1y(_1,this.values)}
...
if(!_3){if(_2===_5)isc.DynamicForm.$1w(_1);else isc.DynamicForm.$1x(_1,_2,this.values);if(_4&&_4.setData){var _7=_1;if(_1.indexOf(isc.Canvas.$1v)!=-1){_7=_1.substring(0,_1.lastIndexOf(isc.Canvas.$1v));_4.setData(isc.DynamicForm.$1y(_7,this.values))}}}}
...
if(this.members==null)this.members=[];this.members.add(_1);this.$310(_1,true);_1.valuesManager=this;_1.$2a=_2;this.rememberValues()}
,isc.A.$310=function isc_ValuesManager__setMemberValues(_1,_2){if(_1.getFields==null)return;var _3=_1.getFullDataPath(),_4=this.getField(_3),_5=isc.DynamicForm.$1y(_3,this.values),_6=isc.isAn.Array(_5)||(_4&&_4.multiple);if(_6){if(_1.dataArity=="single"){if(_1.selectionComponent!=null)return;else if(isc.isAn.Array(_5))_5=_5[0]}}else{if(_5!=null&&_1.dataArity=="multiple")_5=[_5]}
if(!isc.isA.DynamicForm(_1)){if(!_1.setData)return;var _7=_1.getFullDataPath(),_8=_2?_1.getData():null;if(_5==null){if(_2)isc.DynamicForm.$1x(_7,_8)}else{if(_2&&_8!=null&&!isc.isAn.emptyObject(_8)&&!isc.isAn.emptyArray(_8))
...
_1.setData(_5)}}else{var _9=_1.getItems(),_10;for(var i=0;i<_9.getLength();i++){var _12=_9[i];if(!_12.shouldSaveValue)continue;var _13=_12.getDataPath()||_12.getFieldName();if(!_13)continue;var _14=_13,_3=_1.getFullDataPath();if(_3){_14=this.$1z(_3,_14)}
var _15=isc.DynamicForm.$1y(_14,this.values);if(_15!==_10){this.logInfo("Member form "+_1+" has specified value for field '"+_13+"' which collides with an already specified value in this "+"ValuesManager. Resetting the value on the member form.");_1.setValue(_13,_15)}else{if(!_2)_1.clearValue(_13)}
var _16=_1.getValue(_13);if(_16===_10){isc.DynamicForm.$1w(_14,this.values)}else{isc.DynamicForm.$1x(_14,_1.getValue(_13),this.values)}}
if(_2){this.$312(_1)}}}
...
,isc.A.getImageHTML=function isc_ViewFileItem_getImageHTML(){var _1=this.form.getValues(),_2=this.form.getField(this.name),_3=this.name+"$320",_4;if(!_1[this.name])return" ";if(!_1[_3]){var _5=isc.Canvas.getFieldImageDimensions(_2,_1);_4=_1[_3]=isc.Canvas.imgHTML(this.form.getDataSource().streamFile(_1,_2.name),_5.width,_5.height)}else
_4=_1[_3];return _4}
...
,isc.A.updateValue=function isc_RelativeDateItem_updateValue(_1){var _2=this.valueField.getValue();this.$17r(_1);this.$30j=true;this.valueField.setValue(_2);this.valueFieldChanged();this.$30j=false}
...
(_3/ 2));_2+=Math.round((this.getPickerIconHeight()/2)-(_4/ 2));return[_1,_2]}
,isc.A.pickerDataChanged=function isc_RelativeDateItem_pickerDataChanged(_1){var _2=_1.getData();var _3=_2.getFullYear(),_4=_2.getMonth(),_5=_2.getDate();this.$30j=true;this.valueField.setValue(this.formatDate(_2));this.$30j=false;this.updateValue();this.fieldChanged();if(!this.hasFocus)this.focusInItem()}
...
,isc.A.updateValue=function isc_DateRangeItem_updateValue(_1){this.$17r(_1)}
...
,isc.A.updateValue=function isc_MiniDateRangeItem_updateValue(_1){if(!this.$17r(_1))return;this.displayValue(_1)}
