...
,isc.A.$325=function isc_RichTextCanvas__setupEditArea(){isc.HiddenFrame.$59m();var _1=this.$322();if(_1){if(!this.$33e){this.$33e=new Function("event","var returnValue="+this.getID()+".$33f(event);"+"if(returnValue==false && event.preventDefault)event.preventDefault()")}
...
if(this.toolbarHeight>0)this.$338();this.addAutoChild("editArea",{top:this.toolbarHeight,className:this.editAreaClassName,backgroundColor:this.editAreaBackgroundColor,left:0,width:"100%",height:"*",contents:this.value,getTabIndex:function(){if(this.parentElement)return this.parentElement.getTabIndex()
return-1},changed:isc.RichTextEditor.$336,getBrowserSpellCheck:function(){return this.parentElement.getBrowserSpellCheck()}})}
