...
*/
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'cv2_gwt/sc/';}
...
,isc.A.$ca=function isc_ClassFactory__defineNonRootClass(_1,_2,_3,_4,_5){_2=(_2||isc.ClassFactory.defaultSuperClass);if(!_2){isc.Log.logWarn("isc.ClassFactory.defineClass("+_1+") called with null"+" superClass and no ClassFactory.defaultRootClass is defined.");return null}
return this.$cb(_1,_2,_3,_4,_5)}
,isc.A.$cb=function isc_ClassFactory__defineClass(_1,_2,_3,_4,_5){var _6=(isc.Browser.isMoz&&(_1==this.$bu||_1==this.$bv));var _7,_8,_9=(isc.$d&&!_5);_7=isc[_1];if(_7!=null)_8=true
...
_2=this.getClass(_2);var _11=(_2?new _2.$cc.$cd():{});var _12=this.$ce(_2);_11.$cd=this.$cf(_11);_12.Class=_1;_12.$bt=true;if(isc.definingFramework==true)_12.isFrameworkClass=true;else _12.isFrameworkClass=false;if(!_12.isFrameworkClass){var _13=_2;while(_13&&!_13.isFrameworkClass){_13=_13.getSuperClass()}
if(_13)_12.$cg=_13.Class}
if(!_12.$cg)_12.$cg=_12.Class;_12.$a7=_11.$a7=!!_4;_12.$ch=_2;_12.$cc=_11;_11.Class=_1;_11.$ci=_12;_11.$bs=_11;_11.isFrameworkClass=_12.isFrameworkClass;_11.$cg=_12.$cg;isc[_1]=_12;if(_9)window[_1]=_12;this.classList[this.classList.length]=_1
...
);isc.B._maxIndex=isc.C+22;isc.A=isc.ClassFactory;isc.A.TARGET_IMPLEMENTS="TARGET_IMPLEMENTS";isc.A.$cl=0;isc.A.classList=[];isc.defineClass=function(_1,_2,_3,_4){return isc.ClassFactory.defineClass(_1,_2,_3,_4)}
...
if(_2!=null&&(_2.length==null||isc.isA.String(_2)))_2=[_2];if(_2==null)_2=isc.$af;this.$dc=_3||_2;this.$dd=isc.Class.$de(_1,this);this.$df=true;return this.invokeSuper(null,_1)}
...
,isc.A.invokeSuper=function isc_c_Class_invokeSuper(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10){var _11=this.$bt;var _12=this.$df;this.$df=null;var _13=this.$dc;this.$dc=null;var _14;if(_12){_14=this.$dd;this.$dd==null}else{if(_1!=null){_14=_11?_1:_1.$cc}}
var _15,_16;if(_14==null){_15=isc.Class.$c9(_2,this);_16=_11?this:this.getPrototype()}else{_15=isc.Class.$c9(_2,_14);if(_11){_16=_14.$ch}else{_16=_14.$ci.$ch.$cc}
if(_13&&_13.callee!=null&&_13.callee!=_15)
{_15=isc.Class.$c9(_2,this);_16=_11?this:this.getPrototype()}}
_16=isc.Class.$c8(_15,_16,_2,_11);if(_16==null){if(isc.Log)isc.Log.logWarn("Call to Super for method: "+_2+" failed on: "+this+": couldn't find a superclass implementation of : "+(_14?_14.Class:this.Class)+"."+_2+this.getStackTrace());return null}
var _17=_16[_2];isc.Class.$dh(_2,_16,this);var _18;if(_12){if(_13){_18=_17.apply(this,_13)}else{_18=_17.apply(this)}}else{_18=_17.call(this,_3,_4,_5,_6,_7,_8,_9,_10)}
isc.Class.$di(_2,this);return _18}
...
_3="it."+_2+"("+_6+")"}
var _11=_8.$dw;_8.add({target:this,action:_3,$dy:_11});var _12=isc.$al+_2;if(!_1[_12])_1[_12]=_5;if(!_11)_1[_2]=this.$dz(_2,_8);return true}
...
,isc.A.$ed=function isc_Class__addAutoChildToParent(_1,_2,_3){if(_1.addAsPeer||_1.snapEdge)_2.addPeer(_1);else if(isc.isA.Layout(_2)&&!_1.addAsChild&&!_1.snapTo)_2.addMember(_1,_3);else if(isc.isA.TileLayout(_2)&&!_1.addAsChild&&!_1.snapTo)_2.addTile(_1,_3);else _2.addChild(_1)}
...
_3[_3.length]=this[_1];return _3});isc.A.observe=isc.Class.getPrototype().observe;isc.A.ignore=isc.Class.getPrototype().ignore;isc.A.$dz=isc.Class.getPrototype().$dz;isc.B.push(isc.A.getPrototype=function isc_Arra_getPrototype(){return Array.prototype}
...
isc.addGlobal("timeStamp",function(){return new Date().getTime()});isc.addGlobal("timestamp",isc.timeStamp);Date.prototype.Class="Date";Date.Class="Date";isc.Date=Date;isc.A=Date;isc.A.INVALID_DATE_STRING="Invalid date format";isc.A=Date;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$e0={toUSShortDate:"MDY",toUSShortDateTime:"MDY",toEuropeanShortDate:"DMY",toEuropeanShortDateTime:"DMY",toJapanShortDate:"YMD",toJapanShortDateTime:"YMD"};isc.B.push(isc.A.newInstance=function isc_Date_newInstance(_1,_2,_3,_4,_5,_6,_7){return new Date(_1,_2,_3,_4,_5,_6,_7)}
...
,isc.A.getInputFormat=function isc_Date_getInputFormat(){return this.$e1}
...
var _2=this.$e0[_1];if(_2!=null&&isc.isA.String(_2))return _2;if(_1=="toSerializeableDate")return this.parseSchemaDate;isc.Log.logInfo("Unable to determine input format associated with display format "+_1+" - returning default input format","Date");return this.getInputFormat()}
...
var _6=this.$e3(_1,_2);if(_6!=null){var _7=_6[0];if(_7&&_7.length<=2){_7=parseInt(_7,10);if(_7<_3)_7+=2000;else _7+=1900
_6[0]=_7}
...
if(_11!=null){_11.$e4(-isc.Time.getUTCHoursDisplayOffset(_11),-isc.Time.getUTCMinutesDisplayOffset(_11))}
...
,isc.A.getShortMonthNames=function isc_Date_getShortMonthNames(_1){_1=_1||3;var _2=Date.shortMonthNames;if(_2==null)_2=Date.$e7;if(_2==null){var _3=Date.$e7=[];for(var i=0;i<12;i++){var _5=new Date(2000,i,2);_3[i]=_5.deriveShortMonthName()}
_2=Date.$e7}
...
,isc.A.$fi=function isc_Dat__toShortDate(_1,_2){var _3=this.$fa,_4,_5,_6;if(!_2){_4=this.getMonth()+1;_5=this.getDate();_6=this.getFullYear()}else{var _7=this.$fg(isc.Time.getUTCHoursDisplayOffset(this),isc.Time.getUTCMinutesDisplayOffset(this));_4=_7.getUTCMonth()+1;_5=_7.getUTCDate();_6=_7.getUTCFullYear()}
...
isc.$bn(_3,_4,_8+1,3);isc.$bn(_3,this.getFullYear(),_10,4);return _3.join(isc.emptyString)}
,isc.A.toUSShortDate=function isc_Dat_toUSShortDate(_1){return this.$fi(this.$fb,_1)}
,isc.A.$fk=function isc_Dat__toShortTime(_1){if(!_1){var _2=this.$fe;_2[0]=this.getHours().stringify();_2[1]=this.getMinutes().stringify();return _2.join(":")}else{return isc.Time.toShortTime(this,"toShortPadded24HourTime")}}
...
Date.prototype.localeStringFormatter="toLocaleString";Date.setInputFormat("MDY");isc.A=Date;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.$e5=function isc_Date__splitDateViaSubstring(_1,_2,_3,_4){var _5=_4*3,_6=_1.substring(_5,_5+4);var _7=(parseInt(_6)!=_6);if(_7)_6=_6.substring(0,2);var _8=0,_9=0;if(_2>_3)_8+=3;else _9+=3;if(_2>_4)_8+=(_7?3:5);if(_3>_4)_9+=(_7?3:5);var _10=_1.substring(_8,_8+2)-1;var _11=_1.substring(_9,_9+2);var _12=_7?9:11,_13=(_1.substring(_12,_12+2)||0),_14=(_1.substring(_12+3,_12+5)||0),_15=(_1.substring(_12+6,_12+8)||0);return[_6,_10,_11,_13,_14,_15]}
...
);isc.B._maxIndex=isc.C+9;String.prototype.Class="String";isc.$fp=function(){var _1=[Array,Number,Date].getProperty("prototype");for(var i=0;i<_1.length;i++){var _3=_1[i];if(_3.toLocaleString==null){_3.toLocaleString=_3.toString}}
...
);isc.B._maxIndex=isc.C+5;isc.$f1={getCallTrace:function(_1,_2,_3){if(_1==null)_1=arguments.caller;if(_1==null)return"[getCallTrace(): Error: couldn't get arguments object]";var _4,_5=_1.callee;if(_5==null){_4="[args.callee == null]"}else if(!isc.Func){_4="[Func utility class not loaded]"}else{_4=isc.Func.getName(_5,true)}
...
return _2.toString()},$a2:function(_1,_2,_3,_4){if(_1.$f7)return;_1.$f7=true;var _5=_1.toString();if(isc.Browser.isMoz){if(_1.stack){var _6;try{_6=this.transformMozStackTrace(_1.stack)}catch(e){_6=_1.stack}
...
isc.Log.logInfo("initialized");isc.Log.$gr();isc.Log.supportsOnError=(isc.Browser.isIE);if(isc.Log.supportsOnError&&!(window.isc_installOnError==false)){window.onerror=function(_1,_2,_3){var _4=arguments.caller;if(_4==null&&arguments.callee.caller!=null){_4=arguments.callee.caller.arguments}
if(_4&&_4.$ha){return}
...
);isc.B._maxIndex=isc.C+2;isc.A=isc.Time;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$h9=[null,":",null,":"];isc.A.$ia=[null,":"];isc.B.push(isc.A.toTime=function isc_c_Time_toTime(_1,_2){return this.format(_1,_2,false)}
...
var _5=_2.showSeconds,_6=_2.padded,_7=_2.show24;var _8=_1.getUTCHours(),_9=_1.getUTCMinutes();var _10=this.$e4(_8,_9,this.getUTCHoursDisplayOffset(_1),this.getUTCMinutesDisplayOffset(_1));_8=_10[0];_9=_10[1];var _11=_5?_1.getUTCSeconds():null,_12=_7?null:(_8>=12);if(!_7){if(_8>12)_8=_8-12;if(_8==0)_8=12}
if(_6)_8=_8.stringify(2);var _13=_5?this.$h9:this.$ia;_13[0]=_8;_13[2]=_9.stringify();if(_5)_13[4]=_11.stringify();if(!_7)_13[5]=(_12?this.PMIndicator:this.AMIndicator);else _13[5]=null;return _13.join(isc.emptyString)}
,isc.A.parseInput=function isc_c_Time_parseInput(_1,_2,_3){var _4=0,_5=0,_6=0,_7=0;var _8,_9;if(isc.isA.Date(_1)){_3=true;_4=_1.getUTCHours();_5=_1.getUTCMinutes();_6=_1.getUTCSeconds();_7=_1.getUTCMilliseconds()}else if(_1){for(var i=0;i<isc.Time.$h8.length;i++){var _11=isc.Time.$h8[i].exec(_1);if(_11)break}
if(_11){var _4=Math.min(parseInt(_11[1]|0,10),23),_5=Math.min(parseInt(_11[2]|0,10),59),_6=Math.min(parseInt(_11[3]|0,10),59),_12=_11[4];;if(_12){if(!this.$ib)this.$ib={p:true,P:true,pm:true,PM:true,Pm:true};if(this.$ib[_12]==true){if(_4<12)_4+=12}else if(_4==12)_4=0}
...
var _18=this.$e4(_4,_5,(0-_8),(0-_9));_4=_18[0];_5=_18[1];if(_4!=null)_17.setUTCHours(_4);if(_5!=null)_17.setUTCMinutes(_5);if(_6!=null)_17.setUTCSeconds(_6);if(_7!=null)_17.setUTCMilliseconds(_7);return _17}
...
return[_1,_2,_5]}
,isc.A.createDate=function isc_c_Time_createDate(_1,_2,_3,_4,_5){var _6=new Date();if(_1==null)_1=0;if(_2==null)_2=0;if(_3==null)_3=0;if(_4==null)_4=0;if(!_5){var _7=-this.UTCHoursDisplayOffset,_8=-this.UTCMinutesDisplayOffset;var _9=this.$e4(_1,_2,_7,_8);_1=_9[0];_2=_9[1]}
...
return _1.body.scrollHeight});isc.A.getScrollLeft=(isc.Browser.isNS?function(){return window.pageXOffset}:function(){if(document==null||document.body==null)return 0;return(isc.Browser.isStrict?document.documentElement.scrollLeft:document.body.scrollLeft)});isc.A.getScrollTop=(isc.Browser.isNS?function(){return window.pageYOffset}:function(){if(document==null||document.body==null)return 0;return(isc.Browser.isStrict?document.documentElement.scrollTop:document.body.scrollTop)});isc.A.unsupportedBrowserAction="continue";isc.B.push(isc.A.finishedLoading=function isc_c_Page_finishedLoading(){if(this.width==null||this.height==null)isc.EH.$il()
isc.Page.$ie=true;isc.Log.logInfo("isc.Page is loaded");isc.EH.startIdleTimer();if(isc.Browser.isSafari)isc.Canvas.clearCSSCaches();if(!window.suppressAutoLogWindow){var _1=isc.LogViewer.getLogCookie();if(_1!=null&&_1.keepOpen){isc.Timer.setTimeout("isc.Log.show(true)",1000)}}
...
if(isc.Page.pollPageSize){isc.EH.$il()}else{isc.EH.delayCall("$il",null,200)}}
...
if(!this.$59p()){if(!this.$59q){isc.Page.setEvent("load",this.getID()+".draw()",isc.Page.FIRE_ONCE);this.$59q=true}
...
var _5=false,_6=true;if(_3.$lc==_4.keyName){_6=_3.handleKeyPress();_5=true}else{_6=_3.handleKeyDown(_1)}
_3.$lc=_4.keyName;if(_6!=false&&((isc.Browser.isIE&&!_5&&_3.$j2[_4.keyName]!=null)||(isc.Browser.isMoz&&_4.keyName==this.$j7&&this.shiftKeyDown())))
...
if(_9)_5=false}
return _5}
,isc.A.$ld=function isc_c_EventHandler__handleNativeKeyUp(_1){if(!isc.Page.isLoaded())return false;var _2=isc.EH,_3=_2.lastEvent;if(!_1)_1=_2.getWindow().event;_2.getKeyEventProperties(_1);if(_2.$lc==_2.lastEvent.keyName){if(_2.handleKeyPress(_1)==false){this.cancelKeyEvent(_1);return false}}
...
,isc.A.$lf=function isc_c_EventHandler__handleNativeKeyPress(_1){if(!isc.Page.isLoaded())return false;var _2=isc.EH;var _3=_2.lastEvent,_4=_2.KEY_PRESS;if(!_1)_1=_2.getWindow().event;_2.getKeyEventProperties(_1);_3.eventType=_4;if(isc.Browser.isMoz&&_3.keyName==this.$j7&&this.shiftKeyDown())return;var _5=_2.handleKeyPress(_1);if(_5==false){this.cancelKeyEvent(_1)}
return _5}
...
this.$lj(_10)}}
return false}}
if(isc.Browser.isIE&&_4.keyName==isc.EH.$j7&&isc.EH.shiftKeyDown()){var _14=this.handleContextMenu(_1);if(_14){this.$lk=true}
return _14}
...
,isc.A.$mb=function isc_c_EventHandler__handleContextMenu(_1){var _2=isc.Browser.isSafari||(this.lastEvent.eventType==isc.EH.MOUSE_UP);if(this.$lk){delete this.$lk;return true}
...
,isc.A.$md=function isc_c_EventHandler__handleTouchStart(_1){var _2=isc.EH;var _3=_2.getMouseEventProperties(_1);var _4=_2.handleEvent(_3.target,_2.TOUCH_START);if(_4!==false){_3.originalType=_2.TOUCH_START;_3.eventType=_2.MOUSE_DOWN;_2.doHandleMouseDown(_1,_3);if(_2.$71g!=null)isc.Timer.clear(_2.$71g);_2.$71g=this.delayCall("$71h",[],_2.longTouchDelay)}}
...
,isc.A.$me=function isc_c_EventHandler__handleTouchMove(_1){var _2=isc.EH;var _3=_2.getMouseEventProperties(_1);var _4=_2.handleEvent(_3.target,_2.TOUCH_MOVE);if(_4!==false){_3.originalType=_2.TOUCH_MOVE;_3.eventType=_2.MOUSE_MOVE;_2.$l0(_1,_3);if(_2.dragging&&window.event!=null)window.event.preventDefault()}
if(_2.$71g!=null)isc.Timer.clear(_2.$71g)}
,isc.A.$mf=function isc_c_EventHandler__handleTouchEnd(_1){var _2=isc.EH;var _3=_2.getMouseEventProperties(_1);var _4=_2.handleEvent(_3.target,_2.TOUCH_END);if(_4!==false){_3.originalType=_2.TOUCH_END;_3.eventType=_2.MOUSE_UP;_2.$l8(_1,true)}
if(_2.$71g!=null)isc.Timer.clear(_2.$71g)}
...
if(isc.Browser.isIE&&_2.parentElement==null){_2=_3.lastTarget}else{var _6=this.$kg;if(isc.Browser.isIE){while(_2!=null){if(_2.eventProxy)break;_2=_2.parentElement}}else{while(_2!=null){if(_2.eventProxy!=null||(_2.hasAttribute!=null&&_2.hasAttribute(_6)))break;_2=_2.parentNode}}
...
,isc.A.makeEventMask=function isc_c_EventHandler_makeEventMask(_1,_2,_3){if(isc.isA.Function(_1.makeEventMask))return _1.makeEventMask(_2,_3);var _4=this.$ki;if(!_4.contents)_4.contents=isc.Browser.isIE&&isc.Browser.version>6?isc.Canvas.blankImgHTML(1600,1200):isc.Canvas.spacerHTML(1600,1200);var _5=isc.Canvas.create({ID:_1.getID()+"_eventMask",cursor:_1.cursor,$km:_1},_4,_2);_5.setRect(_3?_3:_1.getRect());_1._eventMask=_5;_1.addPeer(_5);return _5}
...
if(this.$nk[_1]==true)return true;return false}
...
if(this.$nl[_1]==true)return true;return false}
...
if(isc.Browser.isTouch){this.captureEvent(_4,"ontouchstart",_2.TOUCH_START,_2.$md);this.captureEvent(_4,"ontouchmove",_2.TOUCH_MOVE,_2.$me);this.captureEvent(_4,"ontouchend",_2.TOUCH_END,_2.$mf)}
...
,isc.A.determineEventKeyName=function isc_c_EventHandler_determineEventKeyName(_1){if(_1==null)return;var _2=_1.keyCode,_3=_1.which,_4=isc.EH,_5=_4.getKeyEventType(_1.type);if(_1.type==this.$k6)return this.$k5;if(isc.Browser.isIE){if(_5==_4.KEY_DOWN||_5==_4.KEY_UP){return _4.$jt[_2]}
if(_5==_4.KEY_PRESS){if(_4.$lc!=null)return _4.$lc;var _6=_4.$j4[_2];if(!_6&&this.getWindow().event.ctrlKey){_6=isc.EH.$n2(_2)}
return _6}}else if(isc.Browser.isMoz){if(_5==_4.KEY_DOWN||_5==_4.KEY_UP){return _4.$jt[_2]}else if(_5==_4.KEY_PRESS){if(_3==0&&_2!=0)return _4.$jt[_2];if(_4.$lc!=null)return _4.$lc;if(_2==0){return _4.$j4[_3]}else{return _4.$jt[_3]}}}else if(isc.Browser.isSafari){if(_5==_4.KEY_DOWN||_5==_4.KEY_UP){return _4.$jt[_2]}
var _7=(_3!=null?_3:_2);if(_7!=null&&_7!=0){if(this.getWindow().event.ctrlKey){var _8=isc.EH.$j4[_7];if(_8==null){if(_7==10)_8="Enter";else _8=isc.EH.$n2(_7)}
return _8}
var _8=isc.EH.$j4[_7];if(_8==null)_8=isc.EH.$j5[_7]
return _8}else if(_5==this.KEY_PRESS){return null}}else{var _7=_3;if(_7==null||(_7==0&&_2))_7=_2
if(_7!=null)return isc.EH.$j4[_7]}
...
,isc.A.clearKeyEventProperties=function isc_c_EventHandler_clearKeyEventProperties(){var _1=this.lastEvent;delete _1.eventType;delete _1.nativeKeyTarget;delete _1.characterValue;delete _1.keyName;delete _1.shiftKey;delete _1.ctrlKey;delete _1.altKey;delete _1.metaKey;delete this.$lc}
...
var _6=this,_7=_6.clickMaskRegistry;if(_6.lastMoveTarget)_6.handleEvent(_6.lastMoveTarget,_6.MOUSE_OUT);delete _6.lastMoveTarget;var _8={autoHide:_5,mode:_2,ID:(_4!=null?_4:"cm_"+_6.$k7++),$n5:{}};this.$n6(_3,_8);var _9=_7.last();_7.add(_8);_8.clickAction=_1;var _10=_6.getFocusCanvas();if(_10!=null&&!_3.contains(_10)){_10.blur();this.setMaskedFocusCanvas(_10,_8)}else if(_9!=null){this.setMaskedFocusCanvas(_9.$mn,_8)}
...
if(this.maskNativeTargets){if(_9==null){this.showScreenSpan(_8)}else if(_11){this.$n8(_8.$n5)}}
...
if(this.$og){if(_5&&_7==null){if(isc.Browser.isIE){isc.Timer.setTimeout({target:this.$og,methodName:"hide"},0)}else{this.$og.hide()}}else if(_8){if(_9){this.$n8(_9.$n5)}else this.$og.sendToBack()}
if(_6){var _14;if(_9!=null){_14=[];for(var i=_4-1;i>=0;i--){var _16=_2[i];_14.addList(isc.getKeys(_16.$n5));if(_16==_9)break}}else{_14=isc.Canvas._canvasList}
this.$oj(_14,true)}
...
if(_17){this.$ma=_12}else{try{_12.focus()}catch(e){}}}}
this.updateEventMasks()}
,isc.A.$oi=function isc_c_EventHandler__getNextHardMask(_1,_2){var _3=this.clickMaskRegistry;if(_2){for(var i=_1+1;i<_3.length;i++){if(this.isHardMask(_3[i]))return _3[i]}}else{for(var i=_1-1;i>=0;i--){if(this.isHardMask(_3[i]))return _3[i]}}
return null}
,isc.A.$oa=function isc_c_EventHandler__getCanvas(_1){if(isc.isA.String(_1))return window[_1];return _1}
);isc.evalBoundary;isc.B.push(isc.A.$oj=function isc_c_EventHandler__hardUnmaskTargets(_1,_2){if(!_1||_1.length==0)return;for(var i=0;i<_1.length;i++){var _4=this.$oa(_1[i]);if(!_4)continue;if(_4.accessKey!=null&&_4.isDrawn()){_4.$oh(_4.accessKey)}
...
);isc.B._maxIndex=isc.C+169;isc.EventHandler.captureEvents();if("2011.07.02_14.30.50"!=""&&!"2011.07.02_14.30.50".startsWith("${")&&!window.isc_expirationOff&&new Date()>Date.parseStandardDate("2011.07.02_14.30.50"))
{window.$703=function(){var _1="http://www.isomorphic.com";var _2="This copy of Isomorphic SmartClient is expired.  See ";if(isc.Window){_2+="<a href=\""+_1+"\">"+_1+"</a>"}else{_2+=_1}
_2+=" for a renewal.";if(isc.Window){isc.Timer.setTimeout("isc.say('"+_2+"')",200)}else{isc.Timer.setTimeout("alert('"+_2+"')",200)}};isc.Page.setEvent("load","$703()")}
isc.ClassFactory.defineClass("Element",null,null,true);isc.A=isc.Element;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$on=window.isc_insertAfterBodyStart;isc.A.$oo="isc_global_insertion_marker";isc.A.$op="afterBegin";isc.A.$oq="afterEnd";isc.A.$or="beforeBegin";isc.A.$os="beforeEnd";isc.A.$ot=isc.Browser.isMoz?"border-left-width":"borderLeftWidth";isc.A.$ou=isc.Browser.isMoz?"border-top-width":"borderTopWidth";isc.A.$ov=isc.Browser.isMoz?"margin-left":"marginLeft";isc.A.$ow=isc.Browser.isMoz?"margin-top":"marginTop";isc.A.$ox="none";isc.A.cacheCount=0;isc.A.uncachedCount=0;isc.A.$73x="$73x";isc.A.$73y="$73y";isc.A.cacheOffsetCoords=true;isc.A.$oy={};isc.A.$oz={border:"borderStyle",borderWidth:"borderStyle",borderLeft:"borderLeftStyle",borderRight:"borderRightStyle",borderTop:"borderTopStyle",borderBottom:"borderBottomStyle",borderLeftWidth:"borderLeftStyle",borderRightWidth:"borderRightStyle",borderBottomWidth:"borderBottomStyle",borderTopWidth:"borderTopStyle"};isc.A.$o0={};isc.A.$o1=";";isc.A.vendorCSSPrefix=(isc.Browser.isMoz?"-moz-":isc.Browser.isSafari?"-webkit-":isc.Browser.isOpera?"-o-":"");isc.B.push(isc.A.get=function isc_c_Element_get(_1,_2){_2=_2||this.getDocument();if(isc.Browser.isDOM)return _2.getElementById(_1)}
...
if(isc.Browser.isIE||isc.Browser.isOpera){_4=_3.currentStyle;if(_2==null)_2=this.$pt;var _6=isc.applyMask(_4,_2);return _6}
...
{_5[_12]=_11[_12]}}
return _5}
,isc.A.getComputedStyleAttribute=function isc_c_Element_getComputedStyleAttribute(_1,_2){if(_1==null||_2==null)return null;if(isc.Browser.isIE||isc.Browser.isOpera){if(_1.currentStyle==null)return null;if(isc.Browser.isOpera&&this.$oz[_2]!=null&&_1.currentStyle[this.$oz[_2]]==this.$ox)return 0;return _1.currentStyle[_2]}
...
if(this.$tk!=null)
this.enforceScrollSize(this.$tk[0],this.$tk[1]);if(this.$tl())isc.EH.$n7([this]);if(this.clipCorners)this.$tm();this.$73z=this.isVisible();if(!_1&&this.$73z)this.show();if(this.parentElement)this.parentElement.childDrawn(this);if(this.masterElement)this.masterElement.peerDrawn(this);if(this.parentElement==null&&this.position==this.$sl){this.$tn=this.getPageLeft();this.$to=this.getPageTop();isc.Page.setEvent("resize",this,isc.Page.FIRE_ONCE,"$tp")}
return this}
...
,isc.A.getPrintInnerHTML=function isc_Canvas_getPrintInnerHTML(){return this.$s5()}
...
,isc.A.$tg=function isc_Canvas__completeHTMLInit(){this.modifyContent();if(isc.Browser.isMoz&&isc.Browser.isStrict&&this.containsIFrame())this.$s4();if(isc.screenReader)this.addContentRoles();if(this.manageChildOverflow&&this.children!=null){this.$t5(this.children)}
...
this.modifyContent();if(isc.screenReader)this.addContentRoles();this.setUpEvents();this.$ug=false;this.adjustOverflow(this.$q6,null,true);this.redrawPeers();if(_1){this.logDebug("Redraw() - Total time to redraw in DOM:"+(isc.timeStamp()-_3),"drawing")}
return this}
...
);isc.evalBoundary;isc.B.push(isc.A.markForDestroy=function isc_Canvas_markForDestroy(){if(isc.$da)arguments.$db=this;if(this.destroyed||this.destroying||this.isPendingDestroy())return;this.$u3=true;this.$uy(false,false);isc.Canvas.scheduleDestroy(this)}
...
,isc.A.getTagStart=function isc_Canvas_getTagStart(_1){var _2=isc.Canvas,_3=this.$vb();if(this.zIndex==_2.AUTO)this.zIndex=_2.getNextZIndex();var _4=(this.eventProxy?this.eventProxy.ID:this.ID);var _5=this.$vc(),_6=_5[0],_7=_5[1];if(!_2.$vd){_2.$vd=" onfocus=";_2.$ve=" onblur=";_2.$vf=" tabindex="
_2.$vg=" accessKey="}
...
if(this.useClipDiv){var _10=this.getCurrentCursor(),_11,_12=this._useNativeTabIndex;if(_12&&this.$ln()){_11=isc.SB.concat(_2.$vd,this.$tx(),_2.$ve,this.$ty(),!this.isDisabled()?_2.$vf+this.getTabIndex():null,(!this.$ti()&&this.accessKey!=null)?_2.$vg+this.accessKey:null)}
var _13=isc.StringBuffer.concat("<div id='",this.$va(),"' eventProxy=",_4,(this.className?" class='"+this.className+"'":""),_11," style='","POSITION:",this.position,";LEFT:",this.left,"px;TOP:",this.top,"px;WIDTH:",_6,"px;HEIGHT:",_7,"px;Z-INDEX:",this.zIndex,(this.visibility==_2.INHERIT?"":";VISIBILITY:"+this.visibility),(this.backgroundColor==null?"":";BACKGROUND-COLOR:"+this.backgroundColor),(this.backgroundImage==null?"":";BACKGROUND-IMAGE:url("+this.getImgURL(this.backgroundImage)+")"+";BACKGROUND-REPEAT:"+this.backgroundRepeat+(this.backgroundPosition?";BACKGROUND-POSITION:"+this.backgroundPosition:"")),(this.border?";BORDER:"+this.border:""),(this.padding!=null||this.$vj?";PADDING:0px":""),this.$vk(),(_9!=null?(this.$qx?";-moz-opacity:":";opacity:")+_9:""),(_8?";-moz-box-sizing:border-box":null),(_8&&_12&&this.mozOutlineOffset!=null?";-moz-outline-offset:"+this.mozOutlineOffset:null),(_8&&_12&&this.mozOutlineColor!=null?";-moz-outline-color:"+this.mozOutlineColor:null),(_8&&_12&&!this.showFocusOutline?";-moz-outline-style:none":null),this.getTransformCSS(),(isc.Browser.isTouch?(!this.canSelectText?";-webkit-user-select:none":";-webkit-user-select:text"):null),";OVERFLOW:",_3,";' ONSCROLL='return "+_4+".$mm()'>","<div id='",this.getCanvasName(),"' eventProxy='",_4,(this.textDirection!=null?"' dir='"+this.textDirection:""),"' style='POSITION:relative;VISIBILITY:inherit",";Z-INDEX:",this.zIndex,(_10==_2.AUTO?"":";CURSOR:"+_10),(this.padding!=null?";PADDING:"+this.padding+"px":""),(this.topPadding!=null?";padding-top:"+this.topPadding+"px":""),(this.bottomPadding!=null?";padding-bottom:"+this.bottomPadding+"px":""),(this.leftPadding!=null?";padding-left:"+this.leftPadding+"px":""),(this.rightPadding!=null?";padding-right:"+this.rightPadding+"px":""),";'>")}else{if(!_2.$vl){_2.$vm=" style='POSITION:absolute;LEFT:";_2.$vn=" style='POSITION:relative;LEFT:";_2.$bg=" class='";_2.$vo="'";_2.$vp=";VISIBILITY:";_2.$vq=";CURSOR:";var _14=_2.$vl=[];_14[0]="<div id=";_14[2]=" eventProxy=";_14[15]="px;TOP:";_14[22]="px;WIDTH:";_14[28]="px;HEIGHT:";_14[34]="px;Z-INDEX:";_14[44]=";OVERFLOW:";_14[59]="' ONSCROLL='return ";_14[61]=".$mm()' "}
var _14=_2.$vl;_14[1]=this.getCanvasName();_14[3]=_4;if(this.className!=null){_14[4]=_2.$bg;_14[5]=this.className;_14[6]=_2.$vo}else{_14[4]=_14[5]=_14[6]=null}
_14[7]=(this.textDirection!=null?" dir="+this.textDirection:null);_14[8]=(this.position==_2.RELATIVE?_2.$vn:_2.$vm);isc.$bn(_14,this.left,9,6);isc.$bn(_14,this.top,16,6);isc.$bn(_14,_6,23,5);isc.$bn(_14,_7,29,5);if(this.zIndex!=_2.AUTO)isc.$bn(_14,this.zIndex,35,9);else{_14[35]=this.zIndex;_14[36]=_14[37]=_14[38]=_14[39]=_14[40]=_14[41]=_14[42]=_14[43]=null}
_14[45]=_3;if(this.visibility!=_2.INHERIT){_14[46]=_2.$vp;_14[47]=this.visibility}else{_14[46]=_14[47]=null}
_14[48]=(this.backgroundColor==null?null:";BACKGROUND-COLOR:"+this.backgroundColor);_14[49]=(this.backgroundImage==null?null:";BACKGROUND-IMAGE:url("+this.getImgURL(this.backgroundImage)+");BACKGROUND-REPEAT:"+this.backgroundRepeat+(this.backgroundPosition?";BACKGROUND-POSITION:"+this.backgroundPosition:""));_14[50]=(_8?";-moz-box-sizing:border-box":null);var _10=this.getCurrentCursor();if(_10==_2.AUTO){_14[51]=_14[52]=null}else{_14[51]=_2.$vq;_14[52]=_10}
_14[53]=this.$vk();_14[54]=(this.padding!=null?";PADDING:"+this.padding+isc.px:null);if(this.topPadding!=null)
...
if(!isc.Canvas.neverUseFilters){if(this.$vr){_14[57]=";filter:progid:DXImageTransform.Microsoft.iris(irisStyle=circle)"}else{_14[57]=null}}}else{if(_9!=null){_14[56]=(this.$qx?";-moz-opacity:":";opacity:")+_9}else{_14[56]=null}}
_14[58]=this.getTransformCSS();_14[60]=_4;var _15=64;if(this.$ln()&&this._useNativeTabIndex){_14[64]=_2.$vd;_14[65]=this.$tx();_14[66]=_2.$ve;_14[67]=this.$ty();if(!this.isDisabled()){_14[68]=_2.$vf;isc.$bn(_14,this.getTabIndex(),69,5);if(this.accessKey!=null){_14[74]=_2.$vg;_14[75]=this.accessKey;_15=76}else _15=74;if(!this.showFocusOutline){if(!_2.$vs)_2.$vs=" hideFocus=true";_14[_15]=_2.$vs;_15+=1}}else _15=68}
_14.length=_15;_14[_15]=this.$rc;if(_1)return _14;return _14.join(isc.emptyString)}
return _13}
...
,isc.A.getOffsetTop=function isc_Canvas_getOffsetTop(){var _1=this.getClipHandle();if(isc.Browser.isMoz&&this.$wb())_1=null;if(_1==null)return this.top;var _2=isc.Element.getOffsetTop(_1);return _2}
...
,isc.A.$p4=function isc_Canvas__calculateMargins(){var _1=this.$vu,_2=(_1!=null),_3,_4,_5,_6;if(_2){_3=_1.top;_6=_1.bottom;_4=_1.left;_5=_1.right;if((_3==null||_3.length==0)&&(_6==null||_6.length==0)&&(_4==null||_4.length==0)&&(_5==null||_5.length==0))_2=false}
if(!this.$vt()&&!_2)return this.$wm();var _7=this.$wl;if(_7)return _7;var _8=this.$wn();_7={left:_8.left,right:_8.right,top:_8.top,bottom:_8.bottom};if(_2){if(_3){for(var i=0;i<_3.length;i++){var _10=_3[i];_7.top+=_10.getVisibleHeight();if(_10.$wo!=null){_7.top-=_10.$wo}}}
if(_6){for(var i=0;i<_6.length;i++){var _11=_6[i];_7.bottom+=_11.getVisibleHeight();if(_11.$wo!=null){_7.bottom-=_11.$wo}}}
if(_4){for(var i=0;i<_4.length;i++){var _12=_4[i];_7.left+=_12.getVisibleWidth();if(_12.$wo!=null){_7.left-=_12.$wo}}}
if(_5){for(var i=0;i<_5.length;i++){var _13=_5[i];_7.right+=_13.getVisibleWidth();if(_13.$wo!=null){_7.right-=_13.$wo}}}}
if(this.$vt()){var _14=this.$sv();_7.left+=_14.$wp,_7.right+=_14.$wq,_7.top+=_14.$wr,_7.bottom+=_14.$ws}
return(this.$wl=_7)}
...
this.$uf=_1;else
this.$uf=[_1,_2,_3,_4];var _5=this.getClipHandle();if(_5!=null){var _6=this.$uf;_5.style.clip="rect("+_6.join("px ")+"px)"}}
...
this.$73x=this.$73y=null;this.moved(_1,_2)}
,isc.A.moved=function(deltaX,deltaY){}
,isc.A.parentMoved=function isc_Canvas_parentMoved(_1,_2,_3){this.$73x=this.$73y=null;this.$w5(_1,_2,_3)}
,isc.A.$w5=function isc_Canvas__fireParentMoved(_1,_2,_3){var _4=this.children;if(_4==null)return;for(var i=0;i<_4.length;i++){if(isc.isA.Canvas(_4[i]))_4[i].parentMoved(_1,_2,_3)}}
...
{isc.Page.setEvent("load",this.ID+".pageResize()",isc.Page.FIRE_ONCE);this.$s7=true}
...
,isc.A.pageResize=function isc_Canvas_pageResize(){this.$n3=null;this.$s7=null;this.$t9()}
...
this.$w3()}
return true}
,isc.A.$w3=function isc_Canvas__completeResizeBy(){var _1=(this.$w1||0),_2=(this.$w2||0),_3=this.$xc,_4;this.$w1=_4;this.$w2=_4;this.$xc=_4;if(!_1&&!_2)return;var _5;if(this.isDrawn()){_5=this.shouldRedrawOnResize(_1,_2,_3);if(_5){this.markForRedraw(this.$n4)}}
...
if(this.$xg!=null)delete this.$xg;if(this.$xh!=null)delete this.$xh;this.resized(deltaX,deltaY,reason)}
...
,isc.A.resizePeersBy=function isc_Canvas_resizePeersBy(_1,_2){var _3=this.peers;if(_3){for(var i=0;i<_3.length;i++){if(_3[i]&&_3[i].$kj){_3[i].resizeBy(_1,_2)}}}}
...
if(_2){_1.dragTarget=this;_1.dragOperation=_2}else if(this.canDragResize){_1.resizeEdge=this.getEventEdge();if(_1.resizeEdge){_1.dragTarget=this;_1.dragOperation=_1.DRAG_RESIZE;_1.dragMoveAction=_1.$nw}}
if(!_1.dragTarget){if(this.canDragReposition){_1.dragTarget=this;_1.dragOperation=_1.DRAG_REPOSITION;_1.dragMoveAction=_1.$mq}else if(isc.Browser.isTouch&&(this.hscrollOn||this.vscrollOn)&&!this.dragOperation)
...
,isc.A.dragScrollMove=function isc_Canvas_dragScrollMove(){var _1=this.dragScrollTarget||this;var _2=this.$xk-isc.EH.getX(),_3=this.$xl-isc.EH.getY();_1.scrollTo(this.$xm+_2,this.$xn+_3);if(window.event)window.event.preventDefault();this.$xo=this.$xp;this.$xq=this.$xr;this.$xs=this.$xt;this.$xp=isc.EH.getX();this.$xr=isc.EH.getY();this.$xt=isc.timestamp()}
...
var _3=this.getStyleHandle();_3.overflow=this.$vb();var _4=this.$vc();_3.width=_4[0];_3.height=_4[1];if(_3.clip!=null&&_3.clip!=""&&_3.clip!="rect(auto auto auto auto)")
{_3.clip=(isc.Browser.isIE?"rect(auto)":"")}
this.adjustOverflow("setOverflow");if(_2==isc.Canvas.VISIBLE&&_1!=isc.Canvas.VISIBLE){var _5=Math.max(this.getScrollWidth()-this.getInnerWidth(),0),_6=Math.max(this.getScrollHeight()-this.getInnerHeight(),0);if(_5>0||_6>0)this.$xe(-_5,-_6,"overflow changed")}else if(_2!=isc.Canvas.VISIBLE&&_1==isc.Canvas.VISIBLE){var _5=Math.max(this.getScrollWidth()-this.getInnerWidth(),0),_6=Math.max(this.getScrollHeight()-this.getInnerHeight(),0);if(_5>0||_6>0)this.$xe(_5,_6,"overflow changed")}
...
if(this.showCustomScrollbars){if(!this.hscrollOn&&_22)this.hscrollbar.hide();if(!this.vscrollOn&&_21)this.vscrollbar.hide();if(this.hscrollOn){this.$yl()}else{if(_22)this.scrollTo(0)}
if(this.vscrollOn){this.$ym()}else{if(_21)this.scrollTo(null,0)}
this.$yk()}
...
this.scrollDelta;this.$yo(_1,_2*_3)}
,isc.A.scrollByDelta=function isc_Canvas_scrollByDelta(_1,_2){this.$yo(_1,_2*this.scrollDelta)}
,isc.A.$yo=function isc_Canvas__scrollByAmount(_1,_2){if(_1){this.scrollTo(null,this.getScrollTop()+_2)}else{this.scrollTo(this.getScrollLeft()+_2)}}
...
,isc.A.scrollTo=function(left,top,handleAlreadyMoved,animating){if(isc.$da)arguments.$db=this;if(!animating){if(this.scrollAnimation)this.finishAnimation("scroll");if(this.hideAnimation&&this.$hideAnimationInfo.slideOut)
...
return}
this.scrollTo(_4,_5,true);isc.EH.$i5()}
...
return _3}
,isc.A.$ue=function isc_Canvas__setHandleRect(_1,_2,_3,_4){if(this.showCustomScrollbars&&this.vscrollOn&&_1!=null&&this.isRTL()){_1+=this.getScrollbarSize()}
...
_1[_2]=_3+this.$sk}}
);isc.evalBoundary;isc.B.push(isc.A.$ts=function isc_Canvas__sizeBackMask(){var _1=this._backMask;if(!_1)return;if(this.showEdges){var _2=this.$m5,_3=this.maskEdgeCenterOnly,_4=_3?_2.$yu:_2.$wp,_5=_3?_2.$yv:_2.$wq,_6=_3?_2.$yw:_2.$wr,_7=_3?_2.$yx:_2.$ws,_8=this.getVisibleWidth()-(_4+_5),_9=this.getVisibleHeight()-(_6+_7);if(_8<=0||_9<=0)_1.hide();else{if(this.isVisible())_1.show();_1.setRect(this.getLeft()+_4,this.getTop()+_6,_8,_9)}}else{_1.setRect(this.getRect())}}
...
,isc.A.$lh=function isc_Canvas__focusInNextTabElement(_1,_2){var _3=this;do{_3=(_1?_3.$zk():_3.$zl())}while(_3&&(isc.EH.targetIsMasked(_3,_2)||_3.isDisabled()||!_3.isDrawn()||!_3.isVisible()||!_3.$ln()))
...
,isc.A.setStyleName=function isc_Canvas_setStyleName(_1){this.$wt=null;this.$wu=null;this.$730();if(_1){this.styleName=_1;this.className=_1}
...
,isc.A.$z5=function isc_Canvas__registerAttachedPeer(_1,_2,_3){if(_1==null||_2==null)return;if(!this.$vu)this.$vu={};if(!this.$vu[_2])this.$vu[_2]=[];this.$vu[_2].add(_1);if(_3!=null)_1.$wo=_3
delete this.$wk;delete this.$wl}
,isc.A.$z6=function isc_Canvas__unRegisterAttachedPeer(_1,_2,_3){if(_1==null||_2==null)return;if(!this.$vu||!this.$vu[_2])return;this.$vu[_2].remove(_1);delete _1.$wo;delete this.$wk;delete this.$wl}
...
,isc.A.$0a=function isc_Canvas__createEdgedCanvas(){var _1=this.$sp,_2=isc.EdgedCanvas.createRaw();_2.autoDraw=false;_2._generated=true;_2.dragTarget=this;_2.visibility=this.visibility;_2.opacity=this.opacity;if(this.edgeOpacity!=null){_2.opacity=this.edgeOpacity;_2.$q0=false}
...
var _12=this.getImgURL(_1,_6,_8);if(_9)_11=[this.$0x];if(isc.Page.isXHTML())_12=isc.makeXMLSafe(_12);if(!this.$tq(_8)||!this.$07(_1)){_11[1]=_12}else{_11[1]=this.$io;_11[3]=this.$05;_11[4]=_12;_11[5]=this.$06;if(_2==null)_2=16;if(_3==null)_3=16}
...
);isc.B._maxIndex=isc.C+4;isc.defineClass("ScreenSpan","Canvas");isc.A=isc.ScreenSpan.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A._generated=true;isc.A.src="[SKINIMG]/blank.gif";isc.A.redrawOnResize=false;isc.A.overflow="hidden";isc.B.push(isc.A.getInnerHTML=function isc_ScreenSpan_getInnerHTML(){if(!this.$1l){this.$1l=isc.Browser.isIE&&isc.Browser.version>6?isc.Canvas.imgHTML(this.src,1600,1200):isc.Canvas.spacerHTML(1600,1200)}
return this.$1l}
...
,isc.A.$1w=function isc_c_Canvas__clearFieldValue(_1,_2){if(!_2||_1==null||isc.isAn.emptyString(_1))return;var _3=_1.contains(this.$1v);if(_3){var _4=_1.split(this.$1v),_5=[];if(isc.isAn.emptyString(_4.last()))_4.length-=1;for(var i=0;i<_4.length;i++){if(isc.isAn.emptyString(_4[i]))continue;if(_2==null){_5.length=0;break}
...
,isc.A.$1x=function isc_c_Canvas__saveFieldValue(_1,_2,_3){if(_3==null)return;var _4=_1.contains(this.$1v);if(_4){_1.trim(isc.Canvas.$1v);var _5=_1.split(this.$1v);for(var i=0;i<_5.length;i++){if(isc.isAn.emptyString(_5[i]))continue;if(i==_5.length-1){_3[_5[i]]=_2}else{var _7=_3[_5[i]]
...
return _3}
,isc.A.$1y=function isc_c_Canvas__getFieldValue(_1,_2){if(_2==null)return;if(_1==null)return;var _3=_1.contains(this.$1v);if(_3){var _4=_1.split(this.$1v);if(isc.isAn.emptyString(_4.last()))_4.length-=1;for(var i=0;i<_4.length;i++){if(isc.isAn.emptyString(_4[i]))continue;if(i==_4.length-1){return _2[_4[i]]}else{if(_2[_4[i]]==null)return;_2=_2[_4[i]]}}}else{return _2[_1]}}
...
_3=_3.parentElement}
this.$19=_2;if(_3){if(_3!=this){if(_3.valuesManager==null){_3.createDefaultValuesManager()}
_3.valuesManager.addMember(this,true)}}}
,isc.A.getFullDataPath=function isc_Canvas_getFullDataPath(){return this.$19||this.dataPath}
...
this.addFieldValidators(_1);return _1}}}
,isc.A.combineFieldData=function isc_Canvas_combineFieldData(_1){var _2=this.getDataSource();if(_1.dataPath){isc.DataSource.combineFieldData(_1,this.getDataPathField(_1.dataPath));return _1}else if(_2.getField(_1.name)){return _2.combineFieldData(_1)}else if(_1.includeFrom!=null){return this.$71x(_1)}
return _1}
...
this.setData(_5);if(!_3.$2i&&this.requestVisibleRows!=null){var _6=this.data,_7=_6.fetchDelay;_6.fetchDelay=0;this.requestVisibleRows();_6.fetchDelay=_7}}
...
,isc.A.setHilites=function isc_Canvas_setHilites(_1){this.hilites=_1;if(_1==null)return;this.$2l(this.hilites)}
...
,isc.A.$2l=function isc_Canvas__setupHilites(_1,_2){for(var i=0;i<_1.length;i++){if(_1[i].id==null){this.$2m=this.$2m||0;_1[i].id=this.$2m++}}
this.$2n=_1.makeIndex("id");if(!_2)this.applyHilites()}
,isc.A.applyHilites=function isc_Canvas_applyHilites(){var _1=this.hilites,_2=this.data;if(!_1)return;if(_1&&!this.$2n)this.$2l(_1,true);if(isc.isA.ResultSet(_2))_2=_2.getAllLoadedRows();if(isc.isA.Tree(_2))_2=_2.getAllItems();_2.setProperty(this.hiliteMarker,null);var _3=this.getAllFields();for(var i=0;i<_3.length;i++){var _5=_3[i],_6=_5[this.fieldIdProperty];if(_5.userFormula||_5.userSummary){if(_5.userSummary&&!_5.$26)
...
this.$2y=false}
,isc.A.$2q=function isc_Canvas__storeTransferState(_1,_2,_3,_4,_5,_6){if(!isc.isAn.Array(this.$2z))this.$2z=[];if(this.$2w&&this.$2w!=0){isc.logWarn("transferRecords was invoked but the prior transfer is not yet complete - \
...
);isc.evalBoundary;isc.B.push(isc.A.$2s=function isc_Canvas__addIfNotDuplicate(_1,_2,_3,_4,_5,_6){var _7=this.getDataSource(),_8,_9=this,_10={};if(this.addOperation){isc.addProperties(_10,{operationId:this.addOperation})}
...
if(!_3.$20)_3.$20=0;_3.$20++;_7.addData(_1,function(_15,_16,_17){_3.$21(_15,_16,_17)},_10);return true}}
if(!this.preventDuplicates){if(_7){if(!_3.$20)_3.$20=0;_3.$20++;_7.addData(_1,function(_15,_16,_17){_3.$21(_15,_16,_17)},_10)}else{if(isc.Tree&&isc.isA.Tree(this.data)){this.data.add(_1,_6,_5)}else{if(_5!=null)this.data.addAt(_1,_5);else this.data.add(_1)}}
return true}
...
this.$22=null;var _2=this.dragDataAction==isc.Canvas.COPY||this.dragDataAction==isc.Canvas.CLONE;if(_2&&_1){for(var i=0;i<_1.length;i++){var _4=_1[i];if(_4.$23!=null){for(var _5=0;_5<_4.$23.length;_5++){this.removeEmbeddedComponent(_4,_4.$23[_5])}}
delete _4.$23}
...
if(this.showGridSummary&&this.summaryRow&&this.exportIncludeSummaries){var _16=this.summaryRow,_3=[_16.$27];for(var _13=0;_13<_3.getLength();_13++){var _14=_3[_13],_15=this.getRecordExportObject(_14,_5,_7,_6,_8,_9);_4.push(_15)}}
...
if(!_3){var _6=_1.type=="date"?Date.prototype.$e2:Date.prototype.$e6;if(_6&&isc.isA.Function(Date.prototype[_6])){_3=_6}}
...
_161=_1}
if(_161.title==null)_161.title="title";if(_161.scRole==null)_161.scRole="waiRole";if(_161.name==null)_161.name="name";var _3=_39.getClassName(),_4=_39.getClass();_160.Class=_3;var _5;if(!_4.isFrameworkClass){_5=_4.$4h}
...
var _77=_49.match("\\[icon='(.+)'\\]"),_78=_77?_77[1]:null;if(_78){return this.$4n(_78)}}},emptyLocatorArray:isc.Canvas.getPrototype().emptyLocatorArray});isc.HeaderItem.addProperties({locateItemBy:"value"});if(isc.PickListMenu){isc.PickListMenu.addProperties({getLocatorParent:function(){if(this.formItem)return this.formItem.form;return this.Super("getLocatorParent",arguments)}})}}
...
isc.DaySchedule.addProperties(isc.$4w);isc.WeekSchedule.addProperties(isc.$4w,{showingDate:function(_2){for(var i=0;i<this.fields.length;i++){var _5=this.fields[i];if(_5.$4x==null)continue;if(Date.compareLogicalDates(new Date(_5.$4x,_5.$4y,_5.$4z),_2)==0)
{this.logWarn("does contain date"+_2.toShortDate());return true}
this.logWarn("date passed in:"+_2.toShortDate()+"compared with:"+new Date(_5.$4x,_5.$4y,_5.$4z).toShortDate())}
